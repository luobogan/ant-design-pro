...
const locale = { "sheets-data-validation": {
	operators: {
		between: "między",
	...
	date: {
		...
		ruleName: {
			...
			notBetween: "nie jest między {FORMULA1}",
			legal: "jest prawidłową datą"
		},
		errorMsg: {
			...
			notBetween: "Wartość musi być prawidłową datą i nie być między {FORMULA1}",
	...
	textLength: {
		errorMsg: {
			...
			notBetween: "Długość tekstu nie może być między {FORMULA1}"
		},
	...
	decimal: { title: "Liczba" },
	whole: { title: "Liczba całkowita" },
	checkbox: {
		title: "Pole wyboru",
		error: "Zawartość tej komórki narusza regułę sprawdzania poprawności",
