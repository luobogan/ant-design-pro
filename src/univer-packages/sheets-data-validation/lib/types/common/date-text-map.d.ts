...
export declare const DateOperatorTitleMap: Record<DataValidationOperator | 'NONE', string>;
export declare const DateOperatorErrorTitleMap: Record<DataValidationOperator | 'NONE', string>;
