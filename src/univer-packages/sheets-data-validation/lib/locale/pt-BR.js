...
const locale = { "sheets-data-validation": {
	...
	date: {
		...
		ruleName: {
			...
			notBetween: "não está entre {FORMULA1}",
			legal: "é uma data válida"
		},
		errorMsg: {
			...
			notBetween: "O valor deve ser uma data válida e não estar entre {FORMULA1}",
	...
	textLength: {
		errorMsg: {
			...
			notBetween: "O comprimento do texto não deve estar entre {FORMULA1}"
		},
