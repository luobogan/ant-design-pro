...
//#endregion
//#region src/facade/f-defined-name.ts
/**
...
let FDefinedNameBuilder = class FDefinedNameBuilder {
	...
	*/
	setScopeToWorkbook() {
		this._definedNameParam.localSheetId = _univerjs_sheets.SCOPE_WORKBOOK_VALUE_DEFINED_NAME;
		return this;
	}
	/**
...
let FDefinedName = class FDefinedName extends _univerjs_core_facade.FBase {
	...
	_apply() {
		if (this._definedNameParam.name === "") this._definedNameParam.name = getDefinedNameFieldName(this._definedNameParam.unitId, this._localeService, this._definedNamesService);
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetDefinedNameCommand.id, this._definedNameParam);
	}
	/**
	...
	*/
	delete() {
		this._commandService.syncExecuteCommand(_univerjs_sheets.RemoveDefinedNameCommand.id, this._definedNameParam);
	}
	/**
	...
	*/
	isWorkbookScope() {
		return this._definedNameParam.localSheetId === _univerjs_sheets.SCOPE_WORKBOOK_VALUE_DEFINED_NAME;
	}
	/**
...
FDefinedName = __decorate([
	__decorateParam(1, (0, _univerjs_core.Inject)(_univerjs_core.Injector)),
	__decorateParam(2, _univerjs_core.ICommandService),
	__decorateParam(3, _univerjs_core.IPermissionService),
	__decorateParam(4, (0, _univerjs_core.Inject)(_univerjs_sheets.WorksheetProtectionRuleModel)),
	__decorateParam(5, (0, _univerjs_core.Inject)(_univerjs_sheets.RangeProtectionRuleModel)),
	__decorateParam(6, (0, _univerjs_core.Inject)(_univerjs_sheets.WorksheetProtectionPointModel)),
	__decorateParam(7, (0, _univerjs_core.Inject)(_univerjs_core.IAuthzIoService)),
...
//#endregion
//#region src/facade/f-selection.ts
var _FSelection;
let FSelection = _FSelection = class FSelection {
	...
	*/
	updatePrimaryCell(cell) {
		...
		for (const { range, style } of this._selections) if (_univerjs_core.Rectangle.contains(range, cell.getRange())) {
			newSelections.push({
				range,
				primary: (0, _univerjs_sheets.getPrimaryForRange)(cell.getRange(), this._worksheet),
				style
			});
			hasSetPrimary = true;
		} else newSelections.push({
			range,
			primary: null,
			style
		});
		if (!hasSetPrimary) newSelections = [{
			range: cell.getRange(),
			primary: (0, _univerjs_sheets.getPrimaryForRange)(cell.getRange(), this._worksheet)
		}];
		...
		commandService.syncExecuteCommand(_univerjs_sheets.SetSelectionsOperation.id, setSelectionOperationParams);
		return new _FSelection(this._workbook, this._worksheet, newSelections, this._injector);
	}
	/**
	...
	*/
	getNextDataRange(direction) {
		if (!this._selections.find((selection) => !!selection.primary)) return null;
		const range = (0, _univerjs_sheets.getNextPrimaryCell)(this._selections.concat(), direction, this._worksheet);
		if (range) return this._injector.createInstance(FRange, this._workbook, this._worksheet, range);
		return null;
	}
};
FSelection = _FSelection = __decorate([__decorateParam(3, (0, _univerjs_core.Inject)(_univerjs_core.Injector))], FSelection);

//#endregion
//#region src/facade/permission/permission-types.ts
/**
* Copyright 2023-present DreamNum Co., Ltd.
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
*/
let UnitRole$3 = /* @__PURE__ */ function(UnitRole) {
...
*/
let WorkbookPermissionPoint = /* @__PURE__ */ function(WorkbookPermissionPoint) {
	/** Edit permission */
	WorkbookPermissionPoint["Edit"] = "WorkbookEdit";
	/** View permission */
	WorkbookPermissionPoint["View"] = "WorkbookView";
	/** Print permission */
	WorkbookPermissionPoint["Print"] = "WorkbookPrint";
	/** Export permission */
	WorkbookPermissionPoint["Export"] = "WorkbookExport";
	/** Share permission */
	WorkbookPermissionPoint["Share"] = "WorkbookShare";
	/** Copy content permission */
	WorkbookPermissionPoint["CopyContent"] = "WorkbookCopy";
	/** Duplicate file permission */
	WorkbookPermissionPoint["DuplicateFile"] = "WorkbookDuplicate";
	/** Comment permission */
	WorkbookPermissionPoint["Comment"] = "WorkbookComment";
	/** Manage collaborators permission */
	WorkbookPermissionPoint["ManageCollaborator"] = "WorkbookManageCollaborator";
	/** Create sheet permission */
	WorkbookPermissionPoint["CreateSheet"] = "WorkbookCreateSheet";
	/** Delete sheet permission */
	WorkbookPermissionPoint["DeleteSheet"] = "WorkbookDeleteSheet";
	/** Rename sheet permission */
	WorkbookPermissionPoint["RenameSheet"] = "WorkbookRenameSheet";
	/** Move sheet permission */
	WorkbookPermissionPoint["MoveSheet"] = "WorkbookMoveSheet";
	/** Hide sheet permission */
	WorkbookPermissionPoint["HideSheet"] = "WorkbookHideSheet";
	/** View history permission */
	WorkbookPermissionPoint["ViewHistory"] = "WorkbookViewHistory";
	/** Recover history permission */
	WorkbookPermissionPoint["RecoverHistory"] = "WorkbookRecoverHistory";
	/** Create protection permission */
	WorkbookPermissionPoint["CreateProtection"] = "WorkbookCreateProtect";
	/** Insert row permission */
	WorkbookPermissionPoint["InsertRow"] = "WorkbookInsertRow";
	/** Insert column permission */
	WorkbookPermissionPoint["InsertColumn"] = "WorkbookInsertColumn";
	/** Delete row permission */
	WorkbookPermissionPoint["DeleteRow"] = "WorkbookDeleteRow";
	/** Delete column permission */
	WorkbookPermissionPoint["DeleteColumn"] = "WorkbookDeleteColumn";
	/** Copy sheet permission */
	WorkbookPermissionPoint["CopySheet"] = "WorkbookCopySheet";
	return WorkbookPermissionPoint;
}({});
/**
* Worksheet-level permission point enumeration
*/
let WorksheetPermissionPoint = /* @__PURE__ */ function(WorksheetPermissionPoint) {
	/** Edit permission */
	WorksheetPermissionPoint["Edit"] = "WorksheetEdit";
	/** View permission */
	WorksheetPermissionPoint["View"] = "WorksheetView";
	/** Copy permission */
	WorksheetPermissionPoint["Copy"] = "WorksheetCopy";
	/** Set cell value permission */
	WorksheetPermissionPoint["SetCellValue"] = "WorksheetSetCellValue";
	/** Set cell style permission */
	WorksheetPermissionPoint["SetCellStyle"] = "WorksheetSetCellStyle";
	/** Set row style permission */
	WorksheetPermissionPoint["SetRowStyle"] = "WorksheetSetRowStyle";
	/** Set column style permission */
	WorksheetPermissionPoint["SetColumnStyle"] = "WorksheetSetColumnStyle";
	/** Insert row permission */
	WorksheetPermissionPoint["InsertRow"] = "WorksheetInsertRow";
	/** Insert column permission */
	WorksheetPermissionPoint["InsertColumn"] = "WorksheetInsertColumn";
	/** Delete row permission */
	WorksheetPermissionPoint["DeleteRow"] = "WorksheetDeleteRow";
	/** Delete column permission */
	WorksheetPermissionPoint["DeleteColumn"] = "WorksheetDeleteColumn";
	/** Sort permission */
	WorksheetPermissionPoint["Sort"] = "WorksheetSort";
	/** Filter permission */
	WorksheetPermissionPoint["Filter"] = "WorksheetFilter";
	/** Pivot table permission */
	WorksheetPermissionPoint["PivotTable"] = "WorksheetPivotTable";
	/** Insert hyperlink permission */
	WorksheetPermissionPoint["InsertHyperlink"] = "WorksheetInsertHyperlink";
	/** Edit extra object permission */
	WorksheetPermissionPoint["EditExtraObject"] = "WorksheetEditExtraObject";
	/** Manage collaborators permission */
	WorksheetPermissionPoint["ManageCollaborator"] = "WorksheetManageCollaborator";
	/** Delete protection permission */
	WorksheetPermissionPoint["DeleteProtection"] = "WorksheetDeleteProtection";
	/** Select protected cells permission */
	WorksheetPermissionPoint["SelectProtectedCells"] = "WorksheetSelectProtectedCells";
	/** Select unprotected cells permission */
	WorksheetPermissionPoint["SelectUnProtectedCells"] = "WorksheetSelectUnProtectedCells";
	return WorksheetPermissionPoint;
}({});
/**
* Range-level permission point enumeration
*/
let RangePermissionPoint = /* @__PURE__ */ function(RangePermissionPoint) {
	/** Edit permission */
	RangePermissionPoint["Edit"] = "RangeEdit";
	/** View permission */
	RangePermissionPoint["View"] = "RangeView";
	RangePermissionPoint["ManageCollaborator"] = "RangeManageCollaborator";
	RangePermissionPoint["Delete"] = "RangeDeleteProtection";
	return RangePermissionPoint;
}({});

//#endregion
//#region src/facade/permission/permission-point-map.ts
/**
* Mapping table from Workbook permission point enum to class constructors
*/
const WORKBOOK_PERMISSION_POINT_MAP = {
	["WorkbookEdit"]: _univerjs_sheets.WorkbookEditablePermission,
	["WorkbookView"]: _univerjs_sheets.WorkbookViewPermission,
	["WorkbookPrint"]: _univerjs_sheets.WorkbookPrintPermission,
	["WorkbookExport"]: _univerjs_sheets.WorkbookExportPermission,
	["WorkbookShare"]: _univerjs_sheets.WorkbookSharePermission,
	["WorkbookCopy"]: _univerjs_sheets.WorkbookCopyPermission,
	["WorkbookDuplicate"]: _univerjs_sheets.WorkbookDuplicatePermission,
	["WorkbookComment"]: _univerjs_sheets.WorkbookCommentPermission,
	["WorkbookManageCollaborator"]: _univerjs_sheets.WorkbookManageCollaboratorPermission,
	["WorkbookCreateSheet"]: _univerjs_sheets.WorkbookCreateSheetPermission,
	["WorkbookDeleteSheet"]: _univerjs_sheets.WorkbookDeleteSheetPermission,
	["WorkbookRenameSheet"]: _univerjs_sheets.WorkbookRenameSheetPermission,
	["WorkbookMoveSheet"]: _univerjs_sheets.WorkbookMoveSheetPermission,
	["WorkbookHideSheet"]: _univerjs_sheets.WorkbookHideSheetPermission,
	["WorkbookViewHistory"]: _univerjs_sheets.WorkbookViewHistoryPermission,
	["WorkbookRecoverHistory"]: _univerjs_sheets.WorkbookRecoverHistoryPermission,
	["WorkbookCreateProtect"]: _univerjs_sheets.WorkbookCreateProtectPermission,
	["WorkbookInsertRow"]: _univerjs_sheets.WorkbookInsertRowPermission,
	["WorkbookInsertColumn"]: _univerjs_sheets.WorkbookInsertColumnPermission,
	["WorkbookDeleteRow"]: _univerjs_sheets.WorkbookDeleteRowPermission,
	["WorkbookDeleteColumn"]: _univerjs_sheets.WorkbookDeleteColumnPermission,
	["WorkbookCopySheet"]: _univerjs_sheets.WorkbookCopySheetPermission
};
/**
* Mapping table from Worksheet permission point enum to class constructors
*/
const WORKSHEET_PERMISSION_POINT_MAP = {
	["WorksheetEdit"]: _univerjs_sheets.WorksheetEditPermission,
	["WorksheetView"]: _univerjs_sheets.WorksheetViewPermission,
	["WorksheetCopy"]: _univerjs_sheets.WorksheetCopyPermission,
	["WorksheetSetCellValue"]: _univerjs_sheets.WorksheetSetCellValuePermission,
	["WorksheetSetCellStyle"]: _univerjs_sheets.WorksheetSetCellStylePermission,
	["WorksheetSetRowStyle"]: _univerjs_sheets.WorksheetSetRowStylePermission,
	["WorksheetSetColumnStyle"]: _univerjs_sheets.WorksheetSetColumnStylePermission,
	["WorksheetInsertRow"]: _univerjs_sheets.WorksheetInsertRowPermission,
	["WorksheetInsertColumn"]: _univerjs_sheets.WorksheetInsertColumnPermission,
	["WorksheetDeleteRow"]: _univerjs_sheets.WorksheetDeleteRowPermission,
	["WorksheetDeleteColumn"]: _univerjs_sheets.WorksheetDeleteColumnPermission,
	["WorksheetSort"]: _univerjs_sheets.WorksheetSortPermission,
	["WorksheetFilter"]: _univerjs_sheets.WorksheetFilterPermission,
	["WorksheetPivotTable"]: _univerjs_sheets.WorksheetPivotTablePermission,
	["WorksheetInsertHyperlink"]: _univerjs_sheets.WorksheetInsertHyperlinkPermission,
	["WorksheetEditExtraObject"]: _univerjs_sheets.WorksheetEditExtraObjectPermission,
	["WorksheetManageCollaborator"]: _univerjs_sheets.WorksheetManageCollaboratorPermission,
	["WorksheetDeleteProtection"]: _univerjs_sheets.WorksheetDeleteProtectionPermission,
	["WorksheetSelectProtectedCells"]: _univerjs_sheets.WorksheetSelectProtectedCellsPermission,
	["WorksheetSelectUnProtectedCells"]: _univerjs_sheets.WorksheetSelectUnProtectedCellsPermission
};
/**
* Mapping table from Range permission point enum to class constructors
*/
const RANGE_PERMISSION_POINT_MAP = {
	["RangeEdit"]: _univerjs_sheets.RangeProtectionPermissionEditPoint,
	["RangeView"]: _univerjs_sheets.RangeProtectionPermissionViewPoint,
	["RangeManageCollaborator"]: _univerjs_sheets.RangeProtectionPermissionManageCollaPoint,
	["RangeDeleteProtection"]: _univerjs_sheets.RangeProtectionPermissionDeleteProtectionPoint
};

//#endregion
//#region src/facade/permission/util.ts
function determineViewState(allowViewByOthers) {
	if (allowViewByOthers === false) return _univerjs_sheets.ViewStateEnum.NoOneElseCanView;
	return _univerjs_sheets.ViewStateEnum.OthersCanView;
}
function determineEditState(allowedUsers) {
	if (allowedUsers === null || allowedUsers === void 0 ? void 0 : allowedUsers.length) return _univerjs_sheets.EditStateEnum.DesignedUserCanEdit;
	return _univerjs_sheets.EditStateEnum.OnlyMe;
}
function determineScope(editState, viewState) {
	return {
		edit: editState === _univerjs_sheets.EditStateEnum.DesignedUserCanEdit ? _univerjs_protocol.ObjectScope.SomeCollaborator : _univerjs_protocol.ObjectScope.OneSelf,
		read: viewState === _univerjs_sheets.ViewStateEnum.OthersCanView ? _univerjs_protocol.ObjectScope.AllCollaborator : _univerjs_protocol.ObjectScope.SomeCollaborator
	};
}
/**
...
async function getListRangeProtectionRules(injector, unitId, subUnitId, options) {
	const rangeProtectionRuleModel = injector.get(_univerjs_sheets.RangeProtectionRuleModel);
	const authzIoService = injector.get(_univerjs_core.IAuthzIoService);
	...
	if (specificRange) rules = rules.filter((rule) => rule.ranges.some((ruleRange) => _univerjs_core.Rectangle.intersects(ruleRange, specificRange.getRange())));
	return (await Promise.all(rules.map(async (rule) => {
		const ranges = rule.ranges.map((range) => worksheet.getRange(range));
		const options = {
			name: rule.description || "",
			allowViewByOthers: rule.viewState !== _univerjs_sheets.ViewStateEnum.NoOneElseCanView
		};
		if (rule.editState === _univerjs_sheets.EditStateEnum.DesignedUserCanEdit) {
			options.allowedUsers = [];
			if (!ignoreCollaborators) try {
				options.allowedUsers = (await authzIoService.listCollaborators({
					objectID: rule.permissionId,
					unitID: unitId
				})).map((c) => {
					var _c$subject;
					return ((_c$subject = c.subject) === null || _c$subject === void 0 ? void 0 : _c$subject.userID) || c.id;
				});
			} catch (error) {
	...
	}))).map(({ id, permissionId, ranges, options }) => injector.createInstance(FRangeProtectionRule, unitId, subUnitId, id, permissionId, ranges, options));
}
...
let FRangeProtectionRule = class FRangeProtectionRule {
	...
	*/
	async updateRanges(ranges) {
		if (!ranges || ranges.length === 0) throw new Error("Ranges cannot be empty");
		const rule = this._rangeProtectionRuleModel.getRule(this._unitId, this._subUnitId, this._ruleId);
		if (!rule) throw new Error(`Rule ${this._ruleId} not found`);
		if (this._rangeProtectionRuleModel.getSubunitRuleList(this._unitId, this._subUnitId).filter((r) => r.id !== this._ruleId).some((otherRule) => otherRule.ranges.some((otherRange) => ranges.some((newRange) => _univerjs_core.Rectangle.intersects(otherRange, newRange.getRange()))))) throw new Error("Range protection cannot intersect with other protection rules");
		const result = await this._commandService.executeCommand(_univerjs_sheets.SetRangeProtectionMutation.id, {
			unitId: this._unitId,
	...
	*/
	async remove() {
		const result = await this._commandService.executeCommand(_univerjs_sheets.DeleteRangeProtectionMutation.id, {
			unitId: this._unitId,
			subUnitId: this._subUnitId,
			ruleIds: [this._ruleId]
		});
		if (result) handleWorksheetRangePermissionIsEmpty(this._injector, this._unitId, this._subUnitId);
		return result;
	}
	/**
	...
	*/
	async setPoint(point, value) {
		...
		if (!PermissionPointClass) throw new Error(`Unknown range permission point: ${point}`);
		...
		await this._authzIoService.update({
			objectType: _univerjs_sheets.UnitObject.SelectRange,
	...
	*/
	canEdit() {
		return this.getPoint("RangeEdit");
	}
	/**
	...
	*/
	canView() {
		return this.getPoint("RangeView");
	}
	/**
	...
	*/
	canManageCollaborator() {
		return this.getPoint("RangeManageCollaborator");
	}
	/**
	...
	*/
	canDelete() {
		return this.getPoint("RangeDeleteProtection");
	}
	/**
...
//#endregion
//#region src/facade/permission/f-worksheet-permission.ts
let FWorksheetPermission = class FWorksheetPermission extends _univerjs_core_facade.FBase {
	...
	*/
	async protect(options) {
		if (this.isProtected()) throw new Error("Worksheet is already protected. Call unprotect() first.");
		const editState = determineEditState(options === null || options === void 0 ? void 0 : options.allowedUsers);
		const viewState = determineViewState(options === null || options === void 0 ? void 0 : options.allowViewByOthers);
		const scope = determineScope(editState, viewState);
		const collaborators = [];
		if (editState === _univerjs_sheets.EditStateEnum.DesignedUserCanEdit) {
			...
			options.allowedUsers.forEach((userId) => {
				const existingCollaborator = existingCollaborators.find((c) => {
					var _c$subject;
					return ((_c$subject = c.subject) === null || _c$subject === void 0 ? void 0 : _c$subject.userID) === userId || c.id === userId;
				});
		...
		const permissionId = await this._authzIoService.create({
			...
			worksheetObject: {
				...
				strategies: [{
					...
					role: _univerjs_protocol.UnitRole.Reader,
					action: _univerjs_protocol.UnitAction.View
				}],
				name: (options === null || options === void 0 ? void 0 : options.name) || "",
				scope
			}
		});
		if (!this._commandService.syncExecuteCommand(_univerjs_sheets.AddWorksheetProtectionMutation.id, {
			unitId: this._unitId,
			subUnitId: this._subUnitId,
			rule: {
				permissionId,
				description: options === null || options === void 0 ? void 0 : options.name,
				unitType: _univerjs_sheets.UnitObject.Worksheet,
				unitId: this._unitId,
				subUnitId: this._subUnitId,
				viewState,
				editState
	...
	*/
	async unprotect() {
		...
		const result = this._commandService.syncExecuteCommand(_univerjs_sheets.DeleteWorksheetProtectionMutation.id, {
			unitId: this._unitId,
			subUnitId: this._subUnitId
		});
		[...(0, _univerjs_sheets.getAllWorksheetPermissionPoint)(), ...(0, _univerjs_sheets.getAllWorksheetPermissionPointByPointPanel)()].forEach((F) => {
	...
	*/
	async setMode(mode) {
		...
		await Promise.all(Object.entries(pointsToSet).map(([point, value]) => this.setPoint(point, value)));
	}
	/**
	...
	*/
	async setPoint(point, value) {
		...
		if (!PermissionPointClass) throw new Error(`Unknown worksheet permission point: ${point}`);
		const worksheetProtectionRule = this._worksheetProtectionRuleModel.getRule(this._unitId, this._subUnitId);
		if (!worksheetProtectionRule) throw new Error(`Cannot set ${point} permission point because worksheet protection does not exist. Call protect() first.`);
	...
	*/
	canEdit() {
		return this.getPoint("WorksheetEdit");
	}
	/**
	...
	*/
	async applyConfig(config) {
		if (config.mode) await this.setMode(config.mode);
		if (config.points) {
			for (const [point, value] of Object.entries(config.points)) if (typeof value === "boolean") await this.setPoint(point, value);
		}
	...
	*/
	async protectRanges(configs) {
		if (!configs || configs.length === 0) throw new Error("Configs cannot be empty");
		const rules = this._rangeProtectionRuleModel.getSubunitRuleList(this._unitId, this._subUnitId);
		...
		for (let i = 0; i < configs.length; i++) {
			...
			if (ranges.some((range) => rules.some((rule) => rule.ranges.some((ruleRange) => _univerjs_core.Rectangle.intersects(ruleRange, range.getRange()))))) throw new Error(`The specified ranges overlap with existing protected ranges: ${ranges.map((r) => r.getA1Notation()).join(", ")}`);
			const editState = determineEditState(options === null || options === void 0 ? void 0 : options.allowedUsers);
			const viewState = determineViewState(options === null || options === void 0 ? void 0 : options.allowViewByOthers);
			const scope = determineScope(editState, viewState);
			const collaborators = [];
			if (editState === _univerjs_sheets.EditStateEnum.DesignedUserCanEdit) {
				...
				options.allowedUsers.forEach((userId) => {
					const existingCollaborator = existingCollaborators.find((c) => {
						var _c$subject2;
						return ((_c$subject2 = c.subject) === null || _c$subject2 === void 0 ? void 0 : _c$subject2.userID) === userId || c.id === userId;
					});
					if (!existingCollaborator) {
						console.error(`User ${userId} not found in existing collaborators`);
						return;
			...
			const ruleId = `ruleId_${(0, _univerjs_core.generateRandomId)(6)}`;
			addRules.push({
				ranges: ranges.map((r) => r.getRange()),
				permissionId,
				id: ruleId,
				description: options === null || options === void 0 ? void 0 : options.name,
				unitType: _univerjs_sheets.UnitObject.SelectRange,
				unitId: this._unitId,
				subUnitId: this._subUnitId,
				viewState,
				editState
		...
		if (!this._commandService.syncExecuteCommand(_univerjs_sheets.AddRangeProtectionMutation.id, {
			unitId: this._unitId,
			subUnitId: this._subUnitId,
			rules: addRules
		})) throw new Error("Failed to create range protection rules");
		return addRules.map((item, i) => {
			return this._injector.createInstance(FRangeProtectionRule, this._unitId, this._subUnitId, item.id, item.permissionId, configs[i].ranges, configs[i].options || {});
		});
	}
	/**
	...
	*/
	async listRangeProtectionRules(options) {
		return getListRangeProtectionRules(this._injector, this._unitId, this._subUnitId, {
			worksheet: this._worksheet,
			ignoreCollaborators: options === null || options === void 0 ? void 0 : options.ignoreCollaborators
		});
	}
	/**
	...
	*/
	async debugCellPermission(row, col) {
		...
		const rule = rules.find((rule) => rule.ranges.some((range) => _univerjs_core.Rectangle.intersects(cellRange, range)));
		if (!rule) return;
		...
		if (rule.editState === _univerjs_sheets.EditStateEnum.DesignedUserCanEdit) {
			options.allowedUsers = [];
			try {
				options.allowedUsers = (await this._authzIoService.listCollaborators({
					objectID: rule.permissionId,
					unitID: this._unitId
				})).map((c) => {
					var _c$subject3;
					return ((_c$subject3 = c.subject) === null || _c$subject3 === void 0 ? void 0 : _c$subject3.userID) || c.id;
				});
			} catch (error) {
				console.error(`Failed to fetch collaborators for rule ${rule.id}:`, error);
			}
		}
		return this._injector.createInstance(FRangeProtectionRule, this._unitId, this._subUnitId, rule.id, rule.permissionId, ranges, options);
	}
};
FWorksheetPermission = __decorate([
	__decorateParam(1, (0, _univerjs_core.Inject)(_univerjs_core.Injector)),
	__decorateParam(2, _univerjs_core.IPermissionService),
	__decorateParam(3, _univerjs_core.IAuthzIoService),
	__decorateParam(4, _univerjs_core.ICommandService),
	__decorateParam(5, (0, _univerjs_core.Inject)(_univerjs_sheets.RangeProtectionRuleModel)),
	__decorateParam(6, (0, _univerjs_core.Inject)(_univerjs_sheets.WorksheetProtectionPointModel)),
	__decorateParam(7, (0, _univerjs_core.Inject)(_univerjs_sheets.WorksheetProtectionRuleModel))
...
function transformFacadeHorizontalAlignment(value) {
	switch (value) {
		case "left": return _univerjs_core.HorizontalAlign.LEFT;
		case "center": return _univerjs_core.HorizontalAlign.CENTER;
		case "normal": return _univerjs_core.HorizontalAlign.RIGHT;
...
function transformCoreHorizontalAlignment(value) {
	switch (value) {
		...
		case _univerjs_core.HorizontalAlign.RIGHT: return "normal";
...
function transformFacadeVerticalAlignment(value) {
	switch (value) {
		case "top": return _univerjs_core.VerticalAlign.TOP;
		case "middle": return _univerjs_core.VerticalAlign.MIDDLE;
		case "bottom": return _univerjs_core.VerticalAlign.BOTTOM;
...
function transformCoreVerticalAlignment(value) {
	switch (value) {
		case _univerjs_core.VerticalAlign.TOP: return "top";
		case _univerjs_core.VerticalAlign.MIDDLE: return "middle";
		case _univerjs_core.VerticalAlign.BOTTOM: return "bottom";
		default: return "general";
	}
}
/**
...
let FWorksheet = _FWorksheet = class FWorksheet extends _univerjs_core_facade.FBaseInitialable {
	...
	*/
	setDefaultStyle(style) {
		...
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetWorksheetDefaultStyleMutation.id, {
			unitId,
			subUnitId,
			defaultStyle: style
		});
	...
	*/
	setColumnDefaultStyle(index, style) {
		const params = {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			columnData: { [index]: { s: style } }
		};
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetColDataCommand.id, params);
		return this;
	}
	/**
	...
	*/
	setRowDefaultStyle(index, style) {
		const params = {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			rowData: { [index]: { s: style } }
		};
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetRowDataCommand.id, params);
		return this;
	}
	getRange(rowOrA1Notation, column, numRows, numColumns) {
		...
		if (typeof rowOrA1Notation === "object") {
			...
			const { range: parsedRange, sheetName } = (0, _univerjs_engine_formula.deserializeRangeWithSheet)(rowOrA1Notation);
			const rangeSheet = sheetName ? this._workbook.getSheetBySheetName(sheetName) : this._worksheet;
			if (!rangeSheet) throw new Error("Range not found");
			sheet = rangeSheet;
			range = {
				...parsedRange,
				unitId: this._workbook.getUnitId(),
				...
				startRow: parsedRange.rangeType === _univerjs_core.RANGE_TYPE.COLUMN ? 0 : parsedRange.startRow,
				endRow: parsedRange.rangeType === _univerjs_core.RANGE_TYPE.COLUMN ? sheet.getMaxRows() - 1 : parsedRange.endRow,
				startColumn: parsedRange.rangeType === _univerjs_core.RANGE_TYPE.ROW ? 0 : parsedRange.startColumn,
				endColumn: parsedRange.rangeType === _univerjs_core.RANGE_TYPE.ROW ? sheet.getMaxColumns() - 1 : parsedRange.endColumn
			};
		...
		} else throw new Error("Invalid range specification");
	...
	*/
	insertRowsAfter(afterPosition, howMany) {
		...
		const cellValue = (0, _univerjs_sheets.copyRangeStyles)(this._worksheet, startRow, endRow, startColumn, endColumn, true, afterPosition);
		this._commandService.syncExecuteCommand(_univerjs_sheets.InsertRowByRangeCommand.id, {
			unitId,
			subUnitId,
			direction,
			range: {
	...
	*/
	insertRowsBefore(beforePosition, howMany) {
		...
		const startColumn = 0;
		const endColumn = this._worksheet.getColumnCount() - 1;
		const cellValue = (0, _univerjs_sheets.copyRangeStyles)(this._worksheet, startRow, endRow, startColumn, endColumn, true, beforePosition - 1);
		this._commandService.syncExecuteCommand(_univerjs_sheets.InsertRowByRangeCommand.id, {
			unitId,
			subUnitId,
			direction,
	...
	*/
	deleteRows(rowPosition, howMany) {
		...
		this._commandService.syncExecuteCommand(_univerjs_sheets.RemoveRowByRangeCommand.id, {
			range,
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId()
		});
	...
	*/
	deleteRowsByPoints(rowPoints) {
		(0, _univerjs_core.generateIntervalsByPoints)(rowPoints).reverse().forEach((interval) => {
	...
	*/
	moveRows(rowSpec, destinationIndex) {
		...
		this._commandService.syncExecuteCommand(_univerjs_sheets.MoveRowsCommand.id, {
			unitId,
			subUnitId,
			range,
			fromRange,
	...
	*/
	hideRow(row) {
		...
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetRowHiddenCommand.id, {
			unitId,
			subUnitId,
			ranges: [range]
		});
	...
	*/
	unhideRow(row) {
		...
		const subUnitId = this._worksheet.getSheetId();
		const range = covertToRowRange(row.getRange(), this._worksheet);
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetSpecificRowsVisibleCommand.id, {
			unitId,
			subUnitId,
			ranges: [range]
		});
	...
	* ```
	*/
	autoFitRow(rowPosition, auto = _univerjs_core.BooleanNumber.TRUE) {
		const unitId = this._workbook.getUnitId();
		const subUnitId = this._worksheet.getSheetId();
		const ranges = [{
			startRow: rowPosition,
		...
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetTextWrapCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			range: ranges[0],
			value: _univerjs_core.WrapStrategy.WRAP
		});
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetWorksheetRowIsAutoHeightMutation.id, {
			unitId,
			subUnitId,
			ranges,
			autoHeightInfo: auto
	...
	*/
	setRowHeights(startRow, numRows, height) {
		...
		for (let i = startRow; i < startRow + numRows; i++) {
			var _rowManager$getRow;
			const autoRowHeight = ((_rowManager$getRow = rowManager.getRow(i)) === null || _rowManager$getRow === void 0 ? void 0 : _rowManager$getRow.ah) || this._worksheet.getConfig().defaultRowHeight;
			const range = {
				startRow: i,
				endRow: i,
				startColumn: 0,
			...
			if (height <= autoRowHeight) autoHeightRanges.push(range);
			else rowHeightRanges.push(range);
		}
		if (rowHeightRanges.length > 0) this._commandService.syncExecuteCommand(_univerjs_sheets.SetRowHeightCommand.id, {
			unitId,
			subUnitId,
			ranges: rowHeightRanges,
			value: height
		});
		if (autoHeightRanges.length > 0) this._commandService.syncExecuteCommand(_univerjs_sheets.SetWorksheetRowIsAutoHeightCommand.id, {
			unitId,
			subUnitId,
	...
	*/
	setRowHeightsForced(startRow, numRows, height) {
		...
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetRowHeightCommand.id, {
			unitId,
			subUnitId,
			ranges,
			value: height
	...
	*/
	setRowCustom(custom) {
		...
		const subUnitId = this._worksheet.getSheetId();
		const rowData = {};
		for (const [rowIndex, customData] of Object.entries(custom)) rowData[Number(rowIndex)] = { custom: customData };
		const params = {
			unitId,
			subUnitId,
			rowData
	...
	*/
	insertColumnsAfter(afterPosition, howMany) {
		const unitId = this._workbook.getUnitId();
		const subUnitId = this._worksheet.getSheetId();
		const direction = _univerjs_core.Direction.RIGHT;
		const startRow = 0;
		const endRow = this._worksheet.getRowCount() - 1;
		const startColumn = afterPosition + 1;
		const endColumn = afterPosition + howMany;
		const cellValue = (0, _univerjs_sheets.copyRangeStyles)(this._worksheet, startRow, endRow, startColumn, endColumn, false, afterPosition);
		this._commandService.syncExecuteCommand(_univerjs_sheets.InsertColByRangeCommand.id, {
			unitId,
			subUnitId,
			direction,
			range: {
	...
	*/
	insertColumnsBefore(beforePosition, howMany) {
		const unitId = this._workbook.getUnitId();
		const subUnitId = this._worksheet.getSheetId();
		const direction = _univerjs_core.Direction.LEFT;
		const startRow = 0;
		const endRow = this._worksheet.getRowCount() - 1;
		const startColumn = beforePosition;
		const endColumn = beforePosition + howMany - 1;
		const cellValue = (0, _univerjs_sheets.copyRangeStyles)(this._worksheet, startRow, endRow, startColumn, endColumn, false, beforePosition - 1);
		this._commandService.syncExecuteCommand(_univerjs_sheets.InsertColByRangeCommand.id, {
			unitId,
			subUnitId,
			direction,
	...
	*/
	deleteColumns(columnPosition, howMany) {
		...
		this._commandService.syncExecuteCommand(_univerjs_sheets.RemoveColByRangeCommand.id, {
			range,
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId()
		});
	...
	*/
	deleteColumnsByPoints(columnPoints) {
		(0, _univerjs_core.generateIntervalsByPoints)(columnPoints).reverse().forEach((interval) => {
	...
	*/
	moveColumns(columnSpec, destinationIndex) {
		...
		this._commandService.syncExecuteCommand(_univerjs_sheets.MoveColsCommand.id, {
			unitId,
			subUnitId,
			range,
			fromRange,
	...
	*/
	hideColumn(column) {
		...
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetColHiddenCommand.id, {
			unitId,
			subUnitId,
			ranges: [range]
		});
	...
	*/
	unhideColumn(column) {
		...
		const subUnitId = this._worksheet.getSheetId();
		const range = covertToColRange(column.getRange(), this._worksheet);
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetSpecificColsVisibleCommand.id, {
			unitId,
			subUnitId,
			ranges: [range]
		});
	...
	*/
	setColumnWidths(startColumn, numColumn, width) {
		...
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetColWidthCommand.id, {
			unitId,
			subUnitId,
			ranges,
			value: width
	...
	*/
	setColumnCustom(custom) {
		...
		const subUnitId = this._worksheet.getSheetId();
		const columnData = {};
		for (const [columnIndex, customData] of Object.entries(custom)) columnData[Number(columnIndex)] = { custom: customData };
		const params = {
			unitId,
			subUnitId,
			columnData
	...
	*/
	getCellMergeData(row, column) {
		...
		if (mergeData) return this._injector.createInstance(FRange, this._workbook, this._worksheet, mergeData);
	}
	/**
	...
	*/
	setActiveRange(range) {
		...
		if (unitId !== this._workbook.getUnitId() || sheetId !== this._worksheet.getSheetId()) throw new Error("Specified range must be part of the sheet.");
	...
	*/
	cancelFreeze() {
		this._commandService.syncExecuteCommand(_univerjs_sheets.CancelFrozenCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this.getSheetId()
		});
		return this;
	...
	*/
	getFrozenColumns() {
		...
		if (freeze.startColumn === -1) return 0;
	...
	*/
	hasHiddenGridLines() {
		return this._worksheet.getConfig().showGridlines === _univerjs_core.BooleanNumber.FALSE;
	}
	/**
	...
	*/
	setHiddenGridlines(hidden) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.ToggleGridlinesCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			showGridlines: hidden ? _univerjs_core.BooleanNumber.FALSE : _univerjs_core.BooleanNumber.TRUE
		});
		return this;
	}
	/**
	...
	*/
	setGridLinesColor(color) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetGridlinesColorCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			color
		});
	...
	*/
	setTabColor(color) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetTabColorCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			value: color
		});
	...
	*/
	showSheet() {
		this._injector.get(_univerjs_core.ICommandService).syncExecuteCommand(_univerjs_sheets.SetWorksheetShowCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId()
		});
		return this;
	...
	*/
	setName(name) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetWorksheetNameCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			name
		});
	...
	*/
	clear(options) {
		if (options && options.contentsOnly && !options.formatOnly) return this.clearContents();
		if (options && options.formatOnly && !options.contentsOnly) return this.clearFormats();
		const unitId = this._workbook.getUnitId();
		const subUnitId = this._worksheet.getSheetId();
		const commandService = this._injector.get(_univerjs_core.ICommandService);
		const range = {
		...
		commandService.syncExecuteCommand(_univerjs_sheets.ClearSelectionAllCommand.id, {
			unitId,
			subUnitId,
			ranges: [range],
			options
	...
	*/
	clearContents() {
		...
		commandService.syncExecuteCommand(_univerjs_sheets.ClearSelectionContentCommand.id, {
			unitId,
			subUnitId,
			ranges: [range]
		});
	...
	*/
	clearFormats() {
		...
		commandService.syncExecuteCommand(_univerjs_sheets.ClearSelectionFormatCommand.id, {
			unitId,
			subUnitId,
			ranges: [range]
		});
	...
	*/
	equalTo(other) {
		if (other instanceof _FWorksheet) return this._worksheet.getSheetId() === other.getSheetId() && this._workbook.getUnitId() === other.getWorkbook().getUnitId();
		return false;
	}
	/**
	...
	*/
	getDefinedNames() {
		return this._fWorkbook.getDefinedNames().filter((name) => name.getLocalSheetId() === this.getSheetId());
	}
	/**
	...
	*/
	appendRow(rowContents) {
		...
		for (let c = 0; c < rowContents.length; c++) cellMatrix.setValue(row, c, (0, _univerjs_core.covertCellValue)(rowContents[c]));
		this._commandService.syncExecuteCommand(_univerjs_sheets.AppendRowCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
	...
	*/
	setRowCount(rowCount) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetWorksheetRowCountCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			rowCount
		});
	...
	*/
	setColumnCount(columnCount) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetWorksheetColumnCountCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			columnCount
		});
	...
	*/
	getWorksheetPermission() {
		return this._injector.createInstance(FWorksheetPermission, this);
	}
};
FWorksheet = _FWorksheet = __decorate([
	...
	__decorateParam(5, (0, _univerjs_core.Inject)(_univerjs_core.ILogService)),
	__decorateParam(6, _univerjs_core.ICommandService)
], FWorksheet);

//#endregion
//#region src/facade/permission/f-range-permission.ts
let FRangePermission = class FRangePermission extends _univerjs_core_facade.FBase {
	...
	*/
	isProtected() {
		return this._rangeProtectionRuleModel.getSubunitRuleList(this._unitId, this._subUnitId).filter((rule) => rule.ranges.some((ruleRange) => _univerjs_core.Rectangle.intersects(ruleRange, this._range.getRange()))).length > 0;
	}
	/**
	...
	*/
	async protect(options) {
		if (this.isProtected()) throw new Error("Range is already protected");
		const editState = determineEditState(options === null || options === void 0 ? void 0 : options.allowedUsers);
		const viewState = determineViewState(options === null || options === void 0 ? void 0 : options.allowViewByOthers);
		const scope = determineScope(editState, viewState);
		const collaborators = [];
		...
		return this._injector.createInstance(FRangeProtectionRule, this._unitId, this._subUnitId, ruleId, permissionId, [this._range], options || {});
	}
	/**
...
FRangePermission = __decorate([
	__decorateParam(4, (0, _univerjs_core.Inject)(_univerjs_core.Injector)),
	__decorateParam(5, (0, _univerjs_core.Inject)(_univerjs_core.IAuthzIoService)),
	__decorateParam(6, (0, _univerjs_core.Inject)(_univerjs_core.ICommandService)),
	__decorateParam(7, (0, _univerjs_core.Inject)(_univerjs_sheets.RangeProtectionRuleModel))
], FRangePermission);
...
let FRange = _FRange = class FRange extends _univerjs_core_facade.FBaseInitialable {
	...
	*/
	isMerged() {
		...
		return this._worksheet.getMergedCellRange(startRow, startColumn, endRow, endColumn).some((range) => _univerjs_core.Rectangle.equals(range, this._range));
	}
	/**
	...
	*/
	getCellStyleData(type = "row") {
		if (type !== "cell") return this._worksheet.getComposedCellStyle(this._range.startRow, this._range.startColumn, type === "row");
	...
	*/
	getCellStyle(type = "row") {
		...
		return data ? _univerjs_core.TextStyleValue.create(data) : null;
	}
	/**
	...
	*/
	getCellStyles(type = "row") {
		return this.getCellDatas().map((row, rowIndex) => row.map((cell, colIndex) => {
			if (!cell) return null;
			...
			return style ? _univerjs_core.TextStyleValue.create(style) : null;
		}));
	}
	...
	*/
	getCellDataGrid() {
		...
		for (let r = startRow; r <= endRow; r++) {
			const row = [];
			for (let c = startColumn; c <= endColumn; c++) row.push(this._worksheet.getCellRaw(r, c));
			range.push(row);
		}
		return range;
	}
	...
	*/
	getRichTextValue() {
		...
		if (data === null || data === void 0 ? void 0 : data.p) return new _univerjs_core.RichTextValue(data.p);
		return null;
	}
	/**
	...
	*/
	getRichTextValues() {
		return this.getCellDataGrid().map((row) => row.map((data) => (data === null || data === void 0 ? void 0 : data.p) ? new _univerjs_core.RichTextValue(data.p) : null));
	}
	/**
	...
	*/
	getValueAndRichTextValue() {
		...
		return (cell === null || cell === void 0 ? void 0 : cell.p) ? new _univerjs_core.RichTextValue(cell.p) : cell === null || cell === void 0 ? void 0 : cell.v;
	}
	/**
	...
	*/
	getValueAndRichTextValues() {
		return this.getCellDatas().map((row) => row.map((data) => (data === null || data === void 0 ? void 0 : data.p) ? new _univerjs_core.RichTextValue(data.p) : data === null || data === void 0 ? void 0 : data.v));
	}
	/**
	...
	*/
	getWraps() {
		...
		return cells.map((row) => row.map((cell) => {
			var _styles$getStyleByCel;
			return ((_styles$getStyleByCel = styles.getStyleByCell(cell)) === null || _styles$getStyleByCel === void 0 ? void 0 : _styles$getStyleByCel.tb) === _univerjs_core.WrapStrategy.WRAP;
		}));
	}
	/**
	...
	*/
	getVerticalAlignments() {
		return this._worksheet.getRange(this._range).getVerticalAlignments().map((row) => row.map((alignment) => transformCoreVerticalAlignment(alignment)));
	}
	/**
	...
	*/
	setCustomMetaData(data) {
		...
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetRangeCustomMetadataCommand.id, params);
		return this;
	}
	/**
	...
	*/
	setBorder(type, style, color) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetBorderBasicCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			ranges: [this._range],
			value: {
	...
	*/
	setBackgroundColor(color) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetStyleCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			range: this._range,
			style: {
	...
	*/
	setTextRotation(rotation) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetTextRotationCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			range: this._range,
			value: rotation
	...
	*/
	setValue(value) {
		const realValue = (0, _univerjs_core.covertCellValue)(value);
		if (!realValue) throw new Error("Invalid value");
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetRangeValuesCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			range: this._range,
			value: realValue
	...
	*/
	setRichTextValueForCell(value) {
		const p = value instanceof _univerjs_core.RichTextValue ? value.getData() : value;
		const params = {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			range: {
	...
	*/
	setWrap(isWrapEnabled) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetTextWrapCommand.id, {
			...
			subUnitId: this._worksheet.getSheetId(),
			range: this._range,
			value: isWrapEnabled ? _univerjs_core.WrapStrategy.WRAP : _univerjs_core.WrapStrategy.UNSPECIFIED
		});
		return this;
	}
	/**
	...
	*/
	setVerticalAlignment(alignment) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetVerticalTextAlignCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			range: this._range,
	...
	*/
	setHorizontalAlignment(alignment) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetHorizontalTextAlignCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			range: this._range,
	...
	*/
	setValues(value) {
		const realValue = (0, _univerjs_core.covertCellValues)(value, this._range);
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetRangeValuesCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			range: this._range,
	...
	*/
	setFontWeight(fontWeight) {
		let value;
		if (fontWeight === "bold") value = _univerjs_core.BooleanNumber.TRUE;
		else if (fontWeight === "normal") value = _univerjs_core.BooleanNumber.FALSE;
		else if (fontWeight === null) value = null;
		else throw new Error("Invalid fontWeight");
		const style = {
			type: "bl",
			value
		};
		...
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetStyleCommand.id, setStyleParams);
		return this;
	}
	/**
	...
	*/
	setFontStyle(fontStyle) {
		let value;
		if (fontStyle === "italic") value = _univerjs_core.BooleanNumber.TRUE;
		else if (fontStyle === "normal") value = _univerjs_core.BooleanNumber.FALSE;
		else if (fontStyle === null) value = null;
		else throw new Error("Invalid fontStyle");
		const style = {
			type: "it",
			value
		};
	...
	*/
	setFontLine(fontLine) {
		if (fontLine === "underline") this._setFontUnderline({ s: _univerjs_core.BooleanNumber.TRUE });
		else if (fontLine === "line-through") this._setFontStrikethrough({ s: _univerjs_core.BooleanNumber.TRUE });
		else if (fontLine === "none") {
			this._setFontUnderline({ s: _univerjs_core.BooleanNumber.FALSE });
			this._setFontStrikethrough({ s: _univerjs_core.BooleanNumber.FALSE });
		} else if (fontLine === null) {
			this._setFontUnderline(null);
			this._setFontStrikethrough(null);
		} else throw new Error("Invalid fontLine");
		return this;
	}
	/**
	...
	*/
	merge(options) {
		const unitId = this._workbook.getUnitId();
		const subUnitId = this._worksheet.getSheetId();
		(0, _univerjs_sheets.addMergeCellsUtil)(this._injector, unitId, subUnitId, [this._range], options);
		return this;
	}
	/**
	...
	*/
	mergeAcross(options) {
		const ranges = (0, _univerjs_sheets.getAddMergeMutationRangeByType)([this._range], _univerjs_core.Dimension.ROWS);
		const unitId = this._workbook.getUnitId();
		const subUnitId = this._worksheet.getSheetId();
		(0, _univerjs_sheets.addMergeCellsUtil)(this._injector, unitId, subUnitId, ranges, options);
		return this;
	}
	/**
	...
	*/
	mergeVertically(options) {
		const ranges = (0, _univerjs_sheets.getAddMergeMutationRangeByType)([this._range], _univerjs_core.Dimension.COLUMNS);
		const unitId = this._workbook.getUnitId();
		const subUnitId = this._worksheet.getSheetId();
		(0, _univerjs_sheets.addMergeCellsUtil)(this._injector, unitId, subUnitId, ranges, options);
		return this;
	...
	*/
	breakApart() {
		this._commandService.syncExecuteCommand(_univerjs_sheets.RemoveWorksheetMergeCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			ranges: [this._range]
		});
	...
	*/
	getA1Notation(withSheet, startAbsoluteRefType, endAbsoluteRefType) {
		...
		return withSheet ? (0, _univerjs_engine_formula.serializeRangeWithSheet)(this._worksheet.getName(), range) : (0, _univerjs_engine_formula.serializeRange)(range);
	}
	/**
	...
	*/
	activate() {
		this._injector.createInstance(FWorkbook, this._workbook).setActiveRange(this);
		return this;
	}
	/**
	...
	*/
	activateAsCurrentCell() {
		...
		if (mergeInfo && _univerjs_core.Rectangle.equals(mergeInfo, this._range) || !mergeInfo && this._range.startRow === this._range.endRow && this._range.startColumn === this._range.endColumn) {
			const activeRange = this._injector.createInstance(FWorkbook, this._workbook).getActiveRange();
			if (!activeRange || activeRange.getUnitId() !== this.getUnitId() || activeRange.getSheetId() !== this.getSheetId()) return this.activate();
			if (_univerjs_core.Rectangle.contains(activeRange.getRange(), this._range)) {
				const setSelectionOperationParams = {
					unitId: this.getUnitId(),
					subUnitId: this.getSheetId(),
					selections: [{
						range: activeRange.getRange(),
						primary: (0, _univerjs_sheets.getPrimaryForRange)(this.getRange(), this._worksheet),
						style: null
					}]
				};
				this._commandService.syncExecuteCommand(_univerjs_sheets.SetSelectionsOperation.id, setSelectionOperationParams);
				return this;
			}
			return this.activate();
		} else throw new Error("The range is not a single cell");
	}
	/**
	...
	*/
	splitTextToColumns(treatMultipleDelimitersAsOne, delimiter, customDelimiter) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.SplitTextToColumnsCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			range: this._range,
			delimiter,
	...
	*/
	useThemeStyle(themeName) {
		if (themeName === null || themeName === void 0) {
			...
			if (usedThemeName) this.removeThemeStyle(usedThemeName);
		} else this._commandService.syncExecuteCommand(_univerjs_sheets.SetWorksheetRangeThemeStyleCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			range: this._range,
			themeName
	...
	*/
	removeThemeStyle(themeName) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.DeleteWorksheetRangeThemeStyleCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			range: this._range,
			themeName
	...
	*/
	getUsedThemeStyle() {
		return this._injector.get(_univerjs_sheets.SheetRangeThemeService).getAppliedRangeThemeStyle({
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			range: this._range
		});
	...
	*/
	clear(options) {
		if (options && options.contentsOnly && !options.formatOnly) return this.clearContent();
		if (options && options.formatOnly && !options.contentsOnly) return this.clearFormat();
		this._commandService.syncExecuteCommand(_univerjs_sheets.ClearSelectionAllCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			ranges: [this._range],
			options
	...
	*/
	clearContent() {
		this._commandService.syncExecuteCommand(_univerjs_sheets.ClearSelectionContentCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			ranges: [this._range]
		});
	...
	*/
	clearFormat() {
		this._commandService.syncExecuteCommand(_univerjs_sheets.ClearSelectionFormatCommand.id, {
			unitId: this._workbook.getUnitId(),
			subUnitId: this._worksheet.getSheetId(),
			ranges: [this._range]
		});
	...
	*/
	insertCells(shiftDimension) {
		if (shiftDimension === _univerjs_core.Dimension.ROWS) this._commandService.executeCommand(_univerjs_sheets.InsertRangeMoveDownCommand.id, { range: this._range });
		else this._commandService.executeCommand(_univerjs_sheets.InsertRangeMoveRightCommand.id, { range: this._range });
	}
	/**
	...
	*/
	deleteCells(shiftDimension) {
		if (shiftDimension === _univerjs_core.Dimension.ROWS) this._commandService.executeCommand(_univerjs_sheets.DeleteRangeMoveUpCommand.id, { range: this._range });
		else this._commandService.executeCommand(_univerjs_sheets.DeleteRangeMoveLeftCommand.id, { range: this._range });
	}
	/**
	...
	*/
	getDataRegion(dimension) {
		...
		if (dimension !== _univerjs_core.Dimension.COLUMNS) {
			let topRowHasValue = false;
			let bottomRowHasValue = false;
			for (let c = startColumn; c <= endColumn; c++) {
				if (startRow > 0 && !(0, _univerjs_core.isNullCell)(cellMatrix.getValue(startRow - 1, c))) topRowHasValue = true;
				if (endRow < maxRows - 1 && !(0, _univerjs_core.isNullCell)(cellMatrix.getValue(endRow + 1, c))) bottomRowHasValue = true;
				if (topRowHasValue && bottomRowHasValue) break;
			}
			if (topRowHasValue) newStartRow = startRow - 1;
			if (bottomRowHasValue) newEndRow = endRow + 1;
		}
		if (dimension !== _univerjs_core.Dimension.ROWS) {
			let leftColumnHasValue = false;
			let rightColumnHasValue = false;
			for (let r = startRow; r <= endRow; r++) {
				if (startColumn > 0 && !(0, _univerjs_core.isNullCell)(cellMatrix.getValue(r, startColumn - 1))) leftColumnHasValue = true;
				if (endColumn < maxColumns - 1 && !(0, _univerjs_core.isNullCell)(cellMatrix.getValue(r, endColumn + 1))) rightColumnHasValue = true;
				if (leftColumnHasValue && rightColumnHasValue) break;
			}
			if (leftColumnHasValue) newStartColumn = startColumn - 1;
			if (rightColumnHasValue) newEndColumn = endColumn + 1;
		}
		return this._injector.createInstance(_FRange, this._workbook, this._worksheet, {
	...
	*/
	isBlank() {
		...
		let isBlank = true;
		for (let r = startRow; r <= endRow; r++) {
			for (let c = startColumn; c <= endColumn; c++) if (!(0, _univerjs_core.isNullCell)(cellMatrix.getValue(r, c))) {
				isBlank = false;
				break;
			}
			if (!isBlank) break;
	...
	*/
	offset(rowOffset, columnOffset, numRows, numColumns) {
		...
		if (newStartRow < 0 || newStartColumn < 0 || newEndRow < 0 || newEndColumn < 0) throw new Error("The row or column index is out of range");
		return this._injector.createInstance(_FRange, this._workbook, this._worksheet, {
			startRow: newStartRow,
			startColumn: newStartColumn,
			endRow: newEndRow,
	...
	*/
	setFormula(formula) {
		return this.setValue({ f: formula });
	}
	/**
	...
	*/
	getRangePermission() {
		...
		return this._injector.createInstance(FRangePermission, this._workbook.getUnitId(), this._worksheet.getSheetId(), this, fWorksheet);
	}
	/**
	...
	*/
	autoFill(targetRange, applyType) {
		...
		if (!_univerjs_core.Rectangle.contains(_targetRange, _sourceRange)) throw new Error("AutoFill target range must contain source range");
		...
		if (sourceEndRow - sourceStartRow !== targetEndRow - targetStartRow && sourceEndColumn - sourceStartColumn !== targetEndColumn - targetStartColumn) throw new Error("AutoFill can only fill in one direction");
		if (sourceEndRow - sourceStartRow === targetEndRow - targetStartRow && sourceStartColumn !== targetStartColumn && sourceEndColumn !== targetEndColumn) throw new Error("AutoFill can only fill in one direction");
		if (sourceEndColumn - sourceStartColumn === targetEndColumn - targetStartColumn && sourceStartRow !== targetStartRow && sourceEndRow !== targetEndRow) throw new Error("AutoFill can only fill in one direction");
		return this._commandService.executeCommand(_univerjs_sheets.AutoFillCommand.id, {
...
//#endregion
//#region src/facade/permission/f-workbook-permission.ts
let FWorkbookPermission = class FWorkbookPermission extends _univerjs_core_facade.FBase {
	...
	_getModePermissions(mode) {
		...
		switch (mode) {
			case "owner":
				...
				break;
			case "editor":
				pointsToSet["WorkbookEdit"] = true;
				pointsToSet["WorkbookView"] = true;
				pointsToSet["WorkbookPrint"] = true;
				pointsToSet["WorkbookExport"] = true;
				pointsToSet["WorkbookCopy"] = true;
				pointsToSet["WorkbookComment"] = true;
				pointsToSet["WorkbookCreateSheet"] = true;
				pointsToSet["WorkbookDeleteSheet"] = true;
				pointsToSet["WorkbookRenameSheet"] = true;
				pointsToSet["WorkbookMoveSheet"] = true;
				pointsToSet["WorkbookHideSheet"] = true;
				pointsToSet["WorkbookInsertRow"] = true;
				pointsToSet["WorkbookInsertColumn"] = true;
				pointsToSet["WorkbookDeleteRow"] = true;
				pointsToSet["WorkbookDeleteColumn"] = true;
				pointsToSet["WorkbookCopySheet"] = true;
				pointsToSet["WorkbookCreateProtect"] = true;
				break;
			case "viewer":
				pointsToSet["WorkbookView"] = true;
				pointsToSet["WorkbookPrint"] = true;
	...
	*/
	async setPoint(point, value) {
		...
		if (!PermissionPointClass) throw new Error(`Unknown workbook permission point: ${point}`);
	...
	*/
	canEdit() {
		return this.getPoint("WorkbookEdit");
	}
	/**
	* Get the value of a specific permission point.
	...
	*/
	async removeCollaborators(userIds) {
		await Promise.all(userIds.map((userId) => this.removeCollaborator(userId)));
	}
	/**
	...
	*/
	async listCollaborators() {
		return (await this._authzIoService.listCollaborators({
			...
			var _c$subject, _c$subject2, _c$subject3;
			return {
				user: {
					userID: ((_c$subject = c.subject) === null || _c$subject === void 0 ? void 0 : _c$subject.userID) || c.id,
					name: ((_c$subject2 = c.subject) === null || _c$subject2 === void 0 ? void 0 : _c$subject2.name) || "",
					avatar: ((_c$subject3 = c.subject) === null || _c$subject3 === void 0 ? void 0 : _c$subject3.avatar) || ""
				},
				role: c.role
			};
		});
...
FWorkbookPermission = __decorate([
	__decorateParam(1, (0, _univerjs_core.Inject)(_univerjs_core.Injector)),
	__decorateParam(2, _univerjs_core.IPermissionService),
	__decorateParam(3, _univerjs_core.IAuthzIoService)
], FWorkbookPermission);
...
let FWorkbook = class FWorkbook extends _univerjs_core_facade.FBaseInitialable {
	...
	*/
	setName(name) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetWorkbookNameCommand.id, {
			unitId: this._workbook.getUnitId(),
			name
		});
		return this;
	...
	*/
	create(name, rows, columns, options) {
		...
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetWorksheetActiveOperation.id, {
			unitId: this.id,
	...
	*/
	deleteSheet(sheet) {
		...
		return this._commandService.syncExecuteCommand(_univerjs_sheets.RemoveSheetCommand.id, {
			unitId,
			subUnitId
		});
	}
	...
	*/
	undo() {
		...
		this._commandService.syncExecuteCommand(_univerjs_core.UndoCommand.id);
		return this;
	}
	/**
	...
	*/
	redo() {
		this._univerInstanceService.focusUnit(this.id);
		this._commandService.syncExecuteCommand(_univerjs_core.RedoCommand.id);
		return this;
	}
	/**
	...
	*/
	onBeforeCommandExecute(callback) {
		return this._commandService.beforeCommandExecuted((command) => {
			var _params;
			if (((_params = command.params) === null || _params === void 0 ? void 0 : _params.unitId) !== this.id) return;
			callback(command);
		});
	}
	/**
	...
	*/
	onCommandExecuted(callback) {
		return this._commandService.onCommandExecuted((command) => {
			var _params2;
			if (((_params2 = command.params) === null || _params2 === void 0 ? void 0 : _params2.unitId) !== this.id) return;
			callback(command);
		});
	}
	/**
	...
	*/
	setEditable(value) {
		const instance = new _univerjs_sheets.WorkbookEditablePermission(this._workbook.getUnitId());
		if (!this._permissionService.getPermissionPoint(instance.id)) this._permissionService.addPermissionPoint(instance);
		this._permissionService.updatePermissionPoint(instance.id, value);
		return this;
	}
	/**
	...
	*/
	setActiveRange(range) {
		...
		if (!worksheet) throw new Error("No active sheet found");
		if (worksheet.getSheetId() !== sheet.getSheetId()) this.setActiveSheet(this._injector.createInstance(FWorksheet, this, this._workbook, worksheet));
		const setSelectionOperationParams = {
			unitId: this.getId(),
			subUnitId: sheetId,
			selections: [range].map((r) => ({
				range: r.getRange(),
				primary: (0, _univerjs_sheets.getPrimaryForRange)(r.getRange(), worksheet),
				style: null
			}))
		};
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetSelectionsOperation.id, setSelectionOperationParams);
	...
	*/
	getActiveRange() {
		const activeSheet = this._workbook.getActiveSheet();
		const active = this._selectionManagerService.getCurrentSelections().find((selection) => !!selection.primary);
		if (!active) return null;
	...
	*/
	duplicateSheet(sheet) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.CopySheetCommand.id, {
	...
	*/
	moveSheet(sheet, index) {
		...
		if (sheetIndexVal < 0) sheetIndexVal = 0;
		else if (sheetIndexVal > this._workbook.getSheets().length - 1) sheetIndexVal = this._workbook.getSheets().length - 1;
		this._commandService.syncExecuteCommand(_univerjs_sheets.SetWorksheetOrderCommand.id, {
			unitId: sheet.getWorkbook().getUnitId(),
			order: sheetIndexVal,
			subUnitId: sheet.getSheetId()
		});
	...
	*/
	getDefinedName(name) {
		...
		return this._injector.createInstance(FDefinedName, {
			...definedName,
			unitId: this.id
		});
	}
	...
	*/
	getRegisteredRangeThemes() {
		return this._injector.get(_univerjs_sheets.SheetRangeThemeService).getRegisteredRangeThemes();
	}
	/**
	...
	*/
	registerRangeTheme(rangeThemeStyle) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.RegisterWorksheetRangeThemeStyleCommand.id, {
			unitId: this.getId(),
			rangeThemeStyle
		});
	}
	...
	*/
	unregisterRangeTheme(themeName) {
		this._commandService.syncExecuteCommand(_univerjs_sheets.UnregisterWorksheetRangeThemeStyleCommand.id, {
			unitId: this.getId(),
			themeName
		});
	}
	...
	*/
	createRangeThemeStyle(themeName, themeStyleJson) {
		return new _univerjs_sheets.RangeThemeStyle(themeName, themeStyleJson);
	}
	/**
...
FWorkbook = __decorate([
	__decorateParam(1, (0, _univerjs_core.Inject)(_univerjs_core.Injector)),
	__decorateParam(2, (0, _univerjs_core.Inject)(_univerjs_core.IResourceLoaderService)),
...
var FUniverSheetsMixin = class extends _univerjs_core_facade.FUniver {
	...
	*/
	_initialize(injector) {
		...
		this.disposeWithMe(this.registerEventHandler(this.Event.SheetValueChanged, () => commandService.onCommandExecuted((commandInfo) => {
			if (_univerjs_sheets.COMMAND_LISTENER_VALUE_CHANGE.indexOf(commandInfo.id) > -1) {
				if (!this.getActiveSheet()) return;
				const ranges = (0, _univerjs_sheets.getValueChangedEffectedRange)(univerInstanceService, commandInfo).map((range) => {
...
* limitations under the License.
*/
var FSheetsEnumMixin = class extends _univerjs_core_facade.FEnum {
	get SheetValueChangeType() {
		return _univerjs_sheets.SheetValueChangeType;
	}
	get SheetSkeletonChangeType() {
		return _univerjs_sheets.SheetSkeletonChangeType;
	}
	get SplitDelimiterType() {
		return _univerjs_sheets.SplitDelimiterEnum;
	}
	get UnitRole() {
		return UnitRole$3;
	}
...
_univerjs_core_facade.FEnum.extend(FSheetsEnumMixin);

//#endregion
//#region src/facade/f-event.ts
var FSheetsEventNameMixin = class extends _univerjs_core_facade.FEventName {
	get SheetCreated() {
		return "SheetCreated";
	}
...
Object.defineProperty(exports, 'FSelection', {
  enumerable: true,
  get: function () {
    return FSelection;
  }
...
Object.defineProperty(exports, 'FWorkbookPermission', {
  enumerable: true,
  get: function () {
    return FWorkbookPermission;
  }
});
Object.defineProperty(exports, 'FWorksheet', {
  enumerable: true,
  get: function () {
    return FWorksheet;
  }
