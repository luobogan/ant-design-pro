	...
	ARRAY_CONSTRAIN: {
		...
		functionParameter: {
			inputRange: {
				...
				detail: "L'interval a restringir."
			},
			numRows: {
				name: "num_files",
...
const locale$14 = {
	...
	HYPGEOMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "acumulat",
				detail: "Un valor lògic que determina la forma de la funció. Si és CERT, DISTR.HIPERGEOM retorna la funció de distribució acumulada; si és FALS, retorna la funció de densitat de probabilitat."
			}
		}
	},
	LOGINV: {
	...
	NEGBINOMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "acumulat",
				detail: "Un valor lògic que determina la forma de la funció. Si és CERT, DISTR.NEGBINOM retorna la funció de distribució acumulada; si és FALS, retorna la funció de densitat de probabilitat."
			}
		}
	},
	NORMDIST: {
...
const locale$11 = {
	...
	DATEDIF: {
		...
		functionParameter: {
			...
			method: {
				name: "mètode",
				detail: "El tipus d'informació que voleu que es retorni."
			}
		}
	},
	DATEVALUE: {
	...
	EPOCHTODATE: {
		...
		functionParameter: {
			timestamp: {
				name: "marca_temps",
				detail: "Una marca de temps d'època Unix, en segons, mil·lisegons o microsegons."
			},
			unit: {
				name: "unitat",
				detail: "La unitat de temps en què s'expressa la marca de temps. 1 per defecte: \\n1 indica que la unitat de temps són segons. \\n2 indica que la unitat de temps són mil·lisegons.\\n3 indica que la unitat de temps són microsegons."
			}
		}
	},
	HOUR: {
	...
	TO_DATE: {
		...
		functionParameter: { value: {
			name: "valor",
			detail: "L'argument o referència a una cel·la que es convertirà a una data."
		} }
	},
	TODAY: {
...
const locale$10 = {
	...
	IMCOTH: {
		...
		functionParameter: { inumber: {
			name: "núm_imaginari",
			detail: "Un nombre complex del qual voleu obtenir la cotangent hiperbòlica."
		} }
	},
	IMCSC: {
	...
	IMLOG: {
		...
		functionParameter: {
			inumber: {
				name: "núm_imaginari",
				detail: "Un nombre complex el logaritme del qual a una base específica s'ha de calcular."
			},
			base: {
				name: "base",
				detail: "La base que es fa servir en calcular el logaritme."
			}
		}
	},
	IMLOG10: {
	...
	IMTANH: {
		...
		functionParameter: { inumber: {
			name: "núm_imaginari",
			detail: "Un nombre complex del qual voleu obtenir la tangent hiperbòlica."
		} }
	},
	OCT2BIN: {
...
const locale$8 = {
	...
	ISURL: {
		...
		functionParameter: { value: {
			name: "valor",
			detail: "El valor que s'ha de verificar com a URL."
		} }
	},
	N: {
...
const locale$6 = {
	...
	HYPERLINK: {
		...
		functionParameter: {
			url: {
				name: "url",
				detail: "L'URL complet de la ubicació de l'enllaç tancat entre cometes, o una referència a una cel·la que contingui aquest URL."
			},
			linkLabel: {
				name: "etiqueta_enllaç",
				detail: "El text a mostrar a la cel·la com a enllaç, tancat entre cometes, o una referència a una cel·la que contingui aquesta etiqueta."
			}
		}
	},
	IMAGE: {
...
const locale$4 = {
	...
	AVERAGE_WEIGHTED: {
		...
		functionParameter: {
			values: {
				name: "valors",
				detail: "Els valors per calcular la mitjana."
			},
			weights: {
				name: "ponderacions",
				detail: "La llista de ponderacions corresponents a aplicar."
			},
			additionalValues: {
				name: "valors_addicionals",
				detail: "Altres valors per calcular la mitjana."
			},
			additionalWeights: {
				name: "ponderacions_addicionals",
				detail: "Altres ponderacions a aplicar."
			}
		}
	},
	AVERAGEA: {
	...
	MARGINOFERROR: {
		...
		functionParameter: {
			range: {
				name: "rang",
				detail: "El rang de valors utilitzat per calcular el marge d'error."
			},
			confidence: {
				name: "confiança",
...
const locale$3 = {
	...
	REGEXMATCH: {
		...
		functionParameter: {
			text: {
				name: "text",
				detail: "El text a provar amb l'expressió regular."
			},
			regularExpression: {
				name: "expressió_regular",
				detail: "L'expressió regular amb la qual provar el text."
			}
		}
	},
	REGEXREPLACE: {
		...
		functionParameter: {
			text: {
				name: "text",
				detail: "El text, una part del qual serà substituïda."
			},
			regularExpression: {
				name: "expressió_regular",
				detail: "L'expressió regular. Totes les instàncies coincidents en el text seran substituïdes."
			},
			replacement: {
				name: "substitució",
				detail: "El text que s'inserirà en el text original."
			}
		}
	},
	REPLACE: {
