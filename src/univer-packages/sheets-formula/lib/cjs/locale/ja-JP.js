...
const locale$14 = {
	...
	STDEV: {
		...
		functionParameter: {
			...
			number2: {
				name: "number2",
				detail: "母集団のサンプルに対応する引数 2 から 255 の数値。 また、半角のカンマ (,) で区切られた引数の代わりに、単一配列や、配列への参照を指定することもできます。"
			}
		}
	},
	STDEVP: {
		...
		functionParameter: {
			...
			number2: {
				name: "数値 2",
				detail: "母集団に対応する引数 2 ~ 255 を数える。 また、半角のカンマ (,) で区切られた引数の代わりに、単一配列や、配列への参照を指定することもできます。"
			}
		}
	},
	TDIST: {
	...
	VAR: {
		...
		functionParameter: {
			...
			number2: {
				name: "数値 2",
				detail: "母集団のサンプルに対応する引数 2 から 255 の数値。"
			}
		}
	},
	VARP: {
...
const locale$12 = {
	DAVERAGE: {
		...
		functionParameter: {
			database: {
				name: "データベース",
				detail: "リストまたはデータベースを構成するセル範囲を指定します。"
			},
			field: {
				name: "フィールド",
				detail: "関数の中で使用する列を指定します。"
			},
			criteria: {
				name: "検索条件",
				detail: "指定した条件が設定されているセル範囲を指定します。"
			}
		}
	},
	DCOUNT: {
...
const locale$11 = {
	...
	DATEDIF: {
		...
		functionParameter: {
			startDate: {
				name: "開始日",
				detail: "指定した期間の最初の日付または開始日を表す日付。"
			},
			endDate: {
				name: "終了日",
	...
	EPOCHTODATE: {
		...
		functionParameter: {
			timestamp: {
				name: "タイムスタンプ",
				detail: "Unix エポック タイムスタンプ（秒、ミリ秒、またはマイクロ秒）。"
			},
			unit: {
				name: "時間の単位",
				detail: "タイムスタンプを表示する時間の単位。デフォルト値は 1: \n1 は時間単位が秒であることを示します。\n2 は時間単位がミリ秒であることを示します。\n3 は時間単位がマイクロ秒であることを示します。"
			}
		}
	},
	HOUR: {
	...
	ISOWEEKNUM: {
		...
		functionParameter: { date: {
			name: "日付",
			detail: "で日付や時刻の計算に使用されるコードのことです。"
		} }
	},
	MINUTE: {
	...
	MONTH: {
		...
		functionParameter: { serialNumber: {
			name: "シリアル値",
			detail: "検索する月の日付を指定します。 日付は、DATE 関数を使って入力するか、他の数式または他の関数の結果として指定します。 たとえば、2008 年 5 月 23 日を入力する場合は、DATE(2008,5,23) を使用します。"
		} }
	},
	NETWORKDAYS: {
	...
	TIME: {
		...
		functionParameter: {
			hour: {
				name: "時",
				detail: "時間を表す 0 (ゼロ) から 32767 までの数値。 23 より大きい値は 24 で割られ、残りは時間値として扱われます。 たとえば、TIME(27,0,0) = TIME(3,0,0) = .125 または 3:00 AM。"
			},
			minute: {
				name: "分",
				detail: "分を表す 0 から 32767 までの数値。 59 より大きい値は、時間と分に変換されます。 たとえば、TIME(0,750,0) = TIME(12,30,0) = .520833 または 12:30 PM。"
			},
			second: {
				name: "秒",
				detail: "2 番目を表す 0 から 32767 までの数値。 59 を超える値は、時間、分、秒に変換されます。 たとえば、TIME(0,0,2000) = TIME(0,33,22) = .023148 または 12:33:20 AM。"
			}
		}
	},
	TIMEVALUE: {
...
const locale$10 = {
	...
	IMLOG: {
		...
		functionParameter: {
			inumber: {
				name: "複素数",
				detail: "特定の底に対する対数を計算する必要がある複素数。"
			},
			base: {
				name: "底",
				detail: "対数を求めるときに使用する底です。"
			}
		}
	},
	IMLOG10: {
...
const locale$8 = {
	...
	ISBLANK: {
		...
		functionParameter: { value: {
			name: "値",
			detail: "テストする値を指定します。テストの対象引数には、空白セル、エラー、論理値、文字列、数値、参照値、または対象となるデータを参照する名前を指定することができます。"
		} }
	},
	ISDATE: {
...
const locale$6 = {
	...
	HYPERLINK: {
		...
		functionParameter: {
			url: {
				name: "URL",
				detail: "リンクの場所の完全な URL を二重引用符で囲んで指定します。または、URL を含むセルへの参照を指定します。"
			},
			linkLabel: {
				name: "リンクラベル",
				detail: "セルにリンクとして表示するテキストを二重引用符で囲んで指定します。または、ラベルを含むセルへの参照を指定します。"
			}
		}
	},
	IMAGE: {
...
const locale$5 = {
	...
	ATANH: {
		...
		functionParameter: { number: {
			name: "数値",
			detail: "-1 より大きく 1 より小さい実数を指定します。"
		} }
	},
	BASE: {
...
const locale$4 = {
	...
	AVERAGE_WEIGHTED: {
		...
		functionParameter: {
			...
			weights: {
				name: "ウェイト",
				detail: "適用するウェイトの対応するリストを指定します。"
			},
			additionalValues: {
				name: "追加の値",
				detail: "平均化する追加の値を指定します。"
			},
			additionalWeights: {
				name: "追加のウェイト",
				detail: "適用する追加のウェイトを指定します。"
			}
		}
	},
	AVERAGEA: {
	...
	COUNTA: {
		...
		functionParameter: {
			number1: {
				name: "数値 1",
				detail: "計算対象として含める値を表す 1 つ目の引数。"
			},
			number2: {
				name: "数値 2",
				detail: "カウントする値を表す追加の引数 (最大 255 個の引数)。"
			}
		}
	},
	COUNTBLANK: {
