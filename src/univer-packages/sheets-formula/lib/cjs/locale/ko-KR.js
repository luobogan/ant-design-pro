...
const locale$15 = {
	...
	FLATTEN: {
		...
		functionParameter: {
			range1: {
				name: "range1",
				detail: "첫 번째로 평면화할 범위입니다."
			},
			range2: {
				name: "range2",
				detail: "추가로 평면화할 범위입니다."
			}
		}
	}
};
...
const locale$14 = {
	...
	BINOMDIST: {
		...
		functionParameter: {
			...
			probabilityS: {
				name: "probability_s",
				detail: "각 시행에서 성공할 확률입니다."
			},
			cumulative: {
				name: "cumulative",
				detail: "함수의 형태를 결정하는 논리값입니다. cumulative가 TRUE이면 BINOMDIST는 누적 분포 함수를 반환하고, FALSE이면 확률 밀도 함수를 반환합니다."
			}
		}
	},
	CHIDIST: {
	...
	CHITEST: {
		...
		functionParameter: {
			actualRange: {
				name: "actual_range",
				detail: "예상 값에 대해 테스트할 관측값이 포함된 데이터 범위입니다."
			},
			expectedRange: {
				name: "expected_range",
				detail: "행 합계와 열 합계의 곱을 총 합계로 나눈 비율이 포함된 데이터 범위입니다."
			}
		}
	},
	CONFIDENCE: {
		...
		functionParameter: {
			alpha: {
				name: "alpha",
				detail: "신뢰 수준을 계산하는 데 사용되는 유의 수준입니다. 신뢰 수준은 100*(1 - alpha)% 또는 즉, 0.05의 alpha는 95% 신뢰 수준을 나타냅니다."
			},
			standardDev: {
				name: "standard_dev",
				detail: "데이터 범위에 대한 모집단 표준 편차이며 알려진 것으로 가정됩니다."
			},
			size: {
				name: "size",
				detail: "표본 크기입니다."
	...
	COVAR: {
		...
		functionParameter: {
			array1: {
				name: "array1",
				detail: "첫 번째 셀 값 범위입니다."
			},
			array2: {
				name: "array2",
				detail: "두 번째 셀 값 범위입니다."
			}
		}
	},
	CRITBINOM: {
	...
	EXPONDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "cumulative",
				detail: "함수의 형태를 결정하는 논리값입니다. cumulative가 TRUE이면 EXPONDIST는 누적 분포 함수를 반환하고, FALSE이면 확률 밀도 함수를 반환합니다."
			}
		}
	},
	FDIST: {
	...
	FTEST: {
		...
		functionParameter: {
			array1: {
				name: "array1",
				detail: "첫 번째 배열 또는 데이터 범위입니다."
			},
			array2: {
				name: "array2",
				detail: "두 번째 배열 또는 데이터 범위입니다."
			}
		}
	},
	GAMMADIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "cumulative",
				detail: "함수의 형태를 결정하는 논리값입니다. cumulative가 TRUE이면 GAMMADIST는 누적 분포 함수를 반환하고, FALSE이면 확률 밀도 함수를 반환합니다."
			}
		}
	},
	GAMMAINV: {
	...
	HYPGEOMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "cumulative",
				detail: "함수의 형태를 결정하는 논리값입니다. cumulative가 TRUE이면 HYPGEOMDIST는 누적 분포 함수를 반환하고, FALSE이면 확률 밀도 함수를 반환합니다."
			}
		}
	},
	LOGINV: {
	...
	LOGNORMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "cumulative",
				detail: "함수의 형태를 결정하는 논리값입니다. cumulative가 TRUE이면 LOGNORM.DIST는 누적 분포 함수를 반환하고, FALSE이면 확률 밀도 함수를 반환합니다."
			}
		}
	},
	MODE: {
		...
		functionParameter: {
			number1: {
				name: "number1",
				detail: "최빈값을 계산할 첫 번째 숫자, 셀 참조 또는 범위입니다."
			},
			number2: {
				name: "number2",
				detail: "최빈값을 계산할 추가 숫자, 셀 참조 또는 범위로 최대 255개까지 지정할 수 있습니다."
			}
		}
	},
	NEGBINOMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "cumulative",
				detail: "함수의 형태를 결정하는 논리값입니다. cumulative가 TRUE이면 NEGBINOMDIST는 누적 분포 함수를 반환하고, FALSE이면 확률 밀도 함수를 반환합니다."
			}
		}
	},
	NORMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "cumulative",
				detail: "함수의 형태를 결정하는 논리값입니다. cumulative가 TRUE이면 NORMDIST는 누적 분포 함수를 반환하고, FALSE이면 확률 밀도 함수를 반환합니다."
			}
		}
	},
	NORMINV: {
	...
	PERCENTILE: {
		...
		functionParameter: {
			array: {
				name: "array",
				detail: "상대적 위치를 정의하는 데이터의 배열 또는 범위입니다."
			},
			k: {
				name: "k",
				detail: "0과 1 범위의 백분위수 값입니다 (0과 1 포함)."
			}
		}
	},
	PERCENTRANK: {
		...
		functionParameter: {
			...
			x: {
				name: "x",
				detail: "순위를 알고자 하는 값입니다."
			},
			significance: {
				name: "significance",
				detail: "반환된 백분율 값의 유효 자릿수를 식별하는 값입니다. 생략하면 PERCENTRANK.INC는 3자리 숫자(0.xxx)를 사용합니다."
			}
		}
	},
	POISSON: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "cumulative",
				detail: "함수의 형태를 결정하는 논리값입니다. cumulative가 TRUE이면 POISSON은 누적 분포 함수를 반환하고, FALSE이면 확률 밀도 함수를 반환합니다."
			}
		}
	},
	QUARTILE: {
		...
		functionParameter: {
			array: {
				name: "array",
				detail: "사분위수 값을 구할 데이터의 배열 또는 범위입니다."
			},
			quart: {
				name: "quart",
				detail: "반환할 사분위수 값입니다."
			}
		}
	},
	RANK: {
		...
		functionParameter: {
			...
			ref: {
				name: "ref",
				detail: "숫자 목록에 대한 참조입니다. ref의 숫자가 아닌 값은 무시됩니다."
			},
			order: {
				name: "order",
				detail: "숫자 순위를 매기는 방법을 지정하는 숫자입니다. order가 0(영) 또는 생략되면 Microsoft Excel은 ref가 내림차순으로 정렬된 목록인 것처럼 숫자의 순위를 매깁니다. order가 0이 아닌 값이면 Microsoft Excel은 ref가 오름차순으로 정렬된 목록인 것처럼 숫자의 순위를 매깁니다."
			}
		}
	},
	STDEV: {
		...
		functionParameter: {
			number1: {
				name: "number1",
				detail: "모집단의 표본에 해당하는 첫 번째 숫자 인수입니다."
			},
			number2: {
				name: "number2",
				detail: "모집단의 표본에 해당하는 2~255개의 숫자 인수입니다. 쉼표로 구분된 인수 대신 단일 배열이나 배열에 대한 참조를 사용할 수도 있습니다."
			}
		}
	},
	STDEVP: {
		...
		functionParameter: {
			...
			number2: {
				name: "number2",
				detail: "모집단에 해당하는 2~255개의 숫자 인수입니다. 쉼표로 구분된 인수 대신 단일 배열이나 배열에 대한 참조를 사용할 수도 있습니다."
			}
		}
	},
	TDIST: {
		...
		functionParameter: {
			...
			degFreedom: {
				name: "degFreedom",
				detail: "자유도 수를 나타내는 정수입니다."
			},
			tails: {
				name: "tails",
				detail: "반환할 분포 꼬리 수를 지정합니다. Tails = 1이면 TDIST는 단측 분포를 반환합니다. Tails = 2이면 TDIST는 양측 분포를 반환합니다."
			}
		}
	},
	TINV: {
	...
	TTEST: {
		...
		functionParameter: {
			...
			tails: {
				name: "tails",
				detail: "분포 꼬리 수를 지정합니다. tails = 1이면 TTEST는 단측 분포를 사용합니다. tails = 2이면 TTEST는 양측 분포를 사용합니다."
			},
			type: {
				name: "type",
				detail: "수행할 t-검정의 종류입니다."
			}
		}
	},
	VAR: {
		...
		functionParameter: {
			...
			number2: {
				name: "number2",
				detail: "모집단의 표본에 해당하는 2~255개의 숫자 인수입니다."
			}
		}
	},
	VARP: {
		...
		functionParameter: {
			...
			number2: {
				name: "number2",
				detail: "모집단에 해당하는 2~255개의 숫자 인수입니다."
			}
		}
	},
	WEIBULL: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "cumulative",
				detail: "함수의 형태를 결정하는 논리값입니다. cumulative가 TRUE이면 WEIBULL은 누적 분포 함수를 반환하고, FALSE이면 확률 밀도 함수를 반환합니다."
			}
		}
	},
	ZTEST: {
		...
		functionParameter: {
			array: {
				name: "array",
				detail: "x를 테스트할 데이터의 배열 또는 범위입니다."
			},
			x: {
				name: "x",
				detail: "테스트할 값입니다."
			...
			sigma: {
				name: "sigma",
				detail: "모집단(알려진) 표준 편차입니다. 생략하면 표본 표준 편차가 사용됩니다."
			}
		}
	}
};
...
const locale$12 = {
	DAVERAGE: {
		...
		functionParameter: {
			database: {
				name: "database",
				detail: "목록이나 데이터베이스를 구성하는 셀 범위입니다."
			},
			field: {
				name: "field",
				detail: "함수에서 사용되는 열을 나타냅니다."
			},
			criteria: {
				name: "criteria",
				detail: "지정한 조건이 포함된 셀 범위입니다."
			}
		}
	},
	DCOUNT: {
...
const locale$11 = {
	...
	DATEDIF: {
		...
		functionParameter: {
			startDate: {
				name: "start_date",
				detail: "지정된 기간의 첫 번째 또는 시작 날짜를 나타내는 날짜입니다."
			},
			endDate: {
				name: "end_date",
				detail: "기간의 마지막 또는 종료 날짜를 나타내는 날짜입니다."
			},
			method: {
				name: "method",
				detail: "반환하려는 정보의 유형입니다."
			}
		}
	},
	DATEVALUE: {
	...
	EPOCHTODATE: {
		...
		functionParameter: {
			timestamp: {
				name: "timestamp",
				detail: "초, 밀리초 또는 마이크로초 단위의 Unix epoch 타임스탬프입니다."
			},
			unit: {
				name: "unit",
				detail: "타임스탬프가 표현되는 시간 단위입니다. 기본값은 1입니다: \n1은 시간 단위가 초임을 나타냅니다. \n2는 시간 단위가 밀리초임을 나타냅니다.\n3은 시간 단위가 마이크로초임을 나타냅니다."
			}
		}
	},
	HOUR: {
	...
	ISOWEEKNUM: {
		...
		functionParameter: { date: {
			name: "date",
			detail: "날짜는 Excel에서 날짜 및 시간 계산에 사용하는 날짜-시간 코드입니다."
		} }
	},
	MINUTE: {
		...
		functionParameter: { serialNumber: {
			name: "serial_number",
			detail: "찾으려는 분의 날짜입니다. 날짜는 DATE 함수를 사용하여 입력하거나 다른 수식 또는 함수의 결과로 입력해야 합니다. 예를 들어, 2008년 5월 23일에는 DATE(2008,5,23)을 사용합니다."
		} }
	},
	MONTH: {
		...
		functionParameter: { serialNumber: {
			name: "serial_number",
			detail: "찾으려는 월의 날짜입니다. 날짜는 DATE 함수를 사용하여 입력하거나 다른 수식 또는 함수의 결과로 입력해야 합니다. 예를 들어, 2008년 5월 23일에는 DATE(2008,5,23)을 사용합니다."
		} }
	},
	NETWORKDAYS: {
	...
	SECOND: {
		...
		functionParameter: { serialNumber: {
			name: "serial_number",
			detail: "찾으려는 초의 날짜입니다. 날짜는 DATE 함수를 사용하여 입력하거나 다른 수식 또는 함수의 결과로 입력해야 합니다. 예를 들어, 2008년 5월 23일에는 DATE(2008,5,23)을 사용합니다."
		} }
	},
	TIME: {
	...
	TO_DATE: {
		...
		functionParameter: { value: {
			name: "value",
			detail: "날짜로 변환할 인수 또는 셀에 대한 참조입니다."
		} }
	},
	TODAY: {
...
const locale$9 = {
	...
	IPMT: {
		...
		functionParameter: {
			...
			per: {
				name: "per",
				detail: "이자를 찾으려는 기간으로 1에서 nper 사이의 범위에 있어야 합니다."
			},
			nper: {
				name: "nper",
				detail: "연금의 총 지불 기간 수입니다."
	...
	ISPMT: {
		...
		functionParameter: {
			...
			per: {
				name: "per",
				detail: "이자를 찾으려는 기간으로 1과 Nper 사이여야 합니다."
			},
			nper: {
				name: "nper",
				detail: "투자의 총 지불 기간 수입니다."
			},
			pv: {
				name: "pv",
				detail: "투자의 현재 가치입니다. 대출의 경우 Pv는 대출 금액입니다."
			}
		}
	},
	MDURATION: {
	...
	ISBETWEEN: {
		...
		functionParameter: {
			valueToCompare: {
				...
				detail: "`lower_value`와 `upper_value` 사이에 있는지 테스트할 값입니다."
			},
			lowerValue: {
				name: "lower_value",
				detail: "`value_to_compare`가 속할 수 있는 값 범위의 하한입니다."
			},
			upperValue: {
				name: "upper_value",
				detail: "`value_to_compare`가 속할 수 있는 값 범위의 상한입니다."
			},
			lowerValueIsInclusive: {
				name: "lower_value_is_inclusive",
				detail: "값 범위에 `lower_value`가 포함되는지 여부입니다. 기본적으로 TRUE입니다."
			},
			upperValueIsInclusive: {
				name: "upper_value_is_inclusive",
				detail: "값 범위에 `upper_value`가 포함되는지 여부입니다. 기본적으로 TRUE입니다."
			}
		}
	},
	ISBLANK: {
		...
		functionParameter: { value: {
			name: "value",
			detail: "테스트하려는 값입니다. value 인수는 빈 값(빈 셀), 오류, 논리값, 텍스트, 숫자 또는 참조 값이거나 이들 중 하나를 참조하는 이름일 수 있습니다."
		} }
	},
	ISDATE: {
...
const locale$6 = {
	...
	HYPERLINK: {
		...
		functionParameter: {
			url: {
				name: "url",
				detail: "따옴표로 묶인 링크 위치의 전체 URL 또는 이러한 URL을 포함하는 셀에 대한 참조입니다."
			},
			linkLabel: {
				name: "link_label",
				detail: "셀에 링크로 표시할 텍스트로, 따옴표로 묶이거나 이러한 레이블을 포함하는 셀에 대한 참조입니다."
			}
		}
	},
	IMAGE: {
