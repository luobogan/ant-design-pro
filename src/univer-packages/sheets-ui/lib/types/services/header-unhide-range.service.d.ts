...
export declare enum HeaderUnhideRangeAxis {
    ROW = "row",
    COLUMN = "column"
}
...
export type HeaderUnhideRangeVisibleHandler = (visible: boolean, payload: IHeaderUnhideRangeVisibleCheck) => boolean;
export declare class HeaderUnhideRangeService {
    private readonly _visibleHandlers;
