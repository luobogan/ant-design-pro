...
const locale$14 = {
	...
	BINOMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "累积",
				detail: "决定函数形式的逻辑值。如果为 TRUE，则 BINOMDIST 返回累积分布函数；如果为 FALSE，则返回概率密度函数。"
			}
		}
	},
	CHIDIST: {
	...
	EXPONDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "累积",
				detail: "决定函数形式的逻辑值。 如果为 TRUE，则 EXPONDIST 返回累积分布函数；如果为 FALSE，则返回概率密度函数。"
			}
		}
	},
	FDIST: {
	...
	GAMMADIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "累积",
				detail: "决定函数形式的逻辑值。如果为TRUE，则 GAMMADIST 返回累积分布函数；如果为 FALSE，则返回概率密度函数。"
			}
		}
	},
	GAMMAINV: {
	...
	HYPGEOMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "累积",
				detail: "决定函数形式的逻辑值。如果为TRUE，则 HYPGEOMDIST 返回累积分布函数；如果为 FALSE，则返回概率密度函数。"
			}
		}
	},
	LOGINV: {
	...
	LOGNORMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "累积",
				detail: "决定函数形式的逻辑值。 如果为 TRUE，则 LOGNORMDIST 返回累积分布函数；如果为 FALSE，则返回概率密度函数。"
			}
		}
	},
	MODE: {
	...
	NEGBINOMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "累积",
				detail: "决定函数形式的逻辑值。 如果为 TRUE，则 NEGBINOMDIST 返回累积分布函数；如果为 FALSE，则返回概率密度函数。"
			}
		}
	},
	NORMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "累积",
				detail: "决定函数形式的逻辑值。 如果为 TRUE，则 NORMDIST 返回累积分布函数；如果为 FALSE，则返回概率密度函数。"
			}
		}
	},
	NORMINV: {
	...
	PERCENTRANK: {
		...
		functionParameter: {
			...
			significance: {
				name: "有效位数",
				detail: "用于标识返回的百分比值的有效位数的值。 如果省略，则 PERCENTRANK 使用 3 位小数 (0.xxx)。"
			}
		}
	},
	POISSON: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "累积",
				detail: "决定函数形式的逻辑值。 如果为 TRUE，则 POISSON 返回累积分布函数；如果为 FALSE，则返回概率密度函数。"
			}
		}
	},
	QUARTILE: {
	...
	STDEV: {
		...
		functionParameter: {
			...
			number2: {
				name: "数值 2",
				detail: "对应于总体样本的 2 到 255 个数值参数。 也可以用单一数组或对某个数组的引用来代替用逗号分隔的参数。"
			}
		}
	},
	STDEVP: {
		...
		functionParameter: {
			...
			number2: {
				name: "数值 2",
				detail: "对应于总体的 2 到 255 个数值参数。 也可以用单一数组或对某个数组的引用来代替用逗号分隔的参数。"
			}
		}
	},
	TDIST: {
		...
		functionParameter: {
			...
			tails: {
				name: "尾部特性",
				detail: "指定返回的分布函数是单尾分布还是双尾分布。 如果 Tails = 1，则 TDIST 返回单尾分布。 如果Tails = 2，则 TDIST 返回双尾分布。"
			}
		}
	},
	TINV: {
	...
	TTEST: {
		...
		functionParameter: {
			...
			tails: {
				name: "尾部特性",
				detail: "指定分布尾数。 如果 tails = 1，则 TTEST 使用单尾分布。 如果 tails = 2，则 TTEST 使用双尾分布。"
			},
			type: {
				name: "检验类型",
				detail: "要执行的 t 检验的类型。"
	...
	WEIBULL: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "累积",
				detail: "决定函数形式的逻辑值。如果为TRUE，则 WEIBULL 返回累积分布函数；如果为 FALSE，则返回概率密度函数。"
			}
		}
	},
	ZTEST: {
...
const locale$11 = {
	...
	MONTH: {
		...
		functionParameter: { serialNumber: {
			name: "日期序列号",
			detail: "要查找的月份的日期。 应使用 DATE 函数输入日期，或者将日期作为其他公式或函数的结果输入。 例如，使用函数 DATE(2008,5,23) 输入 2008 年 5 月 23 日。"
		} }
	},
	NETWORKDAYS: {
