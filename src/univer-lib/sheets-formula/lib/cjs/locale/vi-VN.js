...
const locale$15 = {
	...
	FLATTEN: {
		...
		functionParameter: {
			...
			range2: {
				name: "dải ô 2",
				detail: "Các dải ô bổ sung để làm phẳng."
			}
		}
	}
};
...
const locale$14 = {
	...
	BINOMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "tích lũy",
				detail: "Một giá trị lô-gic quyết định dạng thức của hàm. Nếu tích lũy là TRUE, hàm BINOMDIST trả về hàm phân bố tích lũy; nếu FALSE, nó trả về hàm mật độ xác suất."
			}
		}
	},
	CHIDIST: {
	...
	EXPONDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "tích lũy",
				detail: "Một giá trị lô-gic quyết định dạng thức của hàm. Nếu lũy tích là ĐÚNG thì EXPONDIST trả về hàm phân bố lũy tích; nếu SAI, nó trả về hàm mật độ xác suất."
			}
		}
	},
	FDIST: {
	...
	GAMMADIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "tích lũy",
				detail: "Một giá trị lô-gic quyết định dạng thức của hàm. Nếu tích lũy là TRUE, hàm GAMMADIST trả về hàm phân bố tích lũy; nếu FALSE, nó trả về hàm mật độ xác suất."
			}
		}
	},
	GAMMAINV: {
	...
	HYPGEOMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "tích lũy",
				detail: "Một giá trị lô-gic quyết định dạng thức của hàm. Nếu tích lũy là TRUE, hàm HYPGEOMDIST trả về hàm phân bố tích lũy; nếu FALSE, nó trả về hàm mật độ xác suất."
			}
		}
	},
	LOGINV: {
	...
	LOGNORMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "tích lũy",
				detail: "Một giá trị lô-gic quyết định dạng thức của hàm. Nếu lũy tích là ĐÚNG thì LOGNORMDIST trả về hàm phân bố lũy tích; nếu SAI, nó trả về hàm mật độ xác suất."
			}
		}
	},
	MODE: {
	...
	NEGBINOMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "tích lũy",
				detail: "Một giá trị lô-gic quyết định dạng thức của hàm. Nếu tích lũy là TRUE, hàm NEGBINOMDIST trả về hàm phân bố tích lũy; nếu FALSE, nó trả về hàm mật độ xác suất."
			}
		}
	},
	NORMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "tích lũy",
				detail: "Một giá trị lô-gic quyết định dạng thức của hàm. Nếu lũy tích là ĐÚNG thì NORMDIST trả về hàm phân bố lũy tích; nếu SAI, nó trả về hàm mật độ xác suất."
			}
		}
	},
	NORMINV: {
	...
	PERCENTRANK: {
		...
		functionParameter: {
			...
			significance: {
				...
				detail: "Giá trị xác định số chữ số có nghĩa của giá trị phần trăm trả về. Nếu bỏ qua, hàm PERCENTRANK dùng ba chữ số (0.xxx)."
			}
		}
	},
	POISSON: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "tích lũy",
				detail: "Một giá trị lô-gic quyết định dạng thức của hàm. Nếu lũy tích là ĐÚNG thì POISSON trả về hàm phân bố lũy tích; nếu SAI, nó trả về hàm mật độ xác suất."
			}
		}
	},
	QUARTILE: {
	...
	STDEV: {
		...
		functionParameter: {
			number1: {
				name: "number1",
				detail: "Tham số số 1, tương ứng với giá trị mẫu đầu tiên."
			},
			number2: {
				name: "number2",
				detail: "Tham số số 2, tương ứng với các giá trị mẫu từ 2 đến 255. Cũng có thể sử dụng mảng đơn hoặc tham chiếu đến mảng thay vì sử dụng các tham số được phân tách bằng dấu phẩy."
			}
		}
	},
	STDEVP: {
	...
	TDIST: {
		...
		functionParameter: {
			...
			tails: {
				name: "đặc điểm đuôi",
				detail: "Xác định số phần dư của phân bố được trả về. Nếu Tails = 1, hàm TDIST sẽ trả về phân bố một phía. Nếu Tails = 2, hàm TDIST sẽ trả về phân bố hai phía."
			}
		}
	},
	TINV: {
	...
	TTEST: {
		...
		functionParameter: {
			...
			tails: {
				name: "đặc điểm đuôi",
				detail: "Xác định số đuôi của phân phối. Nếu đuôi = 1, TTEST sử dụng phân phối một phía. Nếu đuôi = 2, TTEST sử dụng phân phối hai phía."
			},
			type: {
	...
	VAR: {
		...
		functionParameter: {
			...
			number2: {
				name: "number2",
				detail: "Tham số số 2, tương ứng với các giá trị mẫu từ 2 đến 255."
			}
		}
	},
	VARP: {
	...
	WEIBULL: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "tích lũy",
				detail: "Một giá trị lô-gic quyết định dạng thức của hàm. Nếu tích lũy là TRUE, hàm WEIBULL trả về hàm phân bố tích lũy; nếu FALSE, nó trả về hàm mật độ xác suất."
			}
		}
	},
	ZTEST: {
...
const locale$12 = {
	DAVERAGE: {
		...
		functionParameter: {
			...
			field: {
				name: "cánh đồng",
				detail: "chỉ rõ cột nào được dùng trong hàm."
			},
			criteria: {
				name: "tiêu chuẩn",
				detail: "là phạm vi ô chứa các điều kiện mà bạn chỉ rõ."
			}
		}
	},
	DCOUNT: {
...
const locale$11 = {
	...
	DATEDIF: {
		...
		functionParameter: {
			startDate: {
				name: "ngày bắt đầu",
				detail: "Ngày đại diện cho ngày đầu tiên hoặc ngày bắt đầu của một khoảng thời gian đã cho."
			},
			endDate: {
				name: "ngày kết thúc",
			...
			method: {
				name: "Loại thông tin",
				detail: "Kiểu thông tin mà bạn muốn được trả về."
			}
		}
	},
	DATEVALUE: {
	...
	EPOCHTODATE: {
		...
		functionParameter: {
			timestamp: {
				name: "dấu thời gian",
				detail: "Dấu thời gian bắt đầu của hệ thống Unix ở dạng giây, mili giây hoặc micrô giây."
			},
			unit: {
				name: "đơn vị thời gian",
				detail: "Đơn vị thời gian mà dấu thời gian thể hiện. 1 theo mặc định: \n1 cho biết đơn vị thời gian là giây. \n2 cho biết đơn vị thời gian là mili giây.\n3 cho biết đơn vị thời gian là micrô giây."
			}
		}
	},
	HOUR: {
	...
	ISOWEEKNUM: {
		...
		functionParameter: { date: {
			name: "Ngày",
			detail: "Ngày là mã ngày-giờ được Excel dùng để tính toán ngày và giờ."
		} }
	},
	MINUTE: {
	...
	TO_DATE: {
		...
		functionParameter: { value: {
			name: "giá trị",
			detail: "Đối số hoặc tham chiếu đến một ô sẽ được chuyển đổi thành ngày tháng."
		} }
	},
	TODAY: {
...
const locale$10 = {
	...
	IMAGINARY: {
		...
		functionParameter: { inumber: {
			name: "số phức",
			detail: "Số phức mà bạn muốn tìm hệ số ảo của nó."
		} }
	},
	IMARGUMENT: {
	...
	IMCOTH: {
		...
		functionParameter: { inumber: {
			name: "số phức",
			detail: "Số phức mà bạn muốn lấy hyperbolic cotangent."
		} }
	},
	IMCSC: {
	...
	IMLOG: {
		...
		functionParameter: {
			inumber: {
				name: "số phức",
				detail: "Một số phức có logarit theo một cơ số cụ thể cần được tính."
			},
			base: {
				name: "cơ số",
				detail: "Cơ số cần sử dụng khi tính lôgarit."
			}
		}
	},
	IMLOG10: {
	...
	IMTANH: {
		...
		functionParameter: { inumber: {
			name: "số phức",
			detail: "Số phức mà bạn muốn lấy tanh."
		} }
	},
	OCT2BIN: {
...
const locale$9 = {
	...
	FVSCHEDULE: {
		...
		functionParameter: {
			principal: {
				name: "hiệu trưởng",
				detail: "giá trị hiện tại."
			},
			schedule: {
				name: "mảng lãi suất",
				detail: "Mảng lãi suất áp dụng."
			}
		}
	},
	INTRATE: {
		...
		functionParameter: {
			...
			redemption: {
				name: "giá thanh lý",
				detail: "Giá trị trao đổi của chứng khoán khi đáo hạn."
			},
			basis: {
				name: "điểm chuẩn",
				detail: "Cơ sở năm được dùng."
...
const locale$8 = {
	...
	ISEMAIL: {
		...
		functionParameter: { value: {
			name: "Giá trị",
			detail: "Giá trị được xác minh là một địa chỉ email."
		} }
	},
	ISERR: {
	...
	ISURL: {
		...
		functionParameter: { value: {
			name: "Giá trị",
			detail: "Giá trị được xác minh là một URL."
		} }
	},
	N: {
...
const locale$6 = {
	...
	HYPERLINK: {
		...
		functionParameter: {
			url: {
				name: "url",
				detail: "URL đầy đủ về vị trí liên kết được đóng trong dấu ngoặc kép hoặc tham chiếu đến ô có chứa URL này."
			},
			linkLabel: {
				name: "nhãn_đường_liên_kết",
				detail: "Văn bản cần hiển thị trong ô như là một đường liên kết, được đóng trong dấu ngoặc kép hoặc tham chiếu đến ô có chứa nhãn này."
			}
		}
	},
	IMAGE: {
...
const locale$5 = {
	...
	ATAN2: {
		...
		functionParameter: {
			xNum: {
				name: "Tọa độ x",
				detail: "Tọa độ x của điểm."
			},
			yNum: {
				name: "Tọa độ y",
				detail: "Tọa độ y của điểm."
			}
		}
	},
	ATANH: {
		...
		functionParameter: { number: {
			name: "số",
			detail: "Bất kỳ số thực nào từ 1 đến -1."
		} }
	},
	BASE: {
...
const locale$4 = {
	...
	AVERAGE_WEIGHTED: {
		...
		functionParameter: {
			values: {
				name: "giá_trị",
				detail: "Giá trị cần tính trung bình."
			},
			weights: {
				name: "trọng_số",
				detail: "Danh sách trọng số tương ứng để áp dụng."
			},
			additionalValues: {
				name: "giá_trị_bổ_sung",
				detail: "Các giá trị bổ sung cần tính trung bình."
			},
			additionalWeights: {
				name: "trọng_số_bổ_sung",
				detail: "Các trọng số bổ sung để áp dụng."
			}
		}
	},
	AVERAGEA: {
	...
	MARGINOFERROR: {
		...
		functionParameter: {
			range: {
				name: "dải_ô",
				detail: "Dải giá trị dùng để tính biên độ sai số."
			},
			confidence: {
				name: "mức_tin_cậy",
