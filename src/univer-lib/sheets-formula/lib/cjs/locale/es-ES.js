...
const locale$15 = {
	...
	FLATTEN: {
		...
		functionParameter: {
			range1: {
				name: "rango1",
				detail: "El primer rango a aplanar."
			},
			range2: {
				name: "rango2",
				detail: "Rangos adicionales a aplanar."
			}
		}
	}
};
...
const locale$14 = {
	...
	BINOMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "acumulado",
				detail: "Un valor lógico que determina la forma de la función. Si es VERDADERO, DISTR.BINOM devuelve la función de distribución acumulativa; si es FALSO, devuelve la función de masa de probabilidad."
			}
		}
	},
	CHIDIST: {
	...
	MODE: {
		...
		functionParameter: {
			...
			number2: {
				name: "número2",
				detail: "Números, referencias de celda o rangos adicionales para los que desea calcular la moda, hasta un máximo de 255."
			}
		}
	},
	NEGBINOMDIST: {
	...
	PERCENTILE: {
		...
		functionParameter: {
			...
			k: {
				name: "k",
				detail: "El valor del percentil en el rango de 0 a 1 (incluidos)."
			}
		}
	},
	PERCENTRANK: {
	...
	POISSON: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "acumulado",
				detail: "Un valor lógico que determina la forma de la función. Si es VERDADERO, POISSON devuelve la función de distribución acumulativa; si es FALSO, devuelve la función de masa de probabilidad."
			}
		}
	},
	QUARTILE: {
	...
	STDEV: {
		...
		functionParameter: {
			...
			number2: {
				name: "número2",
				detail: "Argumentos numéricos de 2 a 255 correspondientes a una muestra de una población. También puede usar una sola matriz o una referencia a una matriz en lugar de argumentos separados por comas."
			}
		}
	},
	STDEVP: {
		...
		functionParameter: {
			...
			number2: {
				name: "número2",
				detail: "Argumentos numéricos de 2 a 255 correspondientes a una población. También puede usar una sola matriz o una referencia a una matriz en lugar de argumentos separados por comas."
			}
		}
	},
	TDIST: {
		...
		functionParameter: {
			...
			tails: {
				name: "colas",
				detail: "Especifica el número de colas de distribución a devolver. Si Colas = 1, DISTR.T devuelve la distribución de una cola. Si Colas = 2, DISTR.T devuelve la distribución de dos colas."
			}
		}
	},
	TINV: {
	...
	VAR: {
		...
		functionParameter: {
			...
			number2: {
				name: "número2",
				detail: "Argumentos numéricos de 2 a 255 correspondientes a una muestra de una población."
			}
		}
	},
	VARP: {
		...
		functionParameter: {
			...
			number2: {
				name: "número2",
				detail: "Argumentos numéricos de 2 a 255 correspondientes a una población."
			}
		}
	},
	WEIBULL: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "acumulado",
				detail: "Un valor lógico que determina la forma de la función. Si es VERDADERO, WEIBULL devuelve la función de distribución acumulativa; si es FALSO, devuelve la función de densidad de probabilidad."
			}
		}
	},
	ZTEST: {
...
const locale$12 = {
	DAVERAGE: {
		...
		functionParameter: {
			database: {
				name: "base_datos",
				detail: "El rango de celdas que compone la lista o base de datos."
			},
			field: {
				name: "campo",
				detail: "Indica qué columna se utiliza en la función."
			},
			criteria: {
				name: "criterios",
				detail: "El rango de celdas que contiene las condiciones que especifica."
			}
		}
	},
	DCOUNT: {
...
const locale$11 = {
	...
	DATEDIF: {
		...
		functionParameter: {
			startDate: {
				name: "fecha_inicial",
				detail: "Una fecha que representa la primera fecha, o fecha de inicio de un período determinado."
			},
			endDate: {
				name: "fecha_final",
				detail: "Una fecha que representa la última fecha, o fecha de finalización del período."
			},
			method: {
				name: "método",
				detail: "El tipo de información que desea que se devuelva."
			}
		}
	},
	DATEVALUE: {
	...
	EPOCHTODATE: {
		...
		functionParameter: {
			timestamp: {
				name: "marca_tiempo",
				detail: "Una marca de tiempo de época Unix, en segundos, milisegundos o microsegundos."
			},
			unit: {
				name: "unidad",
	...
	ISOWEEKNUM: {
		...
		functionParameter: { date: {
			name: "fecha",
			detail: "Fecha es el código de fecha y hora utilizado por Excel para el cálculo de fecha y hora."
		} }
	},
	MINUTE: {
	...
	MONTH: {
		...
		functionParameter: { serialNumber: {
			name: "número_serie",
			detail: "La fecha del mes que intenta encontrar. Las fechas deben introducirse usando la función DATE, o como resultados de otras fórmulas o funciones. Por ejemplo, use DATE(2008,5,23) para el día 23 de mayo de 2008."
		} }
	},
	NETWORKDAYS: {
	...
	TIMEVALUE: {
		...
		functionParameter: { timeText: {
			name: "texto_hora",
			detail: "Una cadena de texto que representa una hora en cualquiera de los formatos de hora de Microsoft Excel; por ejemplo, \"6:45 PM\" y \"18:45\" cadenas de texto entre comillas que representan hora."
		} }
	},
	TO_DATE: {
		...
		functionParameter: { value: {
			name: "valor",
			detail: "El argumento o referencia a una celda que se convertirá a una fecha."
		} }
	},
	TODAY: {
...
const locale$10 = {
	...
	IMARGUMENT: {
		...
		functionParameter: { inumber: {
			name: "núm_imaginario",
			detail: "Un número complejo del que desea obtener el argumento theta."
		} }
	},
	IMCONJUGATE: {
	...
	IMCOTH: {
		...
		functionParameter: { inumber: {
			name: "núm_imaginario",
			detail: "Un número complejo del que desea obtener la cotangente hiperbólica."
		} }
	},
	IMCSC: {
	...
	IMEXP: {
		...
		functionParameter: { inumber: {
			name: "núm_imaginario",
			detail: "Un número complejo del que desea obtener la exponencial."
		} }
	},
	IMLN: {
	...
	IMLOG: {
		...
		functionParameter: {
			inumber: {
				name: "núm_imaginario",
				detail: "Un número complejo cuyo logaritmo a una base específica se debe calcular."
			},
			base: {
				name: "base",
				detail: "La base que se usa al calcular el logaritmo."
			}
		}
	},
	IMLOG10: {
	...
	IMTANH: {
		...
		functionParameter: { inumber: {
			name: "núm_imaginario",
			detail: "Un número complejo del que desea obtener la tangente hiperbólica."
		} }
	},
	OCT2BIN: {
...
const locale$9 = {
	...
	INTRATE: {
		...
		functionParameter: {
			...
			redemption: {
				name: "rescate",
				detail: "La cantidad que se recibirá al vencimiento."
			},
			basis: {
				name: "base",
				detail: "El tipo de base de recuento de días que se usará."
...
const locale$8 = {
	...
	ISBETWEEN: {
		...
		functionParameter: {
			valueToCompare: {
				...
				detail: "El valor a comprobar si está entre `valor_inferior` y `valor_superior`."
			},
			lowerValue: {
				name: "valor_inferior",
				detail: "El límite inferior del rango de valores en el que puede caer `valor_a_comparar`."
			},
			upperValue: {
				name: "valor_superior",
				detail: "El límite superior del rango de valores en el que puede caer `valor_a_comparar`."
			},
			lowerValueIsInclusive: {
				name: "valor_inferior_es_inclusivo",
				detail: "Indica si el rango de valores incluye el `valor_inferior`. Por defecto es VERDADERO."
			},
			upperValueIsInclusive: {
				name: "valor_superior_es_inclusivo",
				detail: "Indica si el rango de valores incluye el `valor_superior`. Por defecto es VERDADERO."
			}
		}
	},
	ISBLANK: {
	...
	ISDATE: {
		...
		functionParameter: { value: {
			name: "valor",
			detail: "El valor que se verificará como fecha."
		} }
	},
	ISEMAIL: {
		...
		functionParameter: { value: {
			name: "valor",
			detail: "El valor que se verificará como una dirección de correo electrónico."
		} }
	},
	ISERR: {
	...
	ISFORMULA: {
		...
		functionParameter: { reference: {
			name: "referencia",
			detail: "Referencia es una referencia a la celda que desea probar."
		} }
	},
	ISLOGICAL: {
	...
	ISURL: {
		...
		functionParameter: { value: {
			name: "valor",
			detail: "El valor que se verificará como una URL."
		} }
	},
	N: {
...
const locale$6 = {
	...
	HYPERLINK: {
		...
		functionParameter: {
			url: {
				name: "url",
				detail: "La URL completa de la ubicación del enlace entre comillas, o una referencia a una celda que contenga dicha URL."
			},
			linkLabel: {
				name: "etiqueta_enlace",
				detail: "El texto que se mostrará en la celda como el enlace, entre comillas, o una referencia a una celda que contenga dicha etiqueta."
			}
		}
	},
	IMAGE: {
...
const locale$5 = {
	...
	ATANH: {
		...
		functionParameter: { number: {
			name: "número",
			detail: "Cualquier número real entre 1 y -1."
		} }
	},
	BASE: {
		...
		functionParameter: {
			number: {
				name: "número",
				detail: "El número que desea convertir. Debe ser un entero mayor o igual a 0 y menor que 2^53."
			},
			radix: {
				name: "base",
			...
			minLength: {
				...
				detail: "La longitud mínima de la cadena devuelta. Debe ser un entero mayor o igual a 0."
			}
		}
	},
	CEILING: {
...
const locale$4 = {
	...
	AVERAGE_WEIGHTED: {
		...
		functionParameter: {
			values: {
				name: "valores",
				detail: "Los valores para los que se va a calcular el promedio."
			},
			weights: {
				name: "ponderaciones",
				detail: "La lista de ponderaciones correspondientes a aplicar."
			},
			additionalValues: {
				name: "valores_adicionales",
				detail: "Otros valores para los que se va a calcular el promedio."
			},
			additionalWeights: {
				name: "ponderaciones_adicionales",
				detail: "Otras ponderaciones a aplicar."
			}
		}
	},
	AVERAGEA: {
	...
	MARGINOFERROR: {
		...
		functionParameter: {
			range: {
				name: "rango",
				detail: "El rango de valores utilizado para calcular el margen de error."
			},
			confidence: {
				name: "confianza",
...
const locale$3 = {
	...
	DBCS: {
		...
		functionParameter: { text: {
			name: "texto",
			detail: "El texto o una referencia a una celda que contiene el texto que desea cambiar. Si el texto no contiene ninguna letra inglesa de ancho medio o katakana, el texto не se cambia."
		} }
	},
	DOLLAR: {
	...
	REGEXMATCH: {
		...
		functionParameter: {
			text: {
				name: "texto",
				detail: "El texto que se probará con la expresión regular."
			},
			regularExpression: {
				name: "expresión_regular",
				detail: "La expresión regular con la que se probará el texto."
			}
		}
	},
	REGEXREPLACE: {
		...
		functionParameter: {
			text: {
				name: "texto",
				detail: "El texto, del cual se reemplazará una parte."
			},
			regularExpression: {
				name: "expresión_regular",
				detail: "La expresión regular. Todas las instancias coincidentes en el texto serán reemplazadas."
			},
			replacement: {
				name: "reemplazo",
				detail: "El texto que se insertará en el texto original."
			}
		}
	},
	REPLACE: {
...
const locale$1 = {
	ENCODEURL: {
		...
		functionParameter: { text: {
			name: "texto",
			detail: "Una cadena que se va a codificar en URL"
		} }
	},
	FILTERXML: {
