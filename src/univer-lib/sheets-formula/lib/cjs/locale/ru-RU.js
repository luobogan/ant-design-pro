...
const locale$16 = {
	ARRAY_CONSTRAIN: {
		...
		functionParameter: {
			inputRange: {
				name: "массив",
				detail: "Диапазон для ограничения."
			},
			numRows: {
	...
	FLATTEN: {
		...
		functionParameter: {
			...
			range2: {
				name: "диапазон2",
				detail: "Дополнительные диапазоны, которые необходимо выровнять."
			}
		}
	}
};
...
const locale$15 = {
	...
	COVAR: {
		...
		functionParameter: {
			array1: {
				name: "массив1",
				detail: "Первый диапазон ячеек с целыми числами."
			},
			array2: {
				name: "массив2",
				detail: " Второй диапазон ячеек с целыми числами."
			}
		}
	},
	CRITBINOM: {
	...
	EXPONDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "накопительная",
				detail: "Логическое значение, определяющее форму экспоненциальной функции, которую следует использовать. Если аргумент \"интегральная\" имеет значение ИСТИНА, функция ЭКСПРАСП возвращает интегральную функцию распределения; если он имеет значение ЛОЖЬ, возвращается функция плотности распределения."
			}
		}
	},
	FDIST: {
	...
	GAMMADIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "накопительная",
				detail: "Логическое значение, определяющее форму функции. Если аргумент \"интегральная\" имеет значение ИСТИНА, функция ГАММАРАСП возвращает интегральную функцию распределения; если этот аргумент имеет значение ЛОЖЬ, возвращается функция плотности распределения вероятности."
			}
		}
	},
	GAMMAINV: {
	...
	HYPGEOMDIST: {
		...
		functionParameter: {
			...
			populationS: {
				...
				detail: "Количество успешных испытаний в генеральной совокупности."
			},
			numberPop: {
				name: "размер совокупности",
				detail: "Размер генеральной совокупности"
			},
			cumulative: {
				name: "накопительная",
				detail: "Логическое значение, определяющее вид функции. Если значение кумулятивного распределения равно TRUE, HYPGEOMDIST возвращает кумулятивную функцию распределения; если FALSE, функция возвращает функцию плотности вероятности."
			}
		}
	},
	LOGINV: {
		...
		functionParameter: {
			...
			standardDev: {
				name: "стандартное отклонение",
				detail: "Стандартное отклонение ln(x)."
			}
		}
	},
	LOGNORMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "накопительная",
				detail: "Логическое значение, определяющее форму функции. Если кумулятивная функция TRUE, LOGNORM.DIST возвращает кумулятивную функцию распределения; если FALSE, возвращает функцию плотности вероятности."
			}
		}
	},
	MODE: {
		...
		functionParameter: {
			...
			number2: {
				name: "число2",
				detail: "От 1 до 255 числовых аргументов, для которых вычисляется мода. Вместо аргументов, разделенных точкой с запятой, можно воспользоваться массивом или ссылкой на массив."
			}
		}
	},
	NEGBINOMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "накопительная",
				detail: "Логическое значение, определяющее форму функции. Если кумулятивная функция TRUE, NEGBINOMDIST возвращает кумулятивную функцию распределения; если FALSE, возвращает функцию плотности вероятности."
			}
		}
	},
	NORMDIST: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "накопительная",
				detail: "Логическое значение, определяющее форму функции. Если кумулятивная функция TRUE, NORMDIST возвращает кумулятивную функцию распределения; если FALSE, возвращает функцию плотности вероятности."
			}
		}
	},
	NORMINV: {
	...
	PERCENTILE: {
		...
		functionParameter: {
			...
			k: {
				name: "k",
				detail: "Значение процентили в интервале от 0 до 1, включая эти числа."
			}
		}
	},
	PERCENTRANK: {
		...
		functionParameter: {
			...
			x: {
				name: "x",
				detail: "Значение, для которого требуется узнать ранг в массиве."
			},
			significance: {
				name: "точность",
				detail: "Значение, определяющее количество значимых цифр для возвращаемого процентного значения. Если этот аргумент опущен, для функции ПРОЦЕНТРАНГ используются три цифры (0,xxx)."
			}
		}
	},
	POISSON: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "накопительная",
				detail: "Логическое значение, определяющее форму функции. Если кумулятивная функция TRUE, POISSON возвращает кумулятивную функцию распределения; если FALSE, он возвращает функцию плотности вероятности."
			}
		}
	},
	QUARTILE: {
	...
	STDEV: {
		...
		functionParameter: {
			number1: {
				name: "число1",
				detail: "Первый числовой аргумент, соответствующий выборке из генеральной совокупности."
			},
			number2: {
				name: "число2",
				detail: "Числовые аргументы 2—255, соответствующие выборке из генеральной совокупности. Вместо аргументов, разделенных точкой с запятой, можно использовать массив или ссылку на массив."
			}
		}
	},
	STDEVP: {
		...
		functionParameter: {
			...
			number2: {
				name: "число2",
				detail: "Числовые аргументы 2—255, соответствующие генеральной совокупности. Вместо аргументов, разделенных точкой с запятой, можно использовать массив или ссылку на массив."
			}
		}
	},
	TDIST: {
		...
		functionParameter: {
			...
			tails: {
				name: "хвосты",
				detail: "Определяет количество возвращаемых хвостов распределения. Если значение \"хвосты\" = 1, функция TDIST возвращает одностороннее распределение. Если значение \"хвосты\" = 2, функция TDIST возвращает двустороннее распределение."
			}
		}
	},
	TINV: {
		...
		functionParameter: {
			probability: {
				name: "вероятность",
				detail: "Вероятность, соответствующая двустороннему распределению Стьюдента."
			},
			degFreedom: {
				name: "cтепени свободы",
				detail: "Целое, указывающее число степеней свободы."
	...
	TTEST: {
		...
		functionParameter: {
			...
			tails: {
				name: "хвосты",
				detail: "Число хвостов распределения. Если значение \"хвосты\" = 1, функция TTEST возвращает одностороннее распределение. Если значение \"хвосты\" = 2, функция TTEST возвращает двустороннее распределение."
			},
			type: {
				name: "тип",
	...
	VAR: {
		...
		functionParameter: {
			...
			number2: {
				name: "число2",
				detail: "Числовые аргументы 2—255, соответствующие выборке из генеральной совокупности."
			}
		}
	},
	VARP: {
		...
		functionParameter: {
			...
			number2: {
				name: "число2",
				detail: "Числовые аргументы 2—255, соответствующие генеральной совокупности."
			}
		}
	},
	WEIBULL: {
		...
		functionParameter: {
			...
			cumulative: {
				name: "накопительная",
				detail: "Логическое значение, определяющее форму функции. Если кумулятивная функция TRUE, WEIBULL возвращает кумулятивную функцию распределения; если FALSE, он возвращает функцию плотности вероятности."
			}
		}
	},
	ZTEST: {
...
const locale$13 = {
	DAVERAGE: {
		...
		functionParameter: {
			database: {
				name: "База данных",
				detail: "интервал ячеек, образующих список или базу данных."
			},
			field: {
				name: "поле",
				detail: "столбец, используемый функцией."
			},
			criteria: {
				name: "условия",
				detail: "диапазон ячеек, который содержит задаваемые условия."
			}
		}
	},
	DCOUNT: {
...
const locale$12 = {
	...
	DATEDIF: {
		...
		functionParameter: {
			startDate: {
				name: "начальная дата",
				detail: "Дата, представляющая первую или начальную дату заданного периода."
			},
			endDate: {
				name: "конечная дата",
			...
			method: {
				name: "тип",
				detail: "Тип возвращаемых сведений."
			}
		}
	},
	DATEVALUE: {
	...
	EPOCHTODATE: {
		...
		functionParameter: {
			timestamp: {
				...
				detail: "Unix-время в секундах, миллисекундах или микросекундах."
			},
			unit: {
				name: "единица",
				detail: "Eдиница измерения времени во временной метке (значение по умолчанию: 1): \n1 - секунды. \n2 - миллисекунды.\n3 - микросекунды"
			}
		}
	},
	HOUR: {
	...
	MONTH: {
		...
		functionParameter: { serialNumber: {
			name: "дата в числовом формате",
			detail: "Дата месяца, который необходимо найти. Дата должна быть введена с использованием функции ДАТА либо как результат других формул или функций. Например, для указания даты 23 мая 2008 года следует воспользоваться выражением ДАТА(2008;5;23)."
		} }
	},
	NETWORKDAYS: {
	...
	TO_DATE: {
		...
		functionParameter: { value: {
			name: "значение",
			detail: "Число, которое необходимо преобразовать в дату, или ссылка на ячейку, содержащую такое число"
		} }
	},
	TODAY: {
...
const locale$11 = {
	...
	IMAGINARY: {
		...
		functionParameter: { inumber: {
			name: "комлексное число",
			detail: "Комплексное число, для которого требуется определить коэффициент при мнимой части."
		} }
	},
	IMARGUMENT: {
	...
	IMCOTH: {
		...
		functionParameter: { inumber: {
			name: "комлексное число",
			detail: "Комплексное число, гиперболический котангенс которого нужно вычислить."
		} }
	},
	IMCSC: {
	...
	IMEXP: {
		...
		functionParameter: { inumber: {
			name: "комлексное число",
			detail: "Комплексное число, для которого требуется определить экспоненту."
		} }
	},
	IMLN: {
	...
	IMLOG: {
		...
		functionParameter: {
			inumber: {
				name: "комлексное число",
				detail: "Значение логарифмической функции, которое нужно указать."
			},
			base: {
				name: "основание",
	...
	IMTANH: {
		...
		functionParameter: { inumber: {
			name: "комлексное число",
			detail: "Комплексное число, гиперболический тангенс которого нужно вычислить."
		} }
	},
	OCT2BIN: {
...
const locale$10 = {
	...
	FVSCHEDULE: {
		...
		functionParameter: {
			principal: {
				name: "первичное",
				detail: "Стоимость инвестиции на текущий момент."
			},
			schedule: {
				name: "план",
				detail: "Массив применяемых процентных ставок."
			}
		}
	},
	INTRATE: {
		...
		functionParameter: {
			...
			redemption: {
				name: "погашение",
				detail: "Сумма, которая должна быть получена на момент погашения ценных бумаг."
			},
			basis: {
				name: "базис",
				detail: "Используемый способ вычисления дня."
...
const locale$9 = {
	...
	ISBETWEEN: {
		...
		functionParameter: {
			valueToCompare: {
				...
				detail: "Значение, которое нужно проверить на принадлежность к интервалу от \"наименьшее значение\" до \"наибольшее значение\"."
			},
			lowerValue: {
				name: "наименьшее значение",
				detail: "Нижняя граница диапазона значений, к которому может относиться значение \"значение для сравнения\"."
			},
			upperValue: {
				name: "наибольшее значение",
				detail: "Верхняя граница диапазона значений, к которому может относиться значение \"значение для сравнения\"."
			},
			lowerValueIsInclusive: {
				name: "наименьшее значение вклюительно",
				detail: "Указывает, входит ли в диапазон значение \"наименьшее значение\". Значение по умолчанию: TRUE."
			},
			upperValueIsInclusive: {
				name: "наибольшее значение вклюительно",
				detail: "Указывает, входит ли в диапазон значение \"наибольшее значение\". Значение по умолчанию: TRUE."
			}
		}
	},
	ISBLANK: {
		...
		functionParameter: { value: {
			name: "значение",
			detail: "Значение, которое вы хотите проверить. Аргументом «значение» может быть пустая ячейка, ошибка, логическое значение, текст, число, ссылочное значение или имя, ссылающееся на любой из них."
		} }
	},
	ISDATE: {
	...
	ISEMAIL: {
		...
		functionParameter: { value: {
			name: "значение",
			detail: "Значение, для которого необходимо проверить, является ли оно адресом электронной почты."
		} }
	},
	ISERR: {
	...
	ISURL: {
		...
		functionParameter: { value: {
			name: "значение",
			detail: "Значение, для которого необходимо проверить, является ли оно URL."
		} }
	},
	N: {
...
const locale$6 = {
	...
	ATANH: {
		...
		functionParameter: { number: {
			name: "число",
			detail: "Любое вещественное число в интервале от -1 до 1."
		} }
	},
	BASE: {
...
const locale$5 = {
	...
	AVERAGE_WEIGHTED: {
		...
		functionParameter: {
			values: {
				name: "значения",
				detail: "Значения для расчета среднего."
			},
			weights: {
				name: "взвешенные",
				detail: "Список соответствующих взвешенных величин, которые необходимо применить."
			},
			additionalValues: {
				name: "дополнительные значения",
				detail: "Дополнительные значения для расчета среднего."
			},
			additionalWeights: {
				name: "дополнительные взвешенные",
				detail: "Дополнительные взвешенные, которые необходимо применить."
			}
		}
	},
	AVERAGEA: {
	...
	MARGINOFERROR: {
		...
		functionParameter: {
			range: {
				name: "диапазон",
				detail: "Диапазон значений, который используется для расчета предельной погрешности."
			},
			confidence: {
				name: "доверие",
