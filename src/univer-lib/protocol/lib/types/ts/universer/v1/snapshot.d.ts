...
export interface IReportUnitRoutingStatsRequest {
    unitId: string;
    estimatedCells?: number | undefined;
    /** precision: seconds */
...
export interface ISnapshotService {
    ...
    GetLatestCsReqIdBySid(request: IGetLatestCsReqIdBySidRequest, metadata?: Metadata): Observable<IGetLatestCsReqIdBySidResponse>;
    FetchMissingChangesets(request: IFetchMissingChangesetsRequest, metadata?: Metadata): Observable<IFetchMissingChangesetsResponse>;
    /**
    ...
    GetLatestSnapshotRevision(request: IGetLatestSnapshotRevisionRequest, metadata?: Metadata): Observable<IGetLatestSnapshotRevisionResponse>;
