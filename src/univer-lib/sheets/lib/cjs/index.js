...
function getCellType(styles, newVal, oldVal) {
	...
	if (oldVal.t === _univerjs_core.CellValueType.FORCE_STRING) {
		var _oldStyle$n;
		if (!(0, _univerjs_core.isTextFormat)(oldStyle === null || oldStyle === void 0 || (_oldStyle$n = oldStyle.n) === null || _oldStyle$n === void 0 ? void 0 : _oldStyle$n.pattern) && newVal.v !== void 0) {
			if ((0, _univerjs_core.isRealNum)(newVal.v)) return _univerjs_core.CellValueType.NUMBER;
			else if ((0, _univerjs_core.isBooleanString)(`${newVal.v}`)) return _univerjs_core.CellValueType.BOOLEAN;
		}
		return _univerjs_core.CellValueType.FORCE_STRING;
	}
	if (hasNumberFormat(newStyle)) {
		var _newStyle$n;
		if ((0, _univerjs_core.isTextFormat)(newStyle === null || newStyle === void 0 || (_newStyle$n = newStyle.n) === null || _newStyle$n === void 0 ? void 0 : _newStyle$n.pattern)) return _univerjs_core.CellValueType.STRING;
		return checkCellValueTypeByValue(newVal, oldVal);
	}
	if ((0, _univerjs_core.isTextFormat)(oldStyle === null || oldStyle === void 0 || (_oldStyle$n2 = oldStyle.n) === null || _oldStyle$n2 === void 0 ? void 0 : _oldStyle$n2.pattern)) return _univerjs_core.CellValueType.STRING;
	return checkCellValueTypeByValue(newVal, oldVal);
}
...
function checkCellValueType(v, type) {
	...
	if (typeof v === "string") {
		if ((0, _univerjs_core.isRealNum)(v)) {
			if ((+v === 0 || +v === 1) && type === _univerjs_core.CellValueType.BOOLEAN) return _univerjs_core.CellValueType.BOOLEAN;
			if (type !== _univerjs_core.CellValueType.STRING && type !== _univerjs_core.CellValueType.FORCE_STRING && (0, _univerjs_core.willLoseNumericPrecision)(v)) return _univerjs_core.CellValueType.FORCE_STRING;
			return _univerjs_core.CellValueType.NUMBER;
		}
		if ((0, _univerjs_core.isBooleanString)(v)) return _univerjs_core.CellValueType.BOOLEAN;
		return _univerjs_core.CellValueType.STRING;
	}
	if (typeof v === "number") {
		if ((v === 0 || v === 1) && type === _univerjs_core.CellValueType.BOOLEAN) return _univerjs_core.CellValueType.BOOLEAN;
		return _univerjs_core.CellValueType.NUMBER;
	}
	if (typeof v === "boolean") return _univerjs_core.CellValueType.BOOLEAN;
	return _univerjs_core.CellValueType.FORCE_STRING;
}
...
const AddMergeUndoMutationFactory = (accessor, params) => {
	if (!getSheetMutationTarget(accessor.get(_univerjs_core.IUniverInstanceService), params)) throw new Error("Workbook or worksheet is null error!");
	return {
		unitId: params.unitId,
		subUnitId: params.subUnitId,
		ranges: _univerjs_core.Tools.deepClone(params.ranges)
	};
};
const AddWorksheetMergeMutation = {
	...
	handler: (accessor, params) => {
		const target = getSheetMutationTarget(accessor.get(_univerjs_core.IUniverInstanceService), params);
...
const CELL_CONTENT = (0, _univerjs_core.createInterceptorKey)("CELL_CONTENT");
const ROW_FILTERED = (0, _univerjs_core.createInterceptorKey)("ROW_FILTERED");
...
const BEFORE_CELL_EDIT = (0, _univerjs_core.createInterceptorKey)("BEFORE_CELL_EDIT");
const AFTER_CELL_EDIT = (0, _univerjs_core.createInterceptorKey)("AFTER_CELL_EDIT");
const VALIDATE_CELL = (0, _univerjs_core.createInterceptorKey)("VALIDATE_CELL");
let SheetInterceptorService = class SheetInterceptorService extends _univerjs_core.Disposable {
	/** @ignore */
	constructor(_univerInstanceService) {
		...
		this.intercept(INTERCEPTOR_POINT.CELL_CONTENT, {
			priority: -1,
			effect: _univerjs_core.InterceptorEffectEnum.Style | _univerjs_core.InterceptorEffectEnum.Value,
	...
	*/
	...
	onWriteCell(workbook, worksheet, row, col, cellData) {
		const context = {
			...
			row,
			col,
			origin: _univerjs_core.Tools.deepClone(cellData)
		};
	...
	intercept(name, interceptor) {
		...
		if (key === INTERCEPTOR_POINT.CELL_CONTENT) {
			...
			const BOTH_EFFECT = _univerjs_core.InterceptorEffectEnum.Style | _univerjs_core.InterceptorEffectEnum.Value;
			this._interceptorsByName.set(`${key}-${_univerjs_core.InterceptorEffectEnum.Style}`, sortedInterceptors.filter((i) => ((i.effect || BOTH_EFFECT) & _univerjs_core.InterceptorEffectEnum.Style) > 0));
			this._interceptorsByName.set(`${key}-${_univerjs_core.InterceptorEffectEnum.Value}`, sortedInterceptors.filter((i) => ((i.effect || BOTH_EFFECT) & _univerjs_core.InterceptorEffectEnum.Value) > 0));
	...
	_interceptWorkbook(workbook) {
		...
		disposables.add((0, _univerjs_core.toDisposable)(() => workbook.getSheets().forEach((worksheet) => this._disposeSheetInterceptor(unitId, worksheet))));
...
SheetInterceptorService = __decorate([__decorateParam(0, _univerjs_core.IUniverInstanceService)], SheetInterceptorService);
...
const darkRangeThemeBuilder = (baseName, rowHeader, firstRow, secondRow) => {
	return new RangeThemeStyle(`dark-${baseName}`, {
		headerRowStyle: {
			...
			ht: _univerjs_core.HorizontalAlign.CENTER,
...
let SheetRangeThemeModel = class SheetRangeThemeModel extends _univerjs_core.Disposable {
	constructor(_sheetInterceptorService, _resourceManagerService, _univerInstanceService) {
		...
		_defineProperty(this, "_rangeThemeMapChanged$", new rxjs.Subject());
	...
	_ensureRTreeCollection(unitId) {
		if (!this._rTreeCollection.has(unitId)) this._rTreeCollection.set(unitId, new _univerjs_core.RTree());
...
SheetRangeThemeModel = __decorate([
	__decorateParam(0, (0, _univerjs_core.Inject)(SheetInterceptorService)),
	__decorateParam(1, (0, _univerjs_core.Inject)(_univerjs_core.IResourceManagerService)),
...
const SetWorksheetRangeThemeStyleMutation = {
	...
	type: _univerjs_core.CommandType.MUTATION,
	handler: (accessor, params) => {
		if (!getSheetCommandTarget(accessor.get(_univerjs_core.IUniverInstanceService), params)) return false;
...
const InsertRowMutationUndoFactory = (accessor, params) => {
	if (!getSheetMutationTarget(accessor.get(_univerjs_core.IUniverInstanceService), params)) throw new Error("Workbook or Worksheet not found at InsertRowMutationUndoFactory");
	return {
		unitId: params.unitId,
		subUnitId: params.subUnitId,
		range: params.range
...
const InsertColMutationUndoFactory = (accessor, params) => {
	if (!getSheetMutationTarget(accessor.get(_univerjs_core.IUniverInstanceService), params)) throw new Error("Workbook or Worksheet not found at InsertColMutationUndoFactory");
	return {
		unitId: params.unitId,
		subUnitId: params.subUnitId,
		range: params.range
...
const MoveRangeMutation = {
	...
	handler: (accessor, params) => {
		...
		new _univerjs_core.ObjectMatrix(from.value).forValue((row, col, newVal) => {
			if (newVal === null || newVal === void 0) fromCellMatrix.realDeleteValue(row, col);
			else fromCellMatrix.setValue(row, col, newVal);
		});
		new _univerjs_core.ObjectMatrix(to.value).forValue((row, col, newVal) => {
...
function MoveRowsMutationUndoFactory(_accessor, params) {
	...
	if (movingBackward) return {
		unitId,
		subUnitId,
		sourceRange: _univerjs_core.Rectangle.clone(targetRange),
		targetRange: {
			...sourceRange,
	...
	return {
		unitId,
		subUnitId,
		targetRange: _univerjs_core.Rectangle.clone(sourceRange),
		sourceRange: {
			...targetRange,
...
const MoveRowsMutation = {
	...
	handler: (accessor, params) => {
		...
		(0, _univerjs_core.moveMatrixArray)(fromRow, count, toRow, worksheet.getRowManager().getRowData());
...
const MoveColsMutation = {
	...
	handler: (accessor, params) => {
		...
		(0, _univerjs_core.moveMatrixArray)(fromCol, count, toCol, worksheet.getColumnManager().getColumnData());
...
const RemoveRowsUndoMutationFactory = (params, worksheet) => {
	...
	const _rowInfo = (0, _univerjs_core.concatMatrixArray)(rowInfo, (0, _univerjs_core.sliceMatrixArray)(range.startRow, range.endRow, rowWrapper));
	return {
		unitId: params.unitId,
		subUnitId: params.subUnitId,
		range: params.range,
...
const RemoveRowMutation = {
	...
	handler: (accessor, params) => {
		...
		(0, _univerjs_core.spliceArray)(range.startRow, rowCount, rowPrimitive);
...
const RemoveColMutationFactory = (accessor, params) => {
	...
	const colInfo = {};
	const range = params.range;
	const _colInfo = (0, _univerjs_core.concatMatrixArray)(colInfo, (0, _univerjs_core.sliceMatrixArray)(range.startColumn, range.endColumn, columnWrapper));
	return {
		unitId: params.unitId,
		subUnitId: params.subUnitId,
		range: params.range,
...
const RemoveColMutation = {
	...
	handler: (accessor, params) => {
		...
		(0, _univerjs_core.spliceArray)(range.startColumn, colCount, colPrimitive);
...
const RemoveMergeUndoMutationFactory = (accessor, params) => {
	...
	for (let j = 0; j < mergeRemoveData.length; j++) for (let i = mergeConfigData.length - 1; i >= 0; i--) {
		...
		if (_univerjs_core.Rectangle.intersects(configMerge, removeMerge)) ranges.push(mergeConfigData[i]);
	}
	return {
		unitId: params.unitId,
		subUnitId: params.subUnitId,
...
const RemoveWorksheetMergeMutation = {
	...
	handler: (accessor, params) => {
		...
		for (let j = 0; j < mergeRemoveData.length; j++) for (let i = mergeConfigData.length - 1; i >= 0; i--) {
			const configMerge = mergeConfigData[i];
			const removeMerge = mergeRemoveData[j];
			if (_univerjs_core.Rectangle.intersects(configMerge, removeMerge)) mergeConfigData.splice(i, 1);
		}
		worksheet.getSpanModel().rebuild(mergeConfigData);
		return true;
	}
...
const ReorderRangeMutation = {
	...
	handler: (accessor, params) => {
		...
		const worksheet = accessor.get(_univerjs_core.IUniverInstanceService).getUnit(unitId).getSheetBySheetId(subUnitId);
		if (!worksheet) return false;
		const cellDataMatrix = new _univerjs_core.ObjectMatrix();
		_univerjs_core.Range.foreach(range, (row, col) => {
			if (order.hasOwnProperty(row)) {
				const targetRow = order[row];
				const cloneCell = _univerjs_core.Tools.deepClone(worksheet.getCellRaw(targetRow, col));
...
function getOldRowData(currentRow, newRow) {
	...
	const row = _univerjs_core.Tools.deepClone(currentRow);
...
function getOldColumnData(currenColumn, newColumn) {
	...
	const column = _univerjs_core.Tools.deepClone(currenColumn);
	...
	handler: (accessor, params) => {
		...
		for (let i = 0; i < params.ranges.length; i++) {
			...
			for (let j = range.startColumn; j < range.endColumn + 1; j++) {
				...
				if (column != null) column.hd = _univerjs_core.BooleanNumber.TRUE;
			}
		}
		return true;
	}
...
const SetColVisibleMutation = {
	...
	handler: (accessor, params) => {
		...
		for (let i = 0; i < params.ranges.length; i++) {
			...
			for (let j = range.startColumn; j < range.endColumn + 1; j++) {
				const column = manager.getColumnOrCreate(j);
				if (column != null) column.hd = _univerjs_core.BooleanNumber.FALSE;
			}
		}
		return true;
	}
...
function sanitizeColorStyle(value) {
	return sanitizeFixedShapeObject(value, _univerjs_core.COLOR_STYLE_KEYS);
}
function sanitizeTextDecoration(value) {
	return sanitizeFixedShapeObject(value, _univerjs_core.TEXT_DECORATION_KEYS, { cl: sanitizeColorStyle });
}
function sanitizeBorderStyleData(value) {
	return sanitizeFixedShapeObject(value, _univerjs_core.BORDER_STYLE_KEYS, { cl: sanitizeColorStyle });
}
function sanitizeBorderData(value) {
	return sanitizeMappedObject(value, _univerjs_core.BORDER_KEYS, sanitizeBorderStyleData);
}
function sanitizeTextRotation(value) {
	return sanitizeFixedShapeObject(value, _univerjs_core.TEXT_ROTATION_KEYS);
}
function sanitizePaddingData(value) {
	return sanitizeFixedShapeObject(value, _univerjs_core.PADDING_KEYS);
}
...
function mergeBorderData(currentBorders, incomingBorders) {
	...
	const mergedBorders = _univerjs_core.Tools.isObject(currentBorders) ? { ...currentBorders } : {};
	forEachPresentKey(borderRecord, _univerjs_core.BORDER_KEYS, (key, fieldValue) => {
...
function transformBorders(oldBorders, newBorders) {
	...
	for (const key of _univerjs_core.BORDER_KEYS) {
...
function mergeRichTextStyle(p, newStyle) {
	...
	for (const textRun of p.body.textRuns) {
		...
		if (index < st) {
			...
			merge && _univerjs_core.Tools.removeNull(merge);
			if (!_univerjs_core.Tools.isEmptyObject(merge)) tr.ts = merge;
			newTextRuns.push(tr);
		}
		const merge = mergeStyle(ts, newStyle, true);
		merge && _univerjs_core.Tools.removeNull(merge);
		if (_univerjs_core.Tools.isEmptyObject(merge)) delete textRun.ts;
	...
	p.body.textRuns = (0, _univerjs_core.normalizeTextRuns)(newTextRuns);
}
...
function getCellValue(type, cell) {
	...
	if (type === _univerjs_core.CellValueType.NUMBER) return Number(cell.v);
	if (type === _univerjs_core.CellValueType.BOOLEAN) return extractBooleanValue(cell.v) ? 1 : 0;
	if (type === _univerjs_core.CellValueType.STRING || type === _univerjs_core.CellValueType.FORCE_STRING) return `${cell.v}`;
	return cell.v;
}
/**
...
function extractBooleanValue(value) {
	if (typeof value === "string") {
		...
		if ((0, _univerjs_core.isSafeNumeric)(value)) {
	...
	handler: (accessor, params) => {
		...
		for (let i = 0; i < ranges.length; i++) {
			...
			for (let j = range.startColumn; j < range.endColumn + 1; j++) {
				...
				else if (_univerjs_core.Tools.isDefine(params.colWidth[j])) manager.setColumnWidth(j, params.colWidth[j]);
			}
		}
		return true;
	}
...
const SetWorksheetRowHeightMutation = {
	...
	handler: (accessor, params) => {
		...
		else if (_univerjs_core.Tools.isDefine(rowHeight[rowIndex])) manager.setRowHeight(rowIndex, rowHeight[rowIndex]);
		return true;
	}
};
	...
	switch (commandInfo.id) {
		...
		case "sheet.mutation.move-range": {
			...
			return [{
				...
				range: new _univerjs_core.ObjectMatrix(params.from.value).getRange()
			}, {
				unitId: params.unitId,
...
function getMatrixWithSpanInfo(worksheet, startRow, startColumn, endRow, endColumn) {
	...
	const returnCellMatrix = new _univerjs_core.ObjectMatrix();
	...
	mergedCellsInRange.forEach((mergedCell) => {
		...
		(0, _univerjs_core.createRowColIter)(startRow, endRow, startColumn, endColumn).forEach((row, col) => {
...
function getExpandedRangeLeft(range, allMatrixWithSpan, leftOffset, isWorksheetHasSpan) {
	...
	if (spanAnchor) return {
		spanAnchor: _univerjs_core.Rectangle.simpleRangesIntersect(range, spanAnchor) ? spanAnchor : null,
		hasValue: false,
		range
	};
	return {
...
function expandToContinuousRange(startRange, directions, worksheet) {
	...
	if (spanAnchors.length > 0) destRange = _univerjs_core.Rectangle.union(destRange, ...spanAnchors);
	return destRange;
}
...
var RangeMergeUtil = class {
	constructor() {
		_defineProperty(this, "_matrix", new _univerjs_core.ObjectMatrix());
	}
	add(...ranges) {
		ranges.forEach((range) => {
			_univerjs_core.Range.foreach(range, (row, col) => {
...
function cellValueToString(cellData) {
	...
	if (cellData.t && (cellData.t === _univerjs_core.CellValueType.FORCE_STRING || cellData.t === _univerjs_core.CellValueType.STRING)) return String(cellData.v);
}
/**
...
function getVisibleRanges(ranges, accessor, unitId, subUnitId) {
	...
	for (const item of intervalsRanges) {
		...
		const mergedRowIntervals = (0, _univerjs_core.mergeIntervals)(rowIntervals);
...
var RangeProtectionRuleModel = class {
	constructor() {
		...
		_defineProperty(this, "_ruleRefresh$", new rxjs.Subject());
		_defineProperty(this, "ruleRefresh$", this._ruleRefresh$.asObservable());
		_defineProperty(this, "_rangeRuleInitStateChange", new rxjs.BehaviorSubject(false));
	...
	createRuleId(unitId, subUnitId) {
		let id = (0, _univerjs_core.generateRandomId)(4);
		const ruleMap = this._ensureRuleMap(unitId, subUnitId);
		while (ruleMap.has(id)) id = (0, _univerjs_core.generateRandomId)(4);
		return id;
	}
...
*/
var WorkbookSelectionModel = class extends _univerjs_core.Disposable {
...
let SheetsSelectionsService = class SheetsSelectionsService extends _univerjs_core.RxDisposable {
	...
	_init() {
		...
		this.disposeWithMe(this.selectionChanged$.pipe((0, rxjs.takeUntil)(this.dispose$)).subscribe(() => {
	...
	dispose() {
		...
		this.selectionMoveStart$ = (0, rxjs.of)(null);
		this.selectionMoving$ = (0, rxjs.of)(null);
		this.selectionMoveEnd$ = (0, rxjs.of)([]);
		this.selectionSet$ = (0, rxjs.of)(null);
		this.selectionChanged$ = (0, rxjs.of)(null);
	}
	/**
	...
	getCellStylesProperty(property) {
		...
		for (let i = 0; i < selections.length; i++) {
			...
			for (let row = startRow; row <= endRow; row++) for (let column = startColumn; column <= endColumn; column++) {
				...
				if (value !== void 0 && value !== null && !_univerjs_core.Tools.diffValue(value, _value)) return {
					isAllValuesSame: false,
					value: null
				};
				value = _value;
...
SheetsSelectionsService = __decorate([__decorateParam(0, _univerjs_core.IUniverInstanceService)], SheetsSelectionsService);
...
function alignToMergedCellsBorders(startRange, worksheet, shouldRecursive = true) {
	const coveredMergedCells = worksheet.getMatrixWithMergedCells(...(0, _univerjs_core.selectionToArray)(startRange));
	...
	coveredMergedCells.forValue((row, col, value) => {
		if (value.colSpan !== void 0 && value.rowSpan !== void 0) {
			...
			if (!_univerjs_core.Rectangle.contains(startRange, mergedCellRange)) exceededMergedCells.push(mergedCellRange);
		}
	});
	if (exceededMergedCells.length === 0) return startRange;
	const union = _univerjs_core.Rectangle.union(startRange, ...exceededMergedCells);
...
function isSingleCellSelection(selection) {
	...
	return _univerjs_core.Rectangle.equals(range, primary);
}
/**
...
function copyRangeStyles(worksheet, startRow, endRow, startColumn, endColumn, isRow, sourceRangeIndex) {
	...
	for (const row in cellValue) {
		for (const col in cellValue[row]) {
			...
			if (cell.s && typeof cell.s === "object" && _univerjs_core.Tools.isEmptyObject(cell.s)) delete cell.s;
			if (_univerjs_core.Tools.isEmptyObject(cell)) delete cellValue[row][col];
		}
		if (_univerjs_core.Tools.isEmptyObject(cellValue[row])) delete cellValue[row];
	}
	return cellValue;
}
...
*/
const IRefSelectionsService = (0, _univerjs_core.createIdentifier)("sheets-formula.ref-selections.service");
let RefSelectionsService = class RefSelectionsService extends SheetsSelectionsService {
	constructor(_instanceSrv) {
		super(_instanceSrv);
	}
	_init() {
		const $ = this._getAliveWorkbooks$().pipe((0, rxjs.takeUntil)(this.dispose$));
		this.selectionMoveStart$ = $.pipe((0, rxjs.switchMap)((ss) => (0, rxjs.merge)(...ss.map((s) => s.selectionMoveStart$))));
		this.selectionMoving$ = $.pipe((0, rxjs.switchMap)((ss) => (0, rxjs.merge)(...ss.map((s) => s.selectionMoving$))));
		this.selectionMoveEnd$ = $.pipe((0, rxjs.switchMap)((ss) => (0, rxjs.merge)(...ss.map((s) => s.selectionMoveEnd$))));
		this.selectionSet$ = $.pipe((0, rxjs.switchMap)((ss) => (0, rxjs.merge)(...ss.map((s) => s.selectionSet$))));
	}
	dispose() {
		super.dispose();
		this.selectionMoveStart$ = (0, rxjs.of)(null);
		this.selectionMoving$ = (0, rxjs.of)(null);
		this.selectionMoveEnd$ = (0, rxjs.of)(null);
		this.selectionSet$ = (0, rxjs.of)(null);
	...
	_getAliveWorkbooks$() {
		...
		this.disposeWithMe(this._instanceSrv.getTypeOfUnitDisposed$(_univerjs_core.UniverInstanceType.UNIVER_SHEET).subscribe((workbook) => {
			this._removeWorkbookSelection(workbook.getUnitId());
			workbooks$.next(workbooks$.getValue().filter((unit) => unit !== workbook));
		}));
		return workbooks$.pipe((0, rxjs.map)((workbooks) => workbooks.map((w) => this._ensureWorkbookSelection(w.getUnitId()))));
	}
};
RefSelectionsService = __decorate([__decorateParam(0, _univerjs_core.IUniverInstanceService)], RefSelectionsService);
...
const MoveRangeCommand = {
	...
	handler: async (accessor, params) => {
		...
		if ((0, _univerjs_core.sequenceExecute)(moveRangeCommandMutations.redos, commandService).result) {
			undoRedoService.pushUndoRedo({
...
function getMoveRangeUndoRedoMutations(accessor, from, to, ignoreMerge = false) {
	...
	if (!_univerjs_core.Rectangle.equals(toRange, alignedRangeWithToRange) && !ignoreMerge) return null;
	const fromWorksheetCellMatrix = fromWorksheet.getCellMatrix();
	const toWorksheetCellMatrix = toWorksheet.getCellMatrix();
	const fromRedoCellValue = new _univerjs_core.ObjectMatrix();
	const fromUndoCellValue = new _univerjs_core.ObjectMatrix();
	...
	_univerjs_core.Range.foreach(fromRange, (row, col) => {
		...
		const relativeRange = _univerjs_core.Rectangle.getRelativeRange(cellRange, fromRange);
		const range = _univerjs_core.Rectangle.getPositionRange(relativeRange, toRange);
...
const SetRangeValuesCommand = {
	...
	handler: (accessor, params) => {
		...
		const cellValue = new _univerjs_core.ObjectMatrix();
		let realCellValue;
		if (_univerjs_core.Tools.isArray(value)) for (let i = 0; i < ranges.length; i++) {
		...
		else if ((0, _univerjs_core.isICellData)(value)) for (let i = 0; i < ranges.length; i++) {
			const { startRow, startColumn, endRow, endColumn } = ranges[i];
			for (let r = startRow; r <= endRow; r++) for (let c = startColumn; c <= endColumn; c++) cellValue.setValue(r, c, value);
		}
		else {
			realCellValue = value;
			ranges = realCellValue ? [new _univerjs_core.ObjectMatrix(realCellValue).getStartEndScope()] : [];
		}
		...
		const { undos: autoHeightUndos, redos: autoHeightRedos } = sheetInterceptorService.generateMutationsOfAutoHeight({
			...
			subUnitId,
			ranges,
			cellHeights: new _univerjs_core.ObjectMatrix(cellHeights)
		});
		if ((0, _univerjs_core.sequenceExecute)([...redos, ...autoHeightRedos], commandService).result) {
			const redoMutations = [
				{
					id: SetRangeValuesMutation.id,
					params: setRangeValuesMutationRedoParams
...
function getInsertRangeMutations(accessor, params) {
	...
	if (worksheet) {
		...
		if (range.startColumn <= dataRange.endColumn || range.startRow <= dataRange.endRow) {
			let moveFromRange;
			let moveToRange;
			if (shiftDimension === _univerjs_core.Dimension.COLUMNS) {
				...
				for (let row = range.startRow; row <= endRow; row++) {
					...
					const rowLength = rowData ? (0, _univerjs_core.getArrayLength)(rowData) - 1 : 0;
...
function getRemoveRangeMutations(accessor, params) {
	...
	if (worksheet) {
		...
		if (range.startColumn <= dataRange.endColumn || range.startRow <= dataRange.endRow) {
			...
			if (shiftDimension === _univerjs_core.Dimension.COLUMNS && range.endColumn < dataRange.endColumn) {
				const endRow = Math.min(range.endRow, dataRange.endRow);
				let endColumn = 0;
				for (let row = range.startRow; row <= endRow; row++) {
					const rowData = cellMatrix.getRow(row);
			...
			if (shiftDimension === _univerjs_core.Dimension.ROWS && range.endRow < dataRange.endRow) {
				const endColumn = Math.min(range.endColumn, dataRange.endColumn);
				const endRow = dataRange.endRow;
				moveFromRange = {
...
function handleInsertRangeMutation(cellMatrix, range, lastEndRow, lastEndColumn, shiftDimension, cellValue) {
	const { startRow, endRow, startColumn, endColumn } = range;
	if (shiftDimension === _univerjs_core.Dimension.ROWS) {
	...
	} else if (shiftDimension === _univerjs_core.Dimension.COLUMNS) {
...
function handleDeleteRangeMutation(cellMatrix, range, lastEndRow, lastEndColumn, shiftDimension) {
	...
	const rows = endRow - startRow + 1;
	const columns = endColumn - startColumn + 1;
	if (shiftDimension === _univerjs_core.Dimension.ROWS) for (let r = startRow; r <= lastEndRow; r++) for (let c = startColumn; c <= endColumn; c++) {
		const value = cellMatrix.getValue(r + rows, c);
		if (value == null) cellMatrix.realDeleteValue(r, c);
		else cellMatrix.setValue(r, c, value);
	}
	else if (shiftDimension === _univerjs_core.Dimension.COLUMNS) for (let r = startRow; r <= endRow; r++) for (let c = startColumn; c <= lastEndColumn; c++) {
...
const DeleteRangeMoveLeftCommand = {
	...
	handler: async (accessor, params) => {
		...
		const deleteRangeMutationParams = {
			...
			subUnitId,
			unitId,
			shiftDimension: _univerjs_core.Dimension.COLUMNS
		};
...
const DeleteRangeMoveUpCommand = {
	...
	handler: async (accessor, params) => {
		...
		const deleteRangeMutationParams = {
			...
			subUnitId,
			unitId,
			shiftDimension: _univerjs_core.Dimension.ROWS
		};
		const sheetInterceptor = sheetInterceptorService.onCommandExecute({
		...
		if (insertRowCount > 0) {
			...
			const insertRowParams = {
				...
				rowInfo: new Array(insertRowCount).fill(void 0).map(() => ({
					h: height,
					hd: _univerjs_core.BooleanNumber.FALSE
				}))
			};
			redoMutations.push({
...
const InsertRowByRangeCommand = {
	...
	handler: (accessor, params) => {
		...
		const { startRow, endRow } = range;
		range.rangeType = _univerjs_core.RANGE_TYPE.ROW;
		const anchorRow = direction === _univerjs_core.Direction.UP ? startRow : startRow - 1;
...
const InsertRowBeforeCommand = {
	...
	handler: async (accessor, params) => {
		...
		return accessor.get(_univerjs_core.ICommandService).executeCommand(InsertRowCommand.id, insertRowParams);
	}
};
...
const InsertColByRangeCommand = {
	...
	handler: (accessor, params) => {
		...
		const { range, direction, cellValue } = params;
		const { startColumn, endColumn } = range;
		range.rangeType = _univerjs_core.RANGE_TYPE.COLUMN;
		const anchorCol = direction === _univerjs_core.Direction.LEFT ? startColumn : startColumn - 1;
...
const InsertColBeforeCommand = {
	...
	handler: async (accessor, params) => {
		...
		return accessor.get(_univerjs_core.ICommandService).executeCommand(InsertColCommand.id, insertColParams);
	}
};
...
*/
const setSelection = (0, _univerjs_core.throttle)((range, workbook, worksheet, commandService) => {
...
const MoveRowsCommand = {
	...
	handler: (accessor, params) => {
		...
		const filteredSelections = selections === null || selections === void 0 ? void 0 : selections.filter((selection) => selection.range.rangeType === _univerjs_core.RANGE_TYPE.ROW && selection.range.startRow <= fromRow && fromRow <= selection.range.endRow);
...
const MoveColsCommand = {
	...
	handler: (accessor, params) => {
		...
		const selections = range ? [covertRangeToSelection(range)] : selectionManagerService.getCurrentSelections();
		const filteredSelections = selections === null || selections === void 0 ? void 0 : selections.filter((selection) => selection.range.rangeType === _univerjs_core.RANGE_TYPE.COLUMN && selection.range.startColumn <= fromCol && fromCol <= selection.range.endColumn);
		if ((filteredSelections === null || filteredSelections === void 0 ? void 0 : filteredSelections.length) !== 1) return false;
		const sheetInterceptorService = accessor.get(SheetInterceptorService);
		const target = getSheetCommandTarget(accessor.get(_univerjs_core.IUniverInstanceService), params);
		if (!target) return false;
...
const ReorderRangeCommand = {
	...
	handler: (accessor, params) => {
		...
		const result = (0, _univerjs_core.sequenceExecute)(redos, commandService);
		...
		if (result.result) {
			(0, _univerjs_core.sequenceExecute)([...reorderAfterIntercepted.redos, ...autoHeightRedos], commandService);
			accessor.get(_univerjs_core.IUndoRedoService).pushUndoRedo({
				unitID: unitId,
				undoMutations: [
					...undos,
...
const handleRangeTypeInput = (range) => {
	...
	if (_range.rangeType === _univerjs_core.RANGE_TYPE.COLUMN || isColumn) {
		_range.startRow = 0;
		_range.endRow = _univerjs_core.MAX_ROW_COUNT - 1;
	}
	if (_range.rangeType === _univerjs_core.RANGE_TYPE.ROW || isRow) {
		_range.startColumn = 0;
		_range.endColumn = _univerjs_core.MAX_COLUMN_COUNT - 1;
	}
	if (_range.rangeType === _univerjs_core.RANGE_TYPE.ALL) {
		_range.startColumn = 0;
		_range.endColumn = _univerjs_core.MAX_COLUMN_COUNT - 1;
		_range.startRow = 0;
		_range.endRow = _univerjs_core.MAX_ROW_COUNT - 1;
...
const rotateRange = (range) => {
	...
	if (range.rangeType === _univerjs_core.RANGE_TYPE.COLUMN) rangeType = _univerjs_core.RANGE_TYPE.ROW;
	else if (range.rangeType === _univerjs_core.RANGE_TYPE.ROW) rangeType = _univerjs_core.RANGE_TYPE.COLUMN;
	return {
...
const handleMoveRangeCommon = (param, targetRange) => {
	...
	if (!_univerjs_core.Rectangle.intersects(fromRange, targetRange) && !_univerjs_core.Rectangle.intersects(toRange, targetRange)) return [targetRange];
	if (_univerjs_core.Rectangle.contains(fromRange, targetRange)) {
		const relativeRange = _univerjs_core.Rectangle.getRelativeRange(targetRange, fromRange);
...
const handleReorderRange = (param, targetRange) => {
	...
	if (_univerjs_core.Rectangle.contains(range, targetRange) && targetRange.endRow === targetRange.startRow) {
		const operators = [];
...
const handleInsertRowCommon = (info, targetRange) => {
	...
	if (param.direction === _univerjs_core.Direction.UP) {
...
const handleInsertColCommon = (info, targetRange) => {
	...
	if (param.direction === _univerjs_core.Direction.LEFT) {
...
const handleDefaultRangeChangeWithEffectRefCommandsSkipNoInterests = (range, commandInfo, deps) => {
	...
	if (getEffectedRangesOnCommand(commandInfo, deps).some((effectRange) => _univerjs_core.Rectangle.intersects(effectRange, range))) return handleDefaultRangeChangeWithEffectRefCommands(range, commandInfo);
	return range;
};
...
const handleCommonRangeChangeWithEffectRefCommandsSkipNoInterests = (range, commandInfo, deps) => {
	...
	if (getEffectedRangesOnCommand(commandInfo, deps).some((effectRange) => _univerjs_core.Rectangle.intersects(effectRange, range))) return handleCommonDefaultRangeChangeWithEffectRefCommands(range, commandInfo);
	return range;
};
/**
...
function getEffectedRangesOnMutation(mutation) {
	switch (mutation.id) {
		...
		case MoveRangeMutation.id: {
			const params = mutation.params;
			return [new _univerjs_core.ObjectMatrix(params.from.value).getRange(), new _univerjs_core.ObjectMatrix(params.to.value).getRange()];
		}
		case InsertColMutation.id: {
...
var WatchRange = class extends _univerjs_core.Disposable {
	...
	onMutation(mutation) {
		...
		if (this._skipIntersects) {
			...
			if (effectRanges === null || effectRanges === void 0 ? void 0 : effectRanges.some((effectRange) => _univerjs_core.Rectangle.intersects(effectRange, this._range))) return;
		}
		const afterRange = adjustRangeOnMutation(this._range, mutation);
		if (afterRange && _univerjs_core.Rectangle.equals(afterRange, this._range)) return false;
		const beforeChange = this._range;
		this._range = afterRange;
		this._callback(beforeChange, afterRange);
	}
};
let RefRangeService = class RefRangeService extends _univerjs_core.Disposable {
		...
		_defineProperty(this, "_checkRange", (effectRanges, unitId, subUnitId) => {
			...
			if (manager) {
				...
				[...manager.keys()].forEach((key) => {
					...
					if (effectRanges.some((item) => _univerjs_core.Rectangle.intersects(item, realRange))) cbList && cbList.forEach((callback) => {
		...
		_defineProperty(
			...
			*/
			...
			(range, callback, _unitId, _subUnitId) => {
				...
				if (!unitId || !subUnitId) return (0, _univerjs_core.toDisposable)(() => {});
...
RefRangeService = __decorate([
	...
	__decorateParam(1, (0, _univerjs_core.Inject)(SheetInterceptorService)),
	__decorateParam(2, (0, _univerjs_core.Inject)(_univerjs_core.IUniverInstanceService)),
	__decorateParam(3, (0, _univerjs_core.Inject)(SheetsSelectionsService))
], RefRangeService);
function getUnitId(univerInstanceService) {
	var _univerInstanceServic;
	return (_univerInstanceServic = univerInstanceService.getCurrentUnitOfType(_univerjs_core.UniverInstanceType.UNIVER_SHEET)) === null || _univerInstanceServic === void 0 ? void 0 : _univerInstanceServic.getUnitId();
}
function getSubUnitId(univerInstanceService) {
	var _univerInstanceServic2;
	return (_univerInstanceServic2 = univerInstanceService.getCurrentUnitOfType(_univerjs_core.UniverInstanceType.UNIVER_SHEET)) === null || _univerInstanceServic2 === void 0 || (_univerInstanceServic2 = _univerInstanceServic2.getActiveSheet()) === null || _univerInstanceServic2 === void 0 ? void 0 : _univerInstanceServic2.getSheetId();
}
...
function getAddMergeMutationRangeByType(selection, type) {
	...
	if (type !== void 0) {
		...
		for (let i = 0; i < ranges.length; i++) {
			...
			if (type === _univerjs_core.Dimension.ROWS) for (let r = startRow; r <= endRow; r++) {
				const data = {
					startRow: r,
					endRow: r,
					startColumn,
			...
			else if (type === _univerjs_core.Dimension.COLUMNS) for (let c = startColumn; c <= endColumn; c++) {
				const data = {
					startRow,
					endRow,
					startColumn: c,
...
const MERGE_CELL_INTERCEPTOR_CHECK = (0, _univerjs_core.createInterceptorKey)("mergeCellPermissionCheck");
let MergeCellController = class MergeCellController extends _univerjs_core.Disposable {
	constructor(_commandService, _refRangeService, _univerInstanceService, _injector, _sheetInterceptorService, _selectionManagerService) {
		...
		this._sheetInterceptorService = _sheetInterceptorService;
		this._selectionManagerService = _selectionManagerService;
		_defineProperty(this, "disposableCollection", new _univerjs_core.DisposableCollection());
		_defineProperty(this, "interceptor", new _univerjs_core.InterceptorManager({ MERGE_CELL_INTERCEPTOR_CHECK }));
		this._onRefRangeChange();
	...
	_initCommandInterceptor() {
			...
			switch (commandInfo.id) {
				...
				case ClearSelectionFormatCommand.id: {
					...
					if (selections && selections.length > 0) {
						if (selections.some((range) => mergeData.some((item) => _univerjs_core.Rectangle.intersects(item, range)))) {
		...
		this._sheetInterceptorService.interceptRanges({ getMutations: ({ unitId, subUnitId, ranges }) => {
			...
			const { worksheet } = target;
			const overlapRanges = worksheet.getMergeData().filter((item) => ranges.some((range) => _univerjs_core.Rectangle.intersects(item, range)));
	...
	_onRefRangeChange() {
		...
		this._univerInstanceService.getCurrentTypeOfUnit$(_univerjs_core.UniverInstanceType.UNIVER_SHEET).pipe((0, rxjs.first)((workbook) => !!workbook)).subscribe((workbook) => {
	...
	_handleMoveRangeCommand(params, unitId, subUnitId) {
		...
		const fromMergeRanges = sourceWorksheet.getMergeData().filter((item) => _univerjs_core.Rectangle.intersects(item, params.fromRange));
		const toMergeRanges = targetWorksheet.getMergeData().filter((item) => _univerjs_core.Rectangle.intersects(item, params.toRange));
		const addMergeCellRanges = getAddMergeMutationRangeByType(fromMergeRanges.map((mergeRange) => _univerjs_core.Rectangle.getRelativeRange(mergeRange, params.fromRange)).map((relativeRange) => _univerjs_core.Rectangle.getPositionRange(relativeRange, params.toRange))).filter((range) => !targetWorksheet.getMergeData().some((mergeRange) => _univerjs_core.Rectangle.equals(range, mergeRange)));
		const redos = [];
		const undos = [];
	...
	_handleInsertRowCommand(config, unitId, subUnitId) {
		...
		const { range } = config;
		const { startRow, endRow } = range;
		const oldMergeCells = _univerjs_core.Tools.deepClone(worksheet.getMergeData()).reduce((mergeCellsHasLapping, cell) => {
		...
		const newMergeCells = _univerjs_core.Tools.deepClone(worksheet.getMergeData()).reduce((mergeCellsHasLapping, cell) => {
	...
	_handleRemoveColCommand(config, unitId, subUnitId) {
		...
		const { startColumn, endColumn } = range;
		const oldMergeCells = _univerjs_core.Tools.deepClone(worksheet.getMergeData()).reduce((mergeCellsHasLapping, cell) => {
			if (_univerjs_core.Rectangle.intersects(range, cell)) mergeCellsHasLapping.push(cell);
			return mergeCellsHasLapping;
		}, []);
		if (oldMergeCells.length === 0) return this._handleNull();
		const newMergeCells = _univerjs_core.Tools.deepClone(worksheet.getMergeData()).reduce((mergeCellsHasLapping, cell) => {
			if (_univerjs_core.Rectangle.intersects(range, cell)) {
	...
	_handleInsertRangeMoveRightCommand(config, unitId, subUnitId) {
		...
		mergeData.forEach((rect) => {
			...
			if (_univerjs_core.Rectangle.intersects({
				...
				if (_univerjs_core.Rectangle.contains({
					startRow,
					startColumn,
					endRow,
					endColumn: maxCol
		...
		mergeData.forEach((rect) => {
			...
			if (_univerjs_core.Rectangle.intersects({
				...
				if (_univerjs_core.Rectangle.contains({
					...
					const rowCount = endRow - startRow + 1;
					const range = _univerjs_core.Rectangle.moveVertical(rect, -rowCount);
		...
		this.disposeWithMe(this._commandService.onCommandExecuted((command) => {
			if (mutationIdArrByMove$1.includes(command.id)) {
				...
				mergeData.forEach((merge) => {
					...
					if (!_univerjs_core.Rectangle.intersects(merge, sourceRange)) {
						if (isRowMove) {
...
MergeCellController = __decorate([
	...
	__decorateParam(1, (0, _univerjs_core.Inject)(RefRangeService)),
	__decorateParam(2, (0, _univerjs_core.Inject)(_univerjs_core.IUniverInstanceService)),
	__decorateParam(3, (0, _univerjs_core.Inject)(_univerjs_core.Injector)),
	__decorateParam(4, (0, _univerjs_core.Inject)(SheetInterceptorService)),
...
const AddMergeRedoSelectionsOperationFactory = (accessor, params, ranges) => {
	...
	if (selectionsBeforeMutation && selectionsBeforeMutation.length > 0) {
		...
		if (primaryBeforeMutation) {
			...
			if (value === _univerjs_core.Dimension.COLUMNS) {
			...
			} else if (value === _univerjs_core.Dimension.ROWS) {
...
const RemoveWorksheetMergeCommand = {
	...
	handler: (accessor, params) => {
		...
		const intersectsMerges = worksheet.getConfig().mergeData.filter((merge) => {
			return selections.some((selection) => _univerjs_core.Rectangle.intersects(selection, merge));
		});
		...
		const undoSelections = _univerjs_core.Tools.deepClone(nowSelections);
		const redoSelections = _univerjs_core.Tools.deepClone(nowSelections);
...
function getSetRangeStyleParamsForRemoveMerge(worksheet, ranges) {
	const styleRedoMatrix = new _univerjs_core.ObjectMatrix();
	ranges.forEach((range) => {
		const { startRow, startColumn, endColumn, endRow } = range;
...
function getClearContentMutationParamForRange(worksheet, range) {
	const { startRow, startColumn, endColumn, endRow } = range;
	const cellMatrix = worksheet.getMatrixWithMergedCells(startRow, startColumn, endRow, endColumn, _univerjs_core.CellModeEnum.Raw);
...
const AddWorksheetMergeCommand = {
	...
	handler: async (accessor, params) => {
		...
		const removeMergeMutationParams = {
			unitId,
			subUnitId,
			ranges: _univerjs_core.Tools.deepClone(ranges)
		};
		const addMergeMutationParams = {
			unitId,
			subUnitId,
...
const AddWorksheetMergeAllCommand = {
	...
	handler: async (accessor) => {
		...
		const unitId = worksheet.getUnitId();
		const subUnitId = worksheet.getSheetId();
		return accessor.get(_univerjs_core.ICommandService).executeCommand(AddWorksheetMergeCommand.id, {
...
const AddWorksheetMergeVerticalCommand = {
	...
	handler: async (accessor) => {
		...
		const subUnitId = worksheet.getSheetId();
		return accessor.get(_univerjs_core.ICommandService).executeCommand(AddWorksheetMergeCommand.id, {
			value: _univerjs_core.Dimension.COLUMNS,
			selections: mergeableSelections,
			unitId,
			subUnitId
		});
...
const AddWorksheetMergeHorizontalCommand = {
	...
	handler: async (accessor) => {
		...
		const subUnitId = worksheet.getSheetId();
		return accessor.get(_univerjs_core.ICommandService).executeCommand(AddWorksheetMergeCommand.id, {
			value: _univerjs_core.Dimension.ROWS,
			selections: mergeableSelections,
			unitId,
			subUnitId
		});
...
function addMergeCellsUtil(injector, unitId, subUnitId, ranges, options = {}) {
	const target = getSheetCommandTarget(injector.get(_univerjs_core.IUniverInstanceService), {
		unitId,
		subUnitId
	});
	if (!target) return;
	...
	if (worksheet.getMergeData().some((mergeRange) => {
		return ranges.some((range) => {
			return _univerjs_core.Rectangle.intersects(range, mergeRange);
		});
	})) {
...
var WorksheetProtectionRuleModel = class {
	constructor() {
		...
		_defineProperty(this, "_ruleChange", new rxjs.Subject());
		_defineProperty(this, "_ruleRefresh", new rxjs.Subject());
		_defineProperty(this, "_resetOrder", new rxjs.Subject());
		_defineProperty(this, "ruleChange$", this._ruleChange.asObservable());
		_defineProperty(this, "ruleRefresh$", this._ruleRefresh.asObservable());
		_defineProperty(this, "resetOrder$", this._resetOrder.asObservable());
		_defineProperty(this, "_worksheetRuleInitStateChange", new rxjs.BehaviorSubject(false));
...
const SetStyleCommand = {
	...
	handler: (accessor, params) => {
		...
		if (_univerjs_core.Tools.isArray(style.value)) for (let i = 0; i < ranges.length; i++) iterator.forOperableEach(ranges[i], (r, c, range) => {
		...
		const result = (0, _univerjs_core.sequenceExecute)([...redos, ...autoHeightRedos], commandService);
...
const SetBoldCommand = {
	...
	handler: (accessor) => {
		...
		const setStyleParams = { style: {
			type: "bl",
			value: worksheet.getRange(actualRow, actualColumn).getFontWeight() === _univerjs_core.FontWeight.BOLD ? _univerjs_core.BooleanNumber.FALSE : _univerjs_core.BooleanNumber.TRUE
		} };
		return accessor.get(_univerjs_core.ICommandService).syncExecuteCommand(SetStyleCommand.id, setStyleParams);
	}
};
/**
...
const SetItalicCommand = {
	...
	handler: (accessor) => {
		...
		if (selection.primary) {
			...
			currentlyItalic = worksheet.getRange(startRow, startColumn).getFontStyle() === _univerjs_core.FontItalic.ITALIC;
		}
		const setStyleParams = { style: {
			type: "it",
			value: currentlyItalic ? _univerjs_core.BooleanNumber.FALSE : _univerjs_core.BooleanNumber.TRUE
		} };
		return accessor.get(_univerjs_core.ICommandService).syncExecuteCommand(SetStyleCommand.id, setStyleParams);
	}
};
...
const SetUnderlineCommand = {
	...
	handler: (accessor) => {
		...
		const setStyleParams = { style: {
			type: "ul",
			value: { s: currentlyUnderline ? _univerjs_core.BooleanNumber.FALSE : _univerjs_core.BooleanNumber.TRUE }
		} };
		return accessor.get(_univerjs_core.ICommandService).syncExecuteCommand(SetStyleCommand.id, setStyleParams);
	}
};
...
const SetStrikeThroughCommand = {
	...
	handler: (accessor) => {
		...
		const setStyleParams = { style: {
			type: "st",
			value: { s: currentlyStrokeThrough ? _univerjs_core.BooleanNumber.FALSE : _univerjs_core.BooleanNumber.TRUE }
		} };
		return accessor.get(_univerjs_core.ICommandService).syncExecuteCommand(SetStyleCommand.id, setStyleParams);
	}
};
...
const SetOverlineCommand = {
	...
	handler: (accessor) => {
		...
		const setStyleParams = { style: {
			type: "ol",
			value: { s: currentlyOverline ? _univerjs_core.BooleanNumber.FALSE : _univerjs_core.BooleanNumber.TRUE }
		} };
		return accessor.get(_univerjs_core.ICommandService).syncExecuteCommand(SetStyleCommand.id, setStyleParams);
	}
};
...
const ResetTextColorCommand = {
	...
	handler: (accessor) => {
		return accessor.get(_univerjs_core.ICommandService).syncExecuteCommand(SetStyleCommand.id, { style: {
			type: "cl",
			value: { rgb: null }
		} });
	}
...
const SetTextRotationCommand = {
	...
	handler: (accessor, params) => {
		...
		const value = typeof params.value === "number" ? { a: params.value } : {
			a: 0,
			v: _univerjs_core.BooleanNumber.TRUE
		};
		const commandService = accessor.get(_univerjs_core.ICommandService);
		const setStyleParams = {
			unitId: params.unitId,
...
function fillSeries$1(data, len, direction) {
	...
	if (data.length > 2 && isEqualRatio(dataNumArr)) for (let i = 1; i <= len; i++) {
		...
		for (let i = 1; i <= len; i++) {
			...
			const d = _univerjs_core.Tools.deepClone(data[index]);
			removeCellCustom(d);
			const forward = direction === _univerjs_core.Direction.DOWN || direction === _univerjs_core.Direction.RIGHT;
...
function getAutoFillRepeatRange(sourceRange, targetRange) {
	const repeats = [];
	let direction;
	if (targetRange.startRow < sourceRange.startRow) direction = _univerjs_core.Direction.UP;
	else if (targetRange.endRow > sourceRange.endRow) direction = _univerjs_core.Direction.DOWN;
	else if (targetRange.startColumn < sourceRange.startColumn) direction = _univerjs_core.Direction.LEFT;
	else if (targetRange.endColumn > sourceRange.endColumn) direction = _univerjs_core.Direction.RIGHT;
	else return [];
	if (direction === _univerjs_core.Direction.DOWN || direction === _univerjs_core.Direction.UP) {
		...
		if (direction === _univerjs_core.Direction.DOWN) {
	...
	if (direction === _univerjs_core.Direction.RIGHT || direction === _univerjs_core.Direction.LEFT) {
		...
		if (direction === _univerjs_core.Direction.RIGHT) {
			for (let i = 0; i < mod; i++) repeats.push({
				repeatStartCell: {
...
function needsUpdateCellValue(cell) {
	if ((0, _univerjs_core.isFormulaString)(cell.f) || (0, _univerjs_core.isFormulaId)(cell.si)) return false;
	if (cell.t === _univerjs_core.CellValueType.BOOLEAN) return false;
	return true;
}
/**
* Remove cell.custom
...
const AutoFillRules = {
	dateRule: {
		...
		match: (cellData, accessor) => {
			...
			if ((typeof (cellData === null || cellData === void 0 ? void 0 : cellData.v) === "number" || (cellData === null || cellData === void 0 ? void 0 : cellData.t) === _univerjs_core.CellValueType.NUMBER) && cellData.s) {
				if (typeof cellData.s === "string") {
					...
					if (pattern) return _univerjs_core.numfmt.getFormatInfo(pattern).isDate;
				} else if (cellData.s.n && _univerjs_core.numfmt.getFormatInfo(cellData.s.n.pattern).isDate) return true;
			}
			return false;
		},
		isContinue: (prev, cur) => {
...
let AutoFillService = class AutoFillService extends _univerjs_core.Disposable {
	constructor(_commandService, _undoRedoService, _univerInstanceService, _injector) {
		...
		_defineProperty(this, "_showMenu$", new rxjs.BehaviorSubject(false));
		_defineProperty(this, "showMenu$", this._showMenu$.asObservable());
		_defineProperty(this, "_direction", _univerjs_core.Direction.DOWN);
	...
	fillData(applyType) {
		...
		const activeWorkbook = this._univerInstanceService.getCurrentUnitOfType(_univerjs_core.UniverInstanceType.UNIVER_SHEET);
		...
		this._prevUndos = [];
		const selection = _univerjs_core.Rectangle.union(discreteRangeToRange(source), discreteRangeToRange(target));
...
const IAutoFillService = (0, _univerjs_core.createIdentifier)("univer.auto-fill-service");
...
async function executeSheetCopyFill(accessor, direction) {
	...
	if (!params) return false;
	const result = await accessor.get(_univerjs_core.ICommandService).executeCommand(AutoFillCommand.id, params);
...
let SheetLazyExecuteScheduleService = class SheetLazyExecuteScheduleService extends _univerjs_core.Disposable {
...
SheetLazyExecuteScheduleService = __decorate([__decorateParam(0, _univerjs_core.ICommandService), __decorateParam(1, _univerjs_core.IUniverInstanceService)], SheetLazyExecuteScheduleService);
...
function buildCopySheetMutations(accessor, workbook, worksheet, unitId, subUnitId, localeService, sheetInterceptorService) {
	...
	const config = (0, _univerjs_core.cloneWorksheetData)(worksheet.getConfig());
	config.name = getCopyUniqueSheetName(workbook, localeService, config.name);
	const newSheetId = (0, _univerjs_core.generateRandomId)();
...
const InsertDefinedNameCommand = {
	...
	handler: (accessor, params) => {
		...
		if (commandService.syncExecuteCommand(_univerjs_engine_formula.SetDefinedNameMutation.id, insertSheetMutationParams)) {
			undoRedoService.pushUndoRedo({
				unitID: params.unitId,
				undoMutations: [{
...
const RemoveSheetCommand = {
	...
	handler: (accessor, params) => {
		...
		const univerInstanceService = accessor.get(_univerjs_core.IUniverInstanceService);
		const sheetInterceptorService = accessor.get(SheetInterceptorService);
		const configService = accessor.get(_univerjs_core.IConfigService);
		const target = getSheetCommandTarget(univerInstanceService, params);
		if (!target) return false;
		const { unitId, subUnitId, workbook, worksheet } = target;
...
var BorderStyleManagerService = class {
	constructor() {
		_defineProperty(this, "_borderInfo", {
			type: _univerjs_core.BorderType.ALL,
			color: "#000000",
			style: _univerjs_core.BorderStyleTypes.THIN,
			activeBorderType: false
		});
		_defineProperty(this, "_borderInfo$", new rxjs.BehaviorSubject(this._borderInfo));
...
const setBorderStyleForRange = (borderContext, range, defaultStyle, reserve) => {
	...
	forEach(range, (row, column) => {
		...
		if (rectangle && (defaultStyle.bc_tr || defaultStyle.ml_tr || defaultStyle.bl_tr || defaultStyle.tl_mr || defaultStyle.tl_bc || defaultStyle.tl_br)) {
			if (reserve) {
				var _mr$getValue;
				const style = _univerjs_core.Tools.deepClone((_mr$getValue = mr.getValue(rectangle.startRow, rectangle.startColumn)) === null || _mr$getValue === void 0 ? void 0 : _mr$getValue.s);
			...
			if (reserve) {
				var _mr$getValue2;
				const style = _univerjs_core.Tools.deepClone((_mr$getValue2 = mr.getValue(row, column)) === null || _mr$getValue2 === void 0 ? void 0 : _mr$getValue2.s);
				bdStyle = (style === null || style === void 0 ? void 0 : style.bd) ? Object.assign(style.bd, defaultStyle) : defaultStyle;
			}
...
function getBorderContext(borderStyleManagerService, target, selections) {
	...
	const top = type === _univerjs_core.BorderType.TOP || type === _univerjs_core.BorderType.ALL || type === _univerjs_core.BorderType.OUTSIDE;
	const left = type === _univerjs_core.BorderType.LEFT || type === _univerjs_core.BorderType.ALL || type === _univerjs_core.BorderType.OUTSIDE;
	const bottom = type === _univerjs_core.BorderType.BOTTOM || type === _univerjs_core.BorderType.ALL || type === _univerjs_core.BorderType.OUTSIDE;
	const right = type === _univerjs_core.BorderType.RIGHT || type === _univerjs_core.BorderType.ALL || type === _univerjs_core.BorderType.OUTSIDE;
	const vertical = type === _univerjs_core.BorderType.VERTICAL || type === _univerjs_core.BorderType.ALL || type === _univerjs_core.BorderType.INSIDE;
	const horizontal = type === _univerjs_core.BorderType.HORIZONTAL || type === _univerjs_core.BorderType.ALL || type === _univerjs_core.BorderType.INSIDE;
	...
	const mr = new _univerjs_core.ObjectMatrix();
	const { worksheet, unitId, subUnitId } = target;
	return {
		worksheet,
		unitId,
...
const innerBorder = (borderContext) => {
	...
	if (vertical) forEach(range, (row, column) => {
		...
		if (mergedRange) {
			...
			if (mergedRange.startColumn !== range.startColumn) mr.setValue(row, column, { s: { bd: (topLeftStyle === null || topLeftStyle === void 0 ? void 0 : topLeftStyle.bd) ? Object.assign(topLeftStyle.bd, { l: _univerjs_core.Tools.deepClone(borderStyle) }) : { l: _univerjs_core.Tools.deepClone(borderStyle) } } });
		} else {
			if (column !== range.endColumn) {
				...
				mr.setValue(row, column, { s: { bd: (style === null || style === void 0 ? void 0 : style.bd) ? Object.assign(style.bd, { r: _univerjs_core.Tools.deepClone(borderStyle) }) : { r: _univerjs_core.Tools.deepClone(borderStyle) } } });
			}
			if (column !== range.startColumn) {
				...
				mr.setValue(row, column, { s: { bd: (style === null || style === void 0 ? void 0 : style.bd) ? Object.assign(style.bd, { l: _univerjs_core.Tools.deepClone(borderStyle) }) : { l: _univerjs_core.Tools.deepClone(borderStyle) } } });
			}
		}
	});
	if (horizontal) forEach(range, (row, column) => {
		...
		if (mergedRange) {
			...
			if (mergedRange.startRow !== range.startRow) mr.setValue(row, column, { s: { bd: (topLeftStyle === null || topLeftStyle === void 0 ? void 0 : topLeftStyle.bd) ? Object.assign(topLeftStyle.bd, { t: _univerjs_core.Tools.deepClone(borderStyle) }) : { t: _univerjs_core.Tools.deepClone(borderStyle) } } });
		} else {
			if (row !== range.endRow) {
				var _mr$getValue7;
				const style = (_mr$getValue7 = mr.getValue(row, column)) === null || _mr$getValue7 === void 0 ? void 0 : _mr$getValue7.s;
				mr.setValue(row, column, { s: { bd: (style === null || style === void 0 ? void 0 : style.bd) ? Object.assign(style.bd, { b: _univerjs_core.Tools.deepClone(borderStyle) }) : { b: _univerjs_core.Tools.deepClone(borderStyle) } } });
			}
			if (row !== range.startRow) {
				var _mr$getValue8;
				const style = (_mr$getValue8 = mr.getValue(row, column)) === null || _mr$getValue8 === void 0 ? void 0 : _mr$getValue8.s;
				mr.setValue(row, column, { s: { bd: (style === null || style === void 0 ? void 0 : style.bd) ? Object.assign(style.bd, { t: _univerjs_core.Tools.deepClone(borderStyle) }) : { t: _univerjs_core.Tools.deepClone(borderStyle) } } });
			}
		}
	});
};
function otherBorders(borderContext) {
	...
	if (tl_br) setBorderStyle(borderContext.range, { tl_br: _univerjs_core.Tools.deepClone(borderStyle) }, true);
	if (tl_bc) setBorderStyle(borderContext.range, { tl_bc: _univerjs_core.Tools.deepClone(borderStyle) }, true);
	if (tl_mr) setBorderStyle(borderContext.range, { tl_mr: _univerjs_core.Tools.deepClone(borderStyle) }, true);
	if (bl_tr) setBorderStyle(borderContext.range, { bl_tr: _univerjs_core.Tools.deepClone(borderStyle) }, true);
	if (ml_tr) setBorderStyle(borderContext.range, { ml_tr: _univerjs_core.Tools.deepClone(borderStyle) }, true);
	if (bc_tr) setBorderStyle(borderContext.range, { bc_tr: _univerjs_core.Tools.deepClone(borderStyle) }, true);
}
const outlineBorder = (borderContext) => {
	...
	if (top) {
		...
		*/
		...
		setBorderStyle(topRange, { t: _univerjs_core.Tools.deepClone(borderStyle) }, true);
	}
	if (bottom) {
		setBorderStyle(bottomRangeOut, { t: null });
		setBorderStyle(bottomRange, { b: _univerjs_core.Tools.deepClone(borderStyle) }, true);
	}
	if (left) {
		setBorderStyle(leftRangeOut, { r: null });
		setBorderStyle(leftRange, { l: _univerjs_core.Tools.deepClone(borderStyle) }, true);
	}
	if (right) {
		setBorderStyle(rightRangeOut, { l: null });
		setBorderStyle(rightRange, { r: _univerjs_core.Tools.deepClone(borderStyle) }, true);
	}
};
...
const SetSpecificColsVisibleCommand = {
	...
	handler: (accessor, params) => {
		...
		const result = (0, _univerjs_core.sequenceExecute)([{
...
const SetDefinedNameCommand = {
	...
	handler: (accessor, params) => {
		...
		const oldDefinedNameMutationParams = (0, _univerjs_engine_formula.SetDefinedNameMutationFactory)(accessor, params);
		const interceptorCommands = sheetInterceptorService.onCommandExecute({
...
const SetProtectionCommand = {
	...
	async handler(accessor, params) {
		...
		const redoMutations = [];
		const undoMutations = [];
		if ((oldRule === null || oldRule === void 0 ? void 0 : oldRule.unitType) === rule.unitType) if (rule.unitType === _univerjs_protocol.UnitObject.Worksheet) {
			redoMutations.push({
			...
			if (oldRule) {
				if (oldRule.unitType === _univerjs_protocol.UnitObject.Worksheet) {
					redoMutations.push({
						id: DeleteWorksheetProtectionMutation.id,
						params: {
							unitId,
				...
				} else if (oldRule.unitType === _univerjs_protocol.UnitObject.SelectRange) {
					redoMutations.push({
						id: DeleteRangeProtectionMutation.id,
						params: {
							unitId,
			...
			if (rule.unitType === _univerjs_protocol.UnitObject.Worksheet) {
				redoMutations.push({
					id: AddWorksheetProtectionMutation.id,
					params: {
						unitId,
			...
			} else if (rule.unitType === _univerjs_protocol.UnitObject.SelectRange) {
...
const SetRangeCustomMetadataCommand = {
	...
	handler: (accessor, params) => {
		...
		const { startRow, startColumn, endRow, endColumn } = range;
		const isArray = _univerjs_core.Tools.isArray(customMetadata);
		const cellValue = new _univerjs_core.ObjectMatrix();
...
const DeltaColumnWidthCommand = {
	...
	handler: async (accessor, params) => {
		...
		const isAllSheetRange = selections.length === 1 && selections[0].range.rangeType === _univerjs_core.RANGE_TYPE.ALL;
		const colSelections = selections.filter((s) => s.range.rangeType === _univerjs_core.RANGE_TYPE.COLUMN);
		const rangeType = isAllSheetRange ? _univerjs_core.RANGE_TYPE.ALL : colSelections.some(({ range }) => {
			const { startColumn, endColumn } = range;
			return startColumn <= anchorCol && anchorCol <= endColumn;
		}) ? _univerjs_core.RANGE_TYPE.COLUMN : _univerjs_core.RANGE_TYPE.NORMAL;
		let redoMutationParams;
		if (rangeType === _univerjs_core.RANGE_TYPE.ALL) {
		...
		} else if (rangeType === _univerjs_core.RANGE_TYPE.COLUMN) redoMutationParams = {
			subUnitId,
			unitId,
			ranges: colSelections.map((s) => _univerjs_core.Rectangle.clone(s.range)),
			colWidth: destColumnWidth
		};
...
const SetWorksheetHideCommand = {
	...
	handler: (accessor, params) => {
		...
		if (!target) return false;
		const { workbook, worksheet, unitId, subUnitId } = target;
		if (worksheet.getConfig().hidden === _univerjs_core.BooleanNumber.TRUE) return false;
		const redoMutationParams = {
			unitId,
			subUnitId,
		...
		if (workbook.getSheets().filter((sheet) => sheet.getConfig().hidden === _univerjs_core.BooleanNumber.FALSE).length === 1) {
...
var WorksheetProtectionPointModel = class {
	constructor() {
		_defineProperty(this, "_model", /* @__PURE__ */ new Map());
		_defineProperty(this, "_pointChange", new rxjs.Subject());
...
var RangeProtectionPermissionDeleteProtectionPoint = class {
	constructor(unitId, subUnitId, permissionId) {
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.SelectRange);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Delete);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		...
		this.id = `${_univerjs_protocol.UnitObject.SelectRange}.${_univerjs_protocol.UnitAction.Delete}.${permissionId}`;
	}
};
...
var RangeProtectionPermissionEditPoint = class {
	constructor(unitId, subUnitId, permissionId) {
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.SelectRange);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Edit);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "value", true);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "unitId", void 0);
		...
		this.subUnitId = subUnitId;
		this.permissionId = permissionId;
		this.id = `${_univerjs_protocol.UnitObject.SelectRange}.${_univerjs_protocol.UnitAction.Edit}.${permissionId}`;
	}
};
...
var RangeProtectionPermissionManageCollaPoint = class {
	constructor(unitId, subUnitId, permissionId) {
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.SelectRange);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.ManageCollaborator);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "value", true);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "unitId", void 0);
		...
		this.subUnitId = subUnitId;
		this.permissionId = permissionId;
		this.id = `${_univerjs_protocol.UnitObject.SelectRange}.${_univerjs_protocol.UnitAction.ManageCollaborator}.${permissionId}`;
	}
};
...
var RangeProtectionPermissionViewPoint = class {
	constructor(unitId, subUnitId, permissionId) {
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.SelectRange);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.View);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		...
		this.subUnitId = subUnitId;
		this.permissionId = permissionId;
		this.id = `${_univerjs_protocol.UnitObject.SelectRange}.${_univerjs_protocol.UnitAction.View}.${permissionId}`;
	}
};
...
const baseProtectionActions = [
	...
	_univerjs_protocol.UnitAction.View,
	_univerjs_protocol.UnitAction.ManageCollaborator,
	_univerjs_protocol.UnitAction.Delete
];
...
var WorkbookCommentPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "value", true);
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Comment);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.Comment}_${unitId}`;
	}
};
...
var WorkbookCopyPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Copy);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.Copy}_${unitId}`;
	}
};
...
var WorkbookCopySheetPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "value", true);
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.CopySheet);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.CopySheet}_${unitId}`;
	}
};
...
var WorkbookCreateProtectPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.CreatePermissionObject);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.CreatePermissionObject}_${unitId}`;
	}
};
...
var WorkbookCreateSheetPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.CreateSheet);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.CreateSheet}_${unitId}`;
	}
};
...
var WorkbookDeleteColumnPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.DeleteColumn);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.DeleteColumn}_${unitId}`;
	}
};
...
var WorkbookDeleteRowPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.DeleteRow);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.DeleteRow}_${unitId}`;
	}
};
...
var WorkbookDeleteSheetPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.DeleteSheet);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.DeleteSheet}_${unitId}`;
	}
};
...
var WorkbookDuplicatePermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Duplicate);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.Duplicate}_${unitId}`;
	}
};
...
var WorkbookEditablePermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Edit);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.Edit}_${unitId}`;
	}
};
...
var WorkbookExportPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Export);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.Export}_${unitId}`;
	}
};
...
var WorkbookHideSheetPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.HideSheet);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.HideSheet}_${unitId}`;
	}
};
...
var WorkbookInsertColumnPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.InsertColumn);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.InsertColumn}_${unitId}`;
	}
};
...
var WorkbookInsertRowPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.InsertRow);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.InsertRow}_${unitId}`;
	}
};
...
var WorkbookManageCollaboratorPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.ManageCollaborator);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.ManageCollaborator}_${unitId}`;
	}
};
...
var WorkbookMoveSheetPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.MoveSheet);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.MoveSheet}_${unitId}`;
	}
};
...
var WorkbookPrintPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Print);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.Print}_${unitId}`;
	}
};
...
var WorkbookRecoverHistoryPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.RecoverHistory);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.RecoverHistory}_${unitId}`;
	}
};
...
var WorkbookRenameSheetPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.RenameSheet);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.RenameSheet}_${unitId}`;
	}
};
...
var WorkbookSharePermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Share);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.Share}_${unitId}`;
	}
};
...
var WorkbookViewPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.View);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.View}_${unitId}`;
	}
};
...
var WorkbookViewHistoryPermission = class {
	constructor(unitId) {
		...
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Workbook);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.ViewHistory);
		this.unitId = unitId;
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.ViewHistory}_${unitId}`;
	}
};
...
var WorksheetCopyPermission = class {
	constructor(unitId, subUnitId) {
		...
		this.subUnitId = subUnitId;
		_defineProperty(this, "value", true);
		_defineProperty(this, "type", _univerjs_protocol.UnitObject.Worksheet);
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Copy);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.Copy}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetDeleteColumnPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.DeleteColumn);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.DeleteColumn}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetDeleteProtectionPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Delete);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.Delete}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetDeleteRowPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.DeleteRow);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.DeleteRow}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetEditPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Edit);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.Edit}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetEditExtraObjectPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.EditExtraObject);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.EditExtraObject}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetFilterPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Filter);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.Filter}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetInsertColumnPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.InsertColumn);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.InsertColumn}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetInsertHyperlinkPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.InsertHyperlink);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.InsertHyperlink}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetInsertRowPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.InsertRow);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.InsertRow}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetManageCollaboratorPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.ManageCollaborator);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.ManageCollaborator}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetPivotTablePermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.PivotTable);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.PivotTable}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetSelectProtectedCellsPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.SelectProtectedCells);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.SelectProtectedCells}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetSelectUnProtectedCellsPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.SelectUnProtectedCells);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.SelectUnProtectedCells}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetSetCellStylePermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.SetCellStyle);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.SetCellStyle}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetSetCellValuePermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.SetCellValue);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.SetCellValue}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetSetColumnStylePermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.SetColumnStyle);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.SetColumnStyle}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetSetRowStylePermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.SetRowStyle);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.SetRowStyle}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetSortPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "status", _univerjs_core.PermissionStatus.INIT);
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.Sort);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.Sort}_${unitId}_${subUnitId}`;
	}
};
...
var WorksheetViewPermission = class {
	constructor(unitId, subUnitId) {
		...
		_defineProperty(this, "id", void 0);
		_defineProperty(this, "subType", _univerjs_protocol.UnitAction.View);
		this.id = `${this.type}.${_univerjs_protocol.UnitAction.View}_${unitId}_${subUnitId}`;
	}
};
...
const defaultWorkbookPermissionPoints = [
	_univerjs_protocol.UnitAction.Edit,
	_univerjs_protocol.UnitAction.Print,
	_univerjs_protocol.UnitAction.Comment,
	_univerjs_protocol.UnitAction.View,
	_univerjs_protocol.UnitAction.Copy,
	_univerjs_protocol.UnitAction.Export,
	_univerjs_protocol.UnitAction.ManageCollaborator,
	_univerjs_protocol.UnitAction.CreateSheet,
	_univerjs_protocol.UnitAction.DeleteSheet,
	_univerjs_protocol.UnitAction.RenameSheet,
	_univerjs_protocol.UnitAction.HideSheet,
	_univerjs_protocol.UnitAction.Duplicate,
	_univerjs_protocol.UnitAction.Share,
	_univerjs_protocol.UnitAction.MoveSheet,
	_univerjs_protocol.UnitAction.CopySheet,
	_univerjs_protocol.UnitAction.RecoverHistory,
	_univerjs_protocol.UnitAction.ViewHistory,
	_univerjs_protocol.UnitAction.CreatePermissionObject,
	_univerjs_protocol.UnitAction.InsertRow,
	_univerjs_protocol.UnitAction.InsertColumn,
	_univerjs_protocol.UnitAction.DeleteRow,
	_univerjs_protocol.UnitAction.DeleteColumn
];
...
const defaultWorksheetPermissionPoint = [
	...
	_univerjs_protocol.UnitAction.DeleteColumn,
	_univerjs_protocol.UnitAction.DeleteRow,
	_univerjs_protocol.UnitAction.EditExtraObject,
	_univerjs_protocol.UnitAction.Filter,
	_univerjs_protocol.UnitAction.InsertColumn,
	_univerjs_protocol.UnitAction.InsertRow,
	_univerjs_protocol.UnitAction.InsertHyperlink,
	_univerjs_protocol.UnitAction.PivotTable,
	_univerjs_protocol.UnitAction.SetCellStyle,
	_univerjs_protocol.UnitAction.SetCellValue,
	_univerjs_protocol.UnitAction.SetColumnStyle,
	_univerjs_protocol.UnitAction.SetRowStyle,
	_univerjs_protocol.UnitAction.Sort
];
...
let WorksheetPermissionService = class WorksheetPermissionService extends _univerjs_core.RxDisposable {
...
WorksheetPermissionService = __decorate([
	...
	__decorateParam(3, (0, _univerjs_core.Inject)(WorksheetProtectionRuleModel)),
	__decorateParam(4, (0, _univerjs_core.Inject)(WorksheetProtectionPointModel)),
	__decorateParam(5, (0, _univerjs_core.Inject)(_univerjs_core.IResourceManagerService)),
	__decorateParam(6, (0, _univerjs_core.Inject)(RangeProtectionRuleModel)),
	__decorateParam(7, (0, _univerjs_core.Inject)(_univerjs_core.ILogService))
...
const DeltaRowHeightCommand = {
	...
	handler: async (accessor, params) => {
		...
		const isAllSheetRange = selections.length === 1 && selections[0].range.rangeType === _univerjs_core.RANGE_TYPE.ALL;
		const rowSelections = selections.filter((s) => s.range.rangeType === _univerjs_core.RANGE_TYPE.ROW);
		const rangeType = isAllSheetRange ? _univerjs_core.RANGE_TYPE.ALL : rowSelections.some(({ range }) => {
			const { startRow, endRow } = range;
			return startRow <= anchorRow && anchorRow <= endRow;
		}) ? _univerjs_core.RANGE_TYPE.ROW : _univerjs_core.RANGE_TYPE.NORMAL;
		let redoMutationParams;
		if (rangeType === _univerjs_core.RANGE_TYPE.ALL) {
		...
		} else if (rangeType === _univerjs_core.RANGE_TYPE.ROW) redoMutationParams = {
			subUnitId,
			unitId,
			ranges: rowSelections.map((s) => _univerjs_core.Rectangle.clone(s.range)),
			rowHeight: destRowHeight
		};
		else redoMutationParams = {
			subUnitId,
		...
		const redoSetIsAutoHeightParams = {
			...
			autoHeightInfo: _univerjs_core.BooleanNumber.FALSE
		};
...
const SetWorksheetRowIsAutoHeightCommand = {
	...
	handler: (accessor, params) => {
		...
		const redoMutationParams = {
			...
			subUnitId,
			ranges,
			autoHeightInfo: _univerjs_core.BooleanNumber.TRUE
		};
...
const SetWorksheetShowCommand = {
	...
	handler: (accessor, params) => {
		...
		if (!target) return false;
		const { unitId, subUnitId, worksheet } = target;
		if (worksheet.getConfig().hidden === _univerjs_core.BooleanNumber.FALSE) return false;
		const commandService = accessor.get(_univerjs_core.ICommandService);
		const undoRedoService = accessor.get(_univerjs_core.IUndoRedoService);
		const redoMutationParams = {
			unitId,
...
const SplitTextToColumnsCommand = {
	...
	handler: (accessor, params) => {
		...
		const { startColumn } = _univerjs_core.Range.transformRange(range, worksheet);
...
const transformCellsToRange = (unitId, subUnitId, cells) => {
	...
	Object.keys(group).forEach((pattern) => {
		...
		groupItem.forEach((item) => {
			...
			values[key].ranges.push((0, _univerjs_core.cellToRange)(item.row, item.col));
		});
	});
	return {
		unitId,
...
const TextToNumberCommand = {
	...
	handler: (accessor, params) => {
		...
		for (let i = 0; i < ranges.length; i++) for (let r = ranges[i].startRow; r <= ranges[i].endRow; r++) for (let c = ranges[i].startColumn; c <= ranges[i].endColumn; c++) {
			...
			if (cell && cell.v && (cell.t !== _univerjs_core.CellValueType.NUMBER || (0, _univerjs_core.isTextFormat)(pattern)) && (0, _univerjs_core.isRealNum)(cell.v)) {
				newCellValue.setValue(r, c, {
					v: Number(cell.v),
					t: _univerjs_core.CellValueType.NUMBER
				});
				if ((0, _univerjs_core.isTextFormat)(pattern)) removeNumfmtRanges.push({
					startRow: r,
					endRow: r,
					startColumn: c,
					endColumn: c
...
const ToggleCellCheckboxCommand = {
	...
	handler: (accessor, params) => {
		...
		const p = _univerjs_core.Tools.deepClone(cell.p);
		const documentDataModel = new _univerjs_core.DocumentDataModel(p);
		...
		_univerjs_core.TextX.apply(documentDataModel.getBody(), textX.serialize());
		const redoParams = {
			unitId,
			subUnitId,
			cellValue: { [row]: { [col]: {
...
const ToggleGridlinesCommand = {
	...
	handler: (accessor, params) => {
		...
		const { unitId, subUnitId } = target;
		const doParams = {
			showGridlines: currentlyShow === _univerjs_core.BooleanNumber.TRUE ? _univerjs_core.BooleanNumber.FALSE : _univerjs_core.BooleanNumber.TRUE,
			unitId,
			subUnitId
		};
		const undoMutationParams = {
...
let AutoFillController = class AutoFillController extends _univerjs_core.Disposable {
	...
	_presetAndCacheData(location, direction) {
		...
		target.rows.forEach((i) => {
			...
			target.cols.forEach((j) => {
				row.push(_univerjs_core.Tools.deepClone(currentCellDatas.getValue(i, j)));
			});
			applyData.push(row);
		});
	...
	_getCopyData(location, direction) {
		...
		const rules = this._autoFillService.getRules();
		const copyData = [];
		const isVertical = direction === _univerjs_core.Direction.DOWN || direction === _univerjs_core.Direction.UP;
		let aArray;
		let bArray;
		if (isVertical) {
			aArray = source.cols;
	...
	_getMergeApplyData(source, target, direction, csLen, location) {
		...
		for (let i = source.startRow; i <= source.endRow; i++) for (let j = source.startColumn; j <= source.endColumn; j++) {
			...
			if (isMergedMainCell) {
				...
				} else if (direction === _univerjs_core.Direction.UP) {
					let windowStartRow = startRow - csLen;
					let windowEndRow = endRow - csLen;
	...
	_fillData(location, direction, applyType) {
		...
		let csLen;
		if (direction === _univerjs_core.Direction.DOWN || direction === _univerjs_core.Direction.UP) csLen = sourceRows.length;
...
let DefinedNameDataController = class DefinedNameDataController extends _univerjs_core.Disposable {
...
DefinedNameDataController = __decorate([__decorateParam(0, _univerjs_engine_formula.IDefinedNamesService), __decorateParam(1, _univerjs_core.IResourceManagerService)], DefinedNameDataController);
...
let SheetsFreezeSyncController = class SheetsFreezeSyncController extends _univerjs_core.Disposable {
	...
	_sequenceExecute(unitId, subUnitId, newFreeze, options) {
		(0, _univerjs_core.sequenceExecute)([{
			id: SetFrozenMutation.id,
			params: {
				...newFreeze,
				unitId,
...
let SheetPermissionCheckController = class SheetPermissionCheckController extends _univerjs_core.Disposable {
	constructor(_commandService, _univerInstanceService, _permissionService, _selectionManagerService, _rangeProtectionRuleModel, _worksheetProtectionRuleModel, _localeService, _lexerTreeBuilder, _definedNamesService) {
		...
		this._definedNamesService = _definedNamesService;
		_defineProperty(this, "disposableCollection", new _univerjs_core.DisposableCollection());
		_defineProperty(this, "_triggerPermissionUIEvent$", new rxjs.Subject());
	...
	blockExecuteWithoutPermission(errorMsg) {
		...
		throw new _univerjs_core.CustomCommandExecutionError("have no permission");
	}
	...
	permissionCheckWithRanges(permissionTypes, selectionRanges, unitId, subUnitId) {
		...
		if (rangeTypes && rangeTypes.length > 0) {
			...
			for (let i = 0; i < rules.length; i++) {
				const rule = rules[i];
				if (ranges.some((range) => rule.ranges.some((ruleRange) => _univerjs_core.Rectangle.intersects(ruleRange, range)))) {
	...
	_permissionCheckWithFormula(params) {
		...
		if (formulaString) {
			...
			if (definedName) {
				...
				if (formulaOrRefString.startsWith(_univerjs_engine_formula.operatorToken.EQUALS)) formulaOrRefString = formulaOrRefString.slice(1);
				const refRangesArr = formulaOrRefString.split(",");
				for (let i = 0; i < refRangesArr.length; i++) {
					const refRange = refRangesArr[i];
					const { sheetName, range } = (0, _univerjs_engine_formula.deserializeRangeWithSheet)(refRange);
					if (sheetName) {
				...
				for (let i = 0; i < sequenceNodes.length; i++) {
					...
					const { token } = node;
					const { unitId: sequenceGridUnitId, sheetName, range } = (0, _univerjs_engine_formula.deserializeRangeWithSheetWithCache)(token);
					let sequenceGridWorkbook = workbook;
					if (sequenceGridUnitId && sequenceGridUnitId !== unitId) {
						const _sequenceGridWorkbook = this._univerInstanceService.getUnit(sequenceGridUnitId, _univerjs_core.UniverInstanceType.UNIVER_SHEET);
		...
		if (range) {
			...
			if (rules.length === 0) return true;
			const permissionIds = rules.filter((rule) => rule.ranges.some((ruleRange) => _univerjs_core.Rectangle.intersects(ruleRange, range))).map((rule) => new RangeProtectionPermissionEditPoint(unitId, subUnitId, rule.permissionId).id);
	...
	_permissionCheckBySetRangeValue(permissionTypes, params) {
		...
		let ranges = [];
		if ((_univerjs_core.Tools.isArray(value) || (0, _univerjs_core.isICellData)(value)) && range) ranges = [range];
		else ranges = [new _univerjs_core.ObjectMatrix(value).getStartEndScope()];
	...
	_permissionCheckByInsertRowColCommand(params) {
		...
		if (direction === _univerjs_core.Direction.UP || direction === _univerjs_core.Direction.DOWN) {
			const anchorRow = direction === _univerjs_core.Direction.UP ? range.startRow : range.startRow - 1;
		...
		} else if (direction === _univerjs_core.Direction.LEFT || direction === _univerjs_core.Direction.RIGHT) {
			const anchorCol = direction === _univerjs_core.Direction.LEFT ? range.startColumn : range.startColumn - 1;
	...
	_permissionCheckWithInsertOrDeleteMoveRange(direction, params) {
		...
		if (rules.some((rule) => rule.ranges.some((range) => _univerjs_core.Rectangle.intersects(range, _range)))) return false;
		return true;
	}
};
SheetPermissionCheckController = __decorate([
	...
	__decorateParam(2, _univerjs_core.IPermissionService),
	__decorateParam(3, (0, _univerjs_core.Inject)(SheetsSelectionsService)),
	__decorateParam(4, (0, _univerjs_core.Inject)(RangeProtectionRuleModel)),
	__decorateParam(5, (0, _univerjs_core.Inject)(WorksheetProtectionRuleModel)),
	__decorateParam(6, (0, _univerjs_core.Inject)(_univerjs_core.LocaleService)),
	__decorateParam(7, (0, _univerjs_core.Inject)(_univerjs_engine_formula.LexerTreeBuilder)),
...
let WorkbookPermissionService = class WorkbookPermissionService extends _univerjs_core.Disposable {
	constructor(_permissionService, _univerInstanceService, _rangeProtectionRuleModel, _worksheetProtectionRuleModel, _worksheetProtectionPointModel) {
		...
		_defineProperty(this, "_unitPermissionInitStateChange", new rxjs.BehaviorSubject(false));
...
WorkbookPermissionService = __decorate([
	__decorateParam(0, (0, _univerjs_core.Inject)(_univerjs_core.IPermissionService)),
	__decorateParam(1, (0, _univerjs_core.Inject)(_univerjs_core.IUniverInstanceService)),
	__decorateParam(2, (0, _univerjs_core.Inject)(RangeProtectionRuleModel)),
	__decorateParam(3, (0, _univerjs_core.Inject)(WorksheetProtectionRuleModel)),
	__decorateParam(4, (0, _univerjs_core.Inject)(WorksheetProtectionPointModel))
...
let SheetPermissionInitController = class SheetPermissionInitController extends _univerjs_core.Disposable {
	...
	async _initRangePermissionFromSnapshot() {
		...
		await Promise.all(this._univerInstanceService.getAllUnitsForType(_univerjs_core.UniverInstanceType.UNIVER_SHEET).map((workbook) => initRangePermissionFunc(workbook)));
		this._rangeProtectionRuleModel.changeRuleInitState(true);
	}
	...
	async initWorkbookPermissionChange(_unitId) {
		...
		return this._authzIoService.allowed({
			objectID: unitId,
			objectType: _univerjs_protocol.UnitObject.Workbook,
			unitID: unitId,
	...
	async _initWorkbookPermissionFromSnapshot() {
		await Promise.all(this._univerInstanceService.getAllUnitsForType(_univerjs_core.UniverInstanceType.UNIVER_SHEET).map((workbook) => this.initWorkbookPermissionChange(workbook.getUnitId())));
	...
	async _initWorksheetPermissionFromSnapshot() {
		...
		await Promise.all(this._univerInstanceService.getAllUnitsForType(_univerjs_core.UniverInstanceType.UNIVER_SHEET).map((workbook) => initSheetPermissionFunc(workbook)));
		this._worksheetProtectionRuleModel.changeRuleInitState(true);
	}
	_initUserChange() {
		this.disposeWithMe(this._userManagerService.currentUser$.pipe((0, rxjs.skip)(1)).subscribe(() => {
...
SheetPermissionInitController = __decorate([
	...
	__decorateParam(2, _univerjs_core.IAuthzIoService),
	__decorateParam(3, (0, _univerjs_core.Inject)(RangeProtectionRuleModel)),
	__decorateParam(4, (0, _univerjs_core.Inject)(WorksheetProtectionRuleModel)),
	__decorateParam(5, (0, _univerjs_core.Inject)(_univerjs_core.UserManagerService)),
	__decorateParam(6, (0, _univerjs_core.Inject)(WorksheetProtectionPointModel)),
	__decorateParam(7, (0, _univerjs_core.Inject)(WorkbookPermissionService)),
	__decorateParam(8, (0, _univerjs_core.Inject)(_univerjs_core.IUndoRedoService)),
	__decorateParam(9, (0, _univerjs_core.Inject)(_univerjs_core.ICommandService))
], SheetPermissionInitController);

//#endregion
//#region src/controllers/zebar-crossing.controller.ts
let ZebraCrossingCacheController = class ZebraCrossingCacheController extends _univerjs_core.Disposable {
	constructor(_commandService, _sheetRangeThemeModel, _univerInstanceService) {
		super();
		this._commandService = _commandService;
		this._sheetRangeThemeModel = _sheetRangeThemeModel;
		this._univerInstanceService = _univerInstanceService;
		_defineProperty(this, "_zebraCacheUpdateSubject", new rxjs.Subject());
		this._init();
	}
	_init() {
...
ZebraCrossingCacheController = __decorate([
	__decorateParam(0, (0, _univerjs_core.Inject)(_univerjs_core.ICommandService)),
	__decorateParam(1, (0, _univerjs_core.Inject)(SheetRangeThemeModel)),
	__decorateParam(2, (0, _univerjs_core.Inject)(_univerjs_core.IUniverInstanceService))
...
let RangeProtectionCache = class RangeProtectionCache extends _univerjs_core.Disposable {
	...
	_getSelectionActions(unitId, subUnitId, rule) {
		...
		return {
			...
			[_univerjs_protocol.UnitAction.ManageCollaborator]: manageProtection,
			[_univerjs_protocol.UnitAction.Delete]: deleteProtection
		};
	}
...
RangeProtectionCache = __decorate([
	...
	__decorateParam(1, (0, _univerjs_core.Inject)(_univerjs_core.IPermissionService)),
	__decorateParam(2, (0, _univerjs_core.Inject)(_univerjs_core.IUniverInstanceService))
...
ActiveWorksheetController = __decorate([__decorateParam(0, _univerjs_core.ICommandService), __decorateParam(1, _univerjs_core.IUniverInstanceService)], ActiveWorksheetController);
...
* limitations under the License.
*/
let NumberCellDisplayController = class NumberCellDisplayController extends _univerjs_core.Disposable {
	...
	_initInterceptorCellContent() {
		this.disposeWithMe(this._sheetInterceptorService.intercept(INTERCEPTOR_POINT.CELL_CONTENT, {
			...
			handler: (cell, location, next) => {
				...
				if (!(0, _univerjs_core.isDefaultFormat)(style === null || style === void 0 || (_style$n = style.n) === null || _style$n === void 0 ? void 0 : _style$n.pattern)) return next(cell);
...
NumberCellDisplayController = __decorate([__decorateParam(0, (0, _univerjs_core.Inject)(SheetInterceptorService))], NumberCellDisplayController);

//#endregion
//#region src/controllers/permission/sheet-permission-view-model.controller.ts
let SheetPermissionViewModelController = class SheetPermissionViewModelController extends _univerjs_core.Disposable {
		...
		this.disposeWithMe(this._sheetInterceptorService.intercept(INTERCEPTOR_POINT.CELL_CONTENT, {
			...
			handler: (cell, context, next) => {
				...
				if (selectionProtection) {
					const isSkipRender = selectionProtection[_univerjs_protocol.UnitAction.View] === false;
...
SheetPermissionViewModelController = __decorate([
	__decorateParam(0, _univerjs_core.IPermissionService),
	__decorateParam(1, (0, _univerjs_core.Inject)(WorksheetProtectionRuleModel)),
	__decorateParam(2, (0, _univerjs_core.Inject)(SheetInterceptorService)),
	__decorateParam(3, (0, _univerjs_core.Inject)(RangeProtectionCache))
...
var ExclusiveRangeService = class extends _univerjs_core.Disposable {
	constructor(..._args) {
		...
		_defineProperty(this, "_exclusiveRangesChange$", new rxjs.Subject());
	...
	getInterestGroupId(selections) {
		...
		selections.forEach((selection) => {
			...
			for (const feature of featureMap.keys()) {
				...
				if (featureMapRanges) {
					for (const featureMapRange of featureMapRanges) if (_univerjs_core.Rectangle.intersects(range, featureMapRange.range)) {
...
let NumfmtService = class NumfmtService extends _univerjs_core.Disposable {
...
let RangeProtectionRefRangeService = class RangeProtectionRefRangeService extends _univerjs_core.Disposable {
	...
	_getRefRangeMutationsByDeleteCols(params, unitId, subUnitId) {
		const permissionRangeLapRules = this._selectionProtectionRuleModel.getSubunitRuleList(unitId, subUnitId).filter((rule) => {
			return rule.ranges.some((range) => {
				return _univerjs_core.Rectangle.intersects(range, params.range);
			});
		});
		...
		if (permissionRangeLapRules.length) {
			...
			permissionRangeLapRules.forEach((rule) => {
				const cloneRule = _univerjs_core.Tools.deepClone(rule);
				cloneRule.ranges = cloneRule.ranges.reduce((p, c) => {
					if (_univerjs_core.Rectangle.intersects(c, removeRange)) {
						const cloneRange = _univerjs_core.Tools.deepClone(c);
			...
			if (mutationIdArrByMove.includes(command.id)) {
				...
				this._selectionProtectionRuleModel.getSubunitRuleList(workbook.getUnitId(), worksheet.getSheetId()).forEach((rule) => {
					rule.ranges.forEach((range) => {
						...
						if (!_univerjs_core.Rectangle.intersects(range, sourceRange)) {
							if (isRowMove) {
								if (sourceStart < startRow && targetStart > endRow) {
									startRow -= moveLength;
									endRow -= moveLength;
...
RangeProtectionRefRangeService = __decorate([
	...
	__decorateParam(3, (0, _univerjs_core.Inject)(RefRangeService)),
	__decorateParam(4, (0, _univerjs_core.Inject)(RangeProtectionRenderModel)),
	__decorateParam(5, (0, _univerjs_core.Inject)(RangeProtectionCache)),
	__decorateParam(6, (0, _univerjs_core.Inject)(SheetInterceptorService)),
	__decorateParam(7, (0, _univerjs_core.Inject)(RangeProtectionRuleModel))
...
let RangeProtectionService = class RangeProtectionService extends _univerjs_core.Disposable {
...
RangeProtectionService = __decorate([
	__decorateParam(0, (0, _univerjs_core.Inject)(RangeProtectionRuleModel)),
	__decorateParam(1, (0, _univerjs_core.Inject)(_univerjs_core.IPermissionService)),
	__decorateParam(2, (0, _univerjs_core.Inject)(_univerjs_core.IResourceManagerService)),
	__decorateParam(3, (0, _univerjs_core.Inject)(RangeProtectionCache)),
...
SheetRangeThemeService = __decorate([__decorateParam(0, (0, _univerjs_core.Inject)(SheetRangeThemeModel))], SheetRangeThemeService);

//#endregion
//#region src/plugin.ts
let UniverSheetsPlugin = class UniverSheetsPlugin extends _univerjs_core.Plugin {
	...
	_initConfig() {
		...
		if ((_this$_config2 = this._config) === null || _this$_config2 === void 0 ? void 0 : _this$_config2.isRowStylePrecedeColumnStyle) this._configService.setConfig(_univerjs_core.IS_ROW_STYLE_PRECEDE_COLUMN_STYLE, true);
		if ((_this$_config3 = this._config) === null || _this$_config3 === void 0 ? void 0 : _this$_config3.autoHeightForMergedCells) this._configService.setConfig(_univerjs_core.AUTO_HEIGHT_FOR_MERGED_CELLS, true);
	}
	_initDependencies() {
		var _this$_config4;
		const dependencies = [
		...
		(0, _univerjs_core.registerDependencies)(this._injector, (0, _univerjs_core.mergeOverrideWithDependencies)(dependencies, this._config.override));
	...
	onRendered() {
		(0, _univerjs_core.touchDependencies)(this._injector, [[INumfmtService]]);
	}
	onReady() {
		(0, _univerjs_core.touchDependencies)(this._injector, [
...
_defineProperty(UniverSheetsPlugin, "type", _univerjs_core.UniverInstanceType.UNIVER_SHEET);
...
const checkRangesEditablePermission = (accessor, unitId, subUnitId, ranges) => {
	...
	const ruleList = rangeProtectionRuleModel.getSubunitRuleList(unitId, subUnitId).filter((rule) => {
		return rule.ranges.some((ruleRange) => ranges.some((range) => _univerjs_core.Rectangle.intersects(ruleRange, range)));
	});
...
const getPrimaryCell = (scopeRange, worksheet, currentPrimary, direction, step = 1) => {
	switch (direction) {
		case _univerjs_core.Direction.UP: return getPrimaryCellUp(scopeRange, worksheet, currentPrimary, step);
		case _univerjs_core.Direction.DOWN: return getPrimaryCellDown(scopeRange, worksheet, currentPrimary, step);
		case _univerjs_core.Direction.LEFT: return getPrimaryCellLeft(scopeRange, worksheet, currentPrimary, step);
		case _univerjs_core.Direction.RIGHT: return getPrimaryCellRight(scopeRange, worksheet, currentPrimary, step);
	}
};
/**
...
const getNextPrimaryCell = (selections, direction, worksheet) => {
	...
	if (!_univerjs_core.Rectangle.equals(activeSelection.range, primary)) {
...
function convertPositionSheetOverGridToAbsolute(unitId, subUnitId, sheetOverGridPosition, skeleton) {
	...
	const left = (0, _univerjs_engine_render.precisionTo)(startSelectionX + fromColumnOffset, 1);
	const top = (0, _univerjs_engine_render.precisionTo)(startSelectionY + fromRowOffset, 1);
	let width = (0, _univerjs_engine_render.precisionTo)(endSelectionX + toColumnOffset - left, 1);
	let height = (0, _univerjs_engine_render.precisionTo)(endSelectionY + toRowOffset - top, 1);
...
//#endregion
exports.AFFECT_LAYOUT_STYLES = AFFECT_LAYOUT_STYLES;
exports.AFTER_CELL_EDIT = AFTER_CELL_EDIT;
exports.AUTO_FILL_APPLY_TYPE = AUTO_FILL_APPLY_TYPE;
exports.AUTO_FILL_DATA_TYPE = AUTO_FILL_DATA_TYPE;
exports.AUTO_FILL_HOOK_TYPE = AUTO_FILL_HOOK_TYPE;
exports.AddMergeRedoSelectionsOperationFactory = AddMergeRedoSelectionsOperationFactory;
exports.AddMergeUndoMutationFactory = AddMergeUndoMutationFactory;
exports.AddMergeUndoSelectionsOperationFactory = AddMergeUndoSelectionsOperationFactory;
exports.AddRangeProtectionCommand = AddRangeProtectionCommand;
exports.AddRangeProtectionMutation = AddRangeProtectionMutation;
exports.AddRangeThemeMutation = AddRangeThemeMutation;
exports.AddWorksheetMergeAllCommand = AddWorksheetMergeAllCommand;
exports.AddWorksheetMergeCommand = AddWorksheetMergeCommand;
exports.AddWorksheetMergeHorizontalCommand = AddWorksheetMergeHorizontalCommand;
exports.AddWorksheetMergeMutation = AddWorksheetMergeMutation;
exports.AddWorksheetMergeVerticalCommand = AddWorksheetMergeVerticalCommand;
exports.AddWorksheetProtectionCommand = AddWorksheetProtectionCommand;
exports.AddWorksheetProtectionMutation = AddWorksheetProtectionMutation;
exports.AppendRowCommand = AppendRowCommand;
exports.AutoClearContentCommand = AutoClearContentCommand;
exports.AutoFillCommand = AutoFillCommand;
Object.defineProperty(exports, 'AutoFillController', {
  enumerable: true,
  get: function () {
    return AutoFillController;
  }
});
exports.AutoFillRules = AutoFillRules;
Object.defineProperty(exports, 'AutoFillService', {
  enumerable: true,
  get: function () {
    return AutoFillService;
  }
});
exports.AutoFillTools = AutoFillTools;
exports.BEFORE_CELL_EDIT = BEFORE_CELL_EDIT;
...
exports.ClearSelectionContentCommand = ClearSelectionContentCommand;
exports.ClearSelectionFormatCommand = ClearSelectionFormatCommand;
exports.CopySheetCommand = CopySheetCommand;
exports.CopyWorksheetEndMutation = CopyWorksheetEndMutation;
exports.DISABLE_NORMAL_SELECTIONS = DISABLE_NORMAL_SELECTIONS;
Object.defineProperty(exports, 'DefinedNameDataController', {
  enumerable: true,
  get: function () {
    return DefinedNameDataController;
  }
});
exports.DeleteRangeMoveLeftCommand = DeleteRangeMoveLeftCommand;
exports.DeleteRangeMoveUpCommand = DeleteRangeMoveUpCommand;
exports.DeleteRangeProtectionCommand = DeleteRangeProtectionCommand;
exports.DeleteRangeProtectionMutation = DeleteRangeProtectionMutation;
exports.DeleteWorksheetProtectionCommand = DeleteWorksheetProtectionCommand;
exports.DeleteWorksheetProtectionMutation = DeleteWorksheetProtectionMutation;
exports.DeleteWorksheetRangeThemeStyleCommand = DeleteWorksheetRangeThemeStyleCommand;
exports.DeleteWorksheetRangeThemeStyleMutation = DeleteWorksheetRangeThemeStyleMutation;
exports.DeleteWorksheetRangeThemeStyleMutationFactory = DeleteWorksheetRangeThemeStyleMutationFactory;
exports.DeltaColumnWidthCommand = DeltaColumnWidthCommand;
exports.DeltaRowHeightCommand = DeltaRowHeightCommand;
exports.EditStateEnum = EditStateEnum;
exports.EffectRefRangId = EffectRefRangId;
exports.EmptyMutation = EmptyMutation;
exports.ExclusiveRangeService = ExclusiveRangeService;
exports.FactoryAddRangeProtectionMutation = FactoryAddRangeProtectionMutation;
exports.FactoryDeleteRangeProtectionMutation = FactoryDeleteRangeProtectionMutation;
exports.FactorySetRangeProtectionMutation = FactorySetRangeProtectionMutation;
exports.IAutoFillService = IAutoFillService;
exports.IExclusiveRangeService = IExclusiveRangeService;
exports.INTERCEPTOR_POINT = INTERCEPTOR_POINT;
exports.INumfmtService = INumfmtService;
exports.IRefSelectionsService = IRefSelectionsService;
exports.InsertColAfterCommand = InsertColAfterCommand;
exports.InsertColBeforeCommand = InsertColBeforeCommand;
exports.InsertColByRangeCommand = InsertColByRangeCommand;
exports.InsertColCommand = InsertColCommand;
exports.InsertColMutation = InsertColMutation;
exports.InsertColMutationUndoFactory = InsertColMutationUndoFactory;
exports.InsertDefinedNameCommand = InsertDefinedNameCommand;
exports.InsertMultiColsLeftCommand = InsertMultiColsLeftCommand;
exports.InsertMultiColsRightCommand = InsertMultiColsRightCommand;
exports.InsertMultiRowsAboveCommand = InsertMultiRowsAboveCommand;
exports.InsertMultiRowsAfterCommand = InsertMultiRowsAfterCommand;
exports.InsertRangeMoveDownCommand = InsertRangeMoveDownCommand;
exports.InsertRangeMoveRightCommand = InsertRangeMoveRightCommand;
exports.InsertRowAfterCommand = InsertRowAfterCommand;
exports.InsertRowBeforeCommand = InsertRowBeforeCommand;
exports.InsertRowByRangeCommand = InsertRowByRangeCommand;
exports.InsertRowCommand = InsertRowCommand;
exports.InsertRowMutation = InsertRowMutation;
exports.InsertRowMutationUndoFactory = InsertRowMutationUndoFactory;
exports.InsertSheetCommand = InsertSheetCommand;
exports.InsertSheetMutation = InsertSheetMutation;
exports.InsertSheetUndoMutationFactory = InsertSheetUndoMutationFactory;
exports.InterceptCellContentPriority = InterceptCellContentPriority;
exports.MAX_CELL_PER_SHEET_KEY = MAX_CELL_PER_SHEET_KEY;
exports.MERGE_CELL_INTERCEPTOR_CHECK = MERGE_CELL_INTERCEPTOR_CHECK;
exports.MarkDirtyFilterChangeMutation = MarkDirtyFilterChangeMutation;
exports.MarkDirtyRowAutoHeightOperation = MarkDirtyRowAutoHeightOperation;
Object.defineProperty(exports, 'MergeCellController', {
  enumerable: true,
  get: function () {
    return MergeCellController;
  }
});
exports.MoveColsCommand = MoveColsCommand;
exports.MoveColsMutation = MoveColsMutation;
exports.MoveColsMutationUndoFactory = MoveColsMutationUndoFactory;
exports.MoveRangeCommand = MoveRangeCommand;
exports.MoveRangeMutation = MoveRangeMutation;
exports.MoveRowsCommand = MoveRowsCommand;
exports.MoveRowsMutation = MoveRowsMutation;
exports.MoveRowsMutationUndoFactory = MoveRowsMutationUndoFactory;
Object.defineProperty(exports, 'NumfmtService', {
  enumerable: true,
  get: function () {
    return NumfmtService;
  }
});
exports.OperatorType = OperatorType;
exports.PermissionPointsDefinitions = PermissionPointsDefinitions;
exports.REF_SELECTIONS_ENABLED = REF_SELECTIONS_ENABLED;
exports.RangeMergeUtil = RangeMergeUtil;
Object.defineProperty(exports, 'RangeProtectionCache', {
  enumerable: true,
  get: function () {
    return RangeProtectionCache;
  }
});
exports.RangeProtectionPermissionDeleteProtectionPoint = RangeProtectionPermissionDeleteProtectionPoint;
exports.RangeProtectionPermissionEditPoint = RangeProtectionPermissionEditPoint;
exports.RangeProtectionPermissionManageCollaPoint = RangeProtectionPermissionManageCollaPoint;
exports.RangeProtectionPermissionViewPoint = RangeProtectionPermissionViewPoint;
Object.defineProperty(exports, 'RangeProtectionRefRangeService', {
  enumerable: true,
  get: function () {
    return RangeProtectionRefRangeService;
  }
});
Object.defineProperty(exports, 'RangeProtectionRenderModel', {
  enumerable: true,
  get: function () {
    return RangeProtectionRenderModel;
  }
});
exports.RangeProtectionRuleModel = RangeProtectionRuleModel;
Object.defineProperty(exports, 'RangeProtectionService', {
  enumerable: true,
  get: function () {
    return RangeProtectionService;
  }
});
exports.RangeThemeStyle = RangeThemeStyle;
Object.defineProperty(exports, 'RefRangeService', {
  enumerable: true,
  get: function () {
    return RefRangeService;
  }
});
Object.defineProperty(exports, 'RefSelectionsService', {
  enumerable: true,
  get: function () {
    return RefSelectionsService;
  }
});
exports.RefillCommand = RefillCommand;
exports.RegisterWorksheetRangeThemeStyleCommand = RegisterWorksheetRangeThemeStyleCommand;
exports.RegisterWorksheetRangeThemeStyleMutation = RegisterWorksheetRangeThemeStyleMutation;
exports.RemoveColByRangeCommand = RemoveColByRangeCommand;
exports.RemoveColCommand = RemoveColCommand;
exports.RemoveColMutation = RemoveColMutation;
exports.RemoveDefinedNameCommand = RemoveDefinedNameCommand;
exports.RemoveMergeUndoMutationFactory = RemoveMergeUndoMutationFactory;
exports.RemoveNumfmtMutation = RemoveNumfmtMutation;
exports.RemoveRangeThemeMutation = RemoveRangeThemeMutation;
exports.RemoveRowByRangeCommand = RemoveRowByRangeCommand;
exports.RemoveRowCommand = RemoveRowCommand;
exports.RemoveRowMutation = RemoveRowMutation;
exports.RemoveSheetCommand = RemoveSheetCommand;
exports.RemoveSheetMutation = RemoveSheetMutation;
exports.RemoveSheetUndoMutationFactory = RemoveSheetUndoMutationFactory;
exports.RemoveWorksheetMergeCommand = RemoveWorksheetMergeCommand;
exports.RemoveWorksheetMergeMutation = RemoveWorksheetMergeMutation;
exports.ReorderRangeCommand = ReorderRangeCommand;
exports.ReorderRangeMutation = ReorderRangeMutation;
exports.ReorderRangeUndoMutationFactory = ReorderRangeUndoMutationFactory;
exports.ResetBackgroundColorCommand = ResetBackgroundColorCommand;
exports.ResetTextColorCommand = ResetTextColorCommand;
exports.SCOPE_WORKBOOK_VALUE_DEFINED_NAME = SCOPE_WORKBOOK_VALUE_DEFINED_NAME;
exports.SELECTIONS_ENABLED = SELECTIONS_ENABLED;
exports.SELECTION_CONTROL_BORDER_BUFFER_COLOR = SELECTION_CONTROL_BORDER_BUFFER_COLOR;
exports.SELECTION_CONTROL_BORDER_BUFFER_WIDTH = SELECTION_CONTROL_BORDER_BUFFER_WIDTH;
exports.SHEETS_PLUGIN_CONFIG_KEY = SHEETS_PLUGIN_CONFIG_KEY;
exports.ScrollToCellOperation = ScrollToCellOperation;
exports.SelectRangeCommand = SelectRangeCommand;
exports.SelectionMoveType = SelectionMoveType;
exports.SetBackgroundColorCommand = SetBackgroundColorCommand;
exports.SetBoldCommand = SetBoldCommand;
exports.SetBorderBasicCommand = SetBorderBasicCommand;
exports.SetBorderColorCommand = SetBorderColorCommand;
exports.SetBorderCommand = SetBorderCommand;
exports.SetBorderPositionCommand = SetBorderPositionCommand;
exports.SetBorderStyleCommand = SetBorderStyleCommand;
exports.SetColDataCommand = SetColDataCommand;
exports.SetColDataMutation = SetColDataMutation;
exports.SetColDataMutationFactory = SetColDataMutationFactory;
exports.SetColHiddenCommand = SetColHiddenCommand;
exports.SetColHiddenMutation = SetColHiddenMutation;
exports.SetColVisibleMutation = SetColVisibleMutation;
exports.SetColWidthCommand = SetColWidthCommand;
exports.SetDefinedNameCommand = SetDefinedNameCommand;
exports.SetFontFamilyCommand = SetFontFamilyCommand;
exports.SetFontSizeCommand = SetFontSizeCommand;
exports.SetFrozenCommand = SetFrozenCommand;
exports.SetFrozenMutation = SetFrozenMutation;
exports.SetFrozenMutationFactory = SetFrozenMutationFactory;
exports.SetGridlinesColorCommand = SetGridlinesColorCommand;
exports.SetGridlinesColorMutation = SetGridlinesColorMutation;
exports.SetHorizontalTextAlignCommand = SetHorizontalTextAlignCommand;
exports.SetItalicCommand = SetItalicCommand;
exports.SetNumfmtMutation = SetNumfmtMutation;
exports.SetOverlineCommand = SetOverlineCommand;
exports.SetProtectionCommand = SetProtectionCommand;
exports.SetRangeCustomMetadataCommand = SetRangeCustomMetadataCommand;
exports.SetRangeProtectionMutation = SetRangeProtectionMutation;
exports.SetRangeThemeMutation = SetRangeThemeMutation;
exports.SetRangeValuesCommand = SetRangeValuesCommand;
exports.SetRangeValuesMutation = SetRangeValuesMutation;
exports.SetRangeValuesUndoMutationFactory = SetRangeValuesUndoMutationFactory;
exports.SetRowDataCommand = SetRowDataCommand;
exports.SetRowDataMutation = SetRowDataMutation;
exports.SetRowDataMutationFactory = SetRowDataMutationFactory;
exports.SetRowHeightCommand = SetRowHeightCommand;
exports.SetRowHiddenCommand = SetRowHiddenCommand;
exports.SetRowHiddenMutation = SetRowHiddenMutation;
exports.SetRowVisibleMutation = SetRowVisibleMutation;
...
exports.SetStyleCommand = SetStyleCommand;
exports.SetTabColorCommand = SetTabColorCommand;
exports.SetTabColorMutation = SetTabColorMutation;
exports.SetTextColorCommand = SetTextColorCommand;
exports.SetTextRotationCommand = SetTextRotationCommand;
exports.SetTextWrapCommand = SetTextWrapCommand;
exports.SetUnderlineCommand = SetUnderlineCommand;
exports.SetVerticalTextAlignCommand = SetVerticalTextAlignCommand;
exports.SetWorkbookNameCommand = SetWorkbookNameCommand;
exports.SetWorkbookNameMutation = SetWorkbookNameMutation;
exports.SetWorksheetActivateCommand = SetWorksheetActivateCommand;
exports.SetWorksheetActiveOperation = SetWorksheetActiveOperation;
exports.SetWorksheetColWidthMutation = SetWorksheetColWidthMutation;
exports.SetWorksheetColWidthMutationFactory = SetWorksheetColWidthMutationFactory;
exports.SetWorksheetColumnCountCommand = SetWorksheetColumnCountCommand;
exports.SetWorksheetColumnCountMutation = SetWorksheetColumnCountMutation;
exports.SetWorksheetColumnCountUndoMutationFactory = SetWorksheetColumnCountUndoMutationFactory;
exports.SetWorksheetDefaultStyleCommand = SetWorksheetDefaultStyleCommand;
exports.SetWorksheetDefaultStyleMutation = SetWorksheetDefaultStyleMutation;
exports.SetWorksheetDefaultStyleMutationFactory = SetWorksheetDefaultStyleMutationFactory;
exports.SetWorksheetHideCommand = SetWorksheetHideCommand;
exports.SetWorksheetHideMutation = SetWorksheetHideMutation;
exports.SetWorksheetNameCommand = SetWorksheetNameCommand;
exports.SetWorksheetNameMutation = SetWorksheetNameMutation;
exports.SetWorksheetOrderCommand = SetWorksheetOrderCommand;
exports.SetWorksheetOrderMutation = SetWorksheetOrderMutation;
exports.SetWorksheetPermissionPointsCommand = SetWorksheetPermissionPointsCommand;
exports.SetWorksheetPermissionPointsMutation = SetWorksheetPermissionPointsMutation;
exports.SetWorksheetProtectionCommand = SetWorksheetProtectionCommand;
exports.SetWorksheetProtectionMutation = SetWorksheetProtectionMutation;
exports.SetWorksheetRangeThemeStyleCommand = SetWorksheetRangeThemeStyleCommand;
exports.SetWorksheetRangeThemeStyleMutation = SetWorksheetRangeThemeStyleMutation;
exports.SetWorksheetRangeThemeStyleMutationFactory = SetWorksheetRangeThemeStyleMutationFactory;
exports.SetWorksheetRightToLeftCommand = SetWorksheetRightToLeftCommand;
exports.SetWorksheetRightToLeftMutation = SetWorksheetRightToLeftMutation;
exports.SetWorksheetRowAutoHeightMutation = SetWorksheetRowAutoHeightMutation;
exports.SetWorksheetRowAutoHeightMutationFactory = SetWorksheetRowAutoHeightMutationFactory;
exports.SetWorksheetRowCountCommand = SetWorksheetRowCountCommand;
exports.SetWorksheetRowCountMutation = SetWorksheetRowCountMutation;
exports.SetWorksheetRowCountUndoMutationFactory = SetWorksheetRowCountUndoMutationFactory;
exports.SetWorksheetRowHeightMutation = SetWorksheetRowHeightMutation;
exports.SetWorksheetRowHeightMutationFactory = SetWorksheetRowHeightMutationFactory;
exports.SetWorksheetRowIsAutoHeightCommand = SetWorksheetRowIsAutoHeightCommand;
exports.SetWorksheetRowIsAutoHeightMutation = SetWorksheetRowIsAutoHeightMutation;
exports.SetWorksheetRowIsAutoHeightMutationFactory = SetWorksheetRowIsAutoHeightMutationFactory;
exports.SetWorksheetShowCommand = SetWorksheetShowCommand;
exports.SheetCopyDownCommand = SheetCopyDownCommand;
exports.SheetCopyRightCommand = SheetCopyRightCommand;
Object.defineProperty(exports, 'SheetInterceptorService', {
  enumerable: true,
  get: function () {
    return SheetInterceptorService;
  }
});
Object.defineProperty(exports, 'SheetLazyExecuteScheduleService', {
  enumerable: true,
  get: function () {
    return SheetLazyExecuteScheduleService;
  }
});
Object.defineProperty(exports, 'SheetPermissionCheckController', {
  enumerable: true,
  get: function () {
    return SheetPermissionCheckController;
  }
});
Object.defineProperty(exports, 'SheetPermissionInitController', {
  enumerable: true,
  get: function () {
    return SheetPermissionInitController;
  }
});
Object.defineProperty(exports, 'SheetRangeThemeModel', {
  enumerable: true,
  get: function () {
    return SheetRangeThemeModel;
  }
});
Object.defineProperty(exports, 'SheetRangeThemeService', {
  enumerable: true,
  get: function () {
    return SheetRangeThemeService;
  }
});
exports.SheetSkeletonChangeType = SheetSkeletonChangeType;
Object.defineProperty(exports, 'SheetSkeletonService', {
  enumerable: true,
  get: function () {
    return SheetSkeletonService;
  }
});
exports.SheetValueChangeType = SheetValueChangeType;
Object.defineProperty(exports, 'SheetsFreezeSyncController', {
  enumerable: true,
  get: function () {
    return SheetsFreezeSyncController;
  }
});
Object.defineProperty(exports, 'SheetsSelectionsService', {
  enumerable: true,
  get: function () {
    return SheetsSelectionsService;
  }
});
exports.SplitDelimiterEnum = SplitDelimiterEnum;
exports.SplitTextToColumnsCommand = SplitTextToColumnsCommand;
exports.TextToNumberCommand = TextToNumberCommand;
...
exports.UnregisterWorksheetRangeThemeStyleCommand = UnregisterWorksheetRangeThemeStyleCommand;
exports.UnregisterWorksheetRangeThemeStyleMutation = UnregisterWorksheetRangeThemeStyleMutation;
exports.VALIDATE_CELL = VALIDATE_CELL;
exports.ViewStateEnum = ViewStateEnum;
exports.WorkbookCommentPermission = WorkbookCommentPermission;
exports.WorkbookCopyPermission = WorkbookCopyPermission;
exports.WorkbookCopySheetPermission = WorkbookCopySheetPermission;
exports.WorkbookCreateProtectPermission = WorkbookCreateProtectPermission;
exports.WorkbookCreateSheetPermission = WorkbookCreateSheetPermission;
exports.WorkbookDeleteColumnPermission = WorkbookDeleteColumnPermission;
exports.WorkbookDeleteRowPermission = WorkbookDeleteRowPermission;
exports.WorkbookDeleteSheetPermission = WorkbookDeleteSheetPermission;
exports.WorkbookDuplicatePermission = WorkbookDuplicatePermission;
exports.WorkbookEditablePermission = WorkbookEditablePermission;
exports.WorkbookExportPermission = WorkbookExportPermission;
exports.WorkbookHideSheetPermission = WorkbookHideSheetPermission;
exports.WorkbookInsertColumnPermission = WorkbookInsertColumnPermission;
exports.WorkbookInsertRowPermission = WorkbookInsertRowPermission;
exports.WorkbookManageCollaboratorPermission = WorkbookManageCollaboratorPermission;
exports.WorkbookMoveSheetPermission = WorkbookMoveSheetPermission;
Object.defineProperty(exports, 'WorkbookPermissionService', {
  enumerable: true,
  get: function () {
    return WorkbookPermissionService;
  }
});
exports.WorkbookPrintPermission = WorkbookPrintPermission;
exports.WorkbookRecoverHistoryPermission = WorkbookRecoverHistoryPermission;
exports.WorkbookRenameSheetPermission = WorkbookRenameSheetPermission;
exports.WorkbookSelectionModel = WorkbookSelectionModel;
exports.WorkbookSharePermission = WorkbookSharePermission;
exports.WorkbookViewHistoryPermission = WorkbookViewHistoryPermission;
exports.WorkbookViewPermission = WorkbookViewPermission;
exports.WorksheetCopyPermission = WorksheetCopyPermission;
exports.WorksheetDeleteColumnPermission = WorksheetDeleteColumnPermission;
exports.WorksheetDeleteProtectionPermission = WorksheetDeleteProtectionPermission;
exports.WorksheetDeleteRowPermission = WorksheetDeleteRowPermission;
exports.WorksheetEditExtraObjectPermission = WorksheetEditExtraObjectPermission;
exports.WorksheetEditPermission = WorksheetEditPermission;
exports.WorksheetFilterPermission = WorksheetFilterPermission;
exports.WorksheetInsertColumnPermission = WorksheetInsertColumnPermission;
exports.WorksheetInsertHyperlinkPermission = WorksheetInsertHyperlinkPermission;
exports.WorksheetInsertRowPermission = WorksheetInsertRowPermission;
exports.WorksheetManageCollaboratorPermission = WorksheetManageCollaboratorPermission;
Object.defineProperty(exports, 'WorksheetPermissionService', {
  enumerable: true,
  get: function () {
    return WorksheetPermissionService;
  }
});
exports.WorksheetPivotTablePermission = WorksheetPivotTablePermission;
exports.WorksheetProtectionPointModel = WorksheetProtectionPointModel;
exports.WorksheetProtectionRuleModel = WorksheetProtectionRuleModel;
exports.WorksheetSelectProtectedCellsPermission = WorksheetSelectProtectedCellsPermission;
exports.WorksheetSelectUnProtectedCellsPermission = WorksheetSelectUnProtectedCellsPermission;
exports.WorksheetSetCellStylePermission = WorksheetSetCellStylePermission;
exports.WorksheetSetCellValuePermission = WorksheetSetCellValuePermission;
exports.WorksheetSetColumnStylePermission = WorksheetSetColumnStylePermission;
exports.WorksheetSetRowStylePermission = WorksheetSetRowStylePermission;
exports.WorksheetSortPermission = WorksheetSortPermission;
exports.WorksheetViewPermission = WorksheetViewPermission;
Object.defineProperty(exports, 'ZebraCrossingCacheController', {
  enumerable: true,
  get: function () {
    return ZebraCrossingCacheController;
  }
});
exports.addMergeCellsUtil = addMergeCellsUtil;
exports.adjustRangeOnMutation = adjustRangeOnMutation;
exports.alignToMergedCellsBorders = alignToMergedCellsBorders;
exports.attachPrimaryWithCoord = attachPrimaryWithCoord;
exports.attachRangeWithCoord = attachRangeWithCoord;
exports.attachSelectionWithCoord = attachSelectionWithCoord;
exports.baseProtectionActions = baseProtectionActions;
exports.checkCellValueType = checkCellValueType;
exports.checkRangesEditablePermission = checkRangesEditablePermission;
exports.convertPositionCellToSheetOverGrid = convertPositionCellToSheetOverGrid;
exports.convertPositionSheetOverGridToAbsolute = convertPositionSheetOverGridToAbsolute;
exports.convertPrimaryWithCoordToPrimary = convertPrimaryWithCoordToPrimary;
...
exports.factorySetNumfmtUndoMutation = factorySetNumfmtUndoMutation;
exports.findAllRectangle = findAllRectangle;
exports.findFirstNonEmptyCell = findFirstNonEmptyCell;
exports.followSelectionOperation = followSelectionOperation;
exports.generateNullCell = generateNullCell;
exports.generateNullCellValue = generateNullCellValue;
exports.getAddMergeMutationRangeByType = getAddMergeMutationRangeByType;
exports.getAllRangePermissionPoint = getAllRangePermissionPoint;
exports.getAllWorkbookPermissionPoint = getAllWorkbookPermissionPoint;
exports.getAllWorksheetPermissionPoint = getAllWorksheetPermissionPoint;
exports.getAllWorksheetPermissionPointByPointPanel = getAllWorksheetPermissionPointByPointPanel;
exports.getCellAtRowCol = getCellAtRowCol;
exports.getClearContentMutationParamForRange = getClearContentMutationParamForRange;
exports.getClearContentMutationParamsForRanges = getClearContentMutationParamsForRanges;
exports.getDefaultRangePermission = getDefaultRangePermission;
exports.getInsertRangeMutations = getInsertRangeMutations;
exports.getMoveRangeCommandMutations = getMoveRangeCommandMutations;
exports.getMoveRangeUndoRedoMutations = getMoveRangeUndoRedoMutations;
exports.getNextPrimaryCell = getNextPrimaryCell;
exports.getPrimaryForRange = getPrimaryForRange;
exports.getRemoveRangeMutations = getRemoveRangeMutations;
exports.getSelectionsService = getSelectionsService;
exports.getSeparateEffectedRangesOnCommand = getSeparateEffectedRangesOnCommand;
exports.getSheetCommandTarget = getSheetCommandTarget;
exports.getSheetCommandTargetWorkbook = getSheetCommandTargetWorkbook;
exports.getSheetMutationTarget = getSheetMutationTarget;
exports.getSkeletonChangedEffectedRange = getSkeletonChangedEffectedRange;
exports.getValueChangedEffectedRange = getValueChangedEffectedRange;
exports.getVisibleRanges = getVisibleRanges;
exports.handleBaseInsertRange = handleBaseInsertRange;
exports.handleBaseMoveRowsCols = handleBaseMoveRowsCols;
exports.handleBaseRemoveRange = handleBaseRemoveRange;
exports.handleCommonDefaultRangeChangeWithEffectRefCommands = handleCommonDefaultRangeChangeWithEffectRefCommands;
exports.handleCommonRangeChangeWithEffectRefCommandsSkipNoInterests = handleCommonRangeChangeWithEffectRefCommandsSkipNoInterests;
exports.handleDefaultRangeChangeWithEffectRefCommands = handleDefaultRangeChangeWithEffectRefCommands;
exports.handleDefaultRangeChangeWithEffectRefCommandsSkipNoInterests = handleDefaultRangeChangeWithEffectRefCommandsSkipNoInterests;
exports.handleDeleteRangeMoveLeft = handleDeleteRangeMoveLeft;
exports.handleDeleteRangeMoveUp = handleDeleteRangeMoveUp;
exports.handleDeleteRangeMutation = handleDeleteRangeMutation;
exports.handleIRemoveCol = handleIRemoveCol;
exports.handleIRemoveRow = handleIRemoveRow;
exports.handleInsertCol = handleInsertCol;
exports.handleInsertRangeMoveDown = handleInsertRangeMoveDown;
exports.handleInsertRangeMoveRight = handleInsertRangeMoveRight;
exports.handleInsertRangeMutation = handleInsertRangeMutation;
exports.handleInsertRow = handleInsertRow;
