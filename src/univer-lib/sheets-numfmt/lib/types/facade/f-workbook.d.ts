...
export declare class FWorkbookSheetsNumfmtMixin extends FWorkbook implements IFWorkbookSheetsNumfmtMixin {
    setNumfmtLocal(locale: INumfmtLocaleTag): FWorkbook;
}
declare module '@univerjs/sheets/facade' {
    interface FWorkbook extends IFWorkbookSheetsNumfmtMixin {
    }
}
