...
const locale = { "sheets-ui": {
	...
	sheetConfig: {
		...
		noMoreSheet: "В книге должен содержаться хотя бы один видимый лист. Чтобы удалить выбранный лист, вставьте новый лист или покажите скрытый лист.",
	...
	"data-validation": {
		...
		listMultiple: { dropdown: "Выберите элементы" }
	},
	permission: {
		toolbarMenu: "Защита",
		panel: {
		...
		dialog: {
			...
			commentErr: "Диапазон защищен, и у вас нет разрешения на комментирование. Для комментирования свяжитесь с создателем."
		},
		button: {
			confirm: "Подтвердить",
			cancel: "Отменить",
