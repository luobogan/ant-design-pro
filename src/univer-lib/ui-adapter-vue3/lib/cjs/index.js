...
let UniverVue3AdapterPlugin = class UniverVue3AdapterPlugin extends _univerjs_core.Plugin {
...
function VueComponentWrapper(options) {
	...
	useEffect(() => {
		...
		(0, vue.render)((0, vue.h)(component, props), domRef.current);
		return () => {
			domRef.current && (0, vue.render)(null, domRef.current);
		};
	}, [props]);
...
//#endregion
Object.defineProperty(exports, 'UniverVue3AdapterPlugin', {
  enumerable: true,
  get: function () {
    return UniverVue3AdapterPlugin;
  }
});