...
export default defineConfig({
  alias: {
    '@root': join(__dirname, '..'),
    // ── Univer 全部本地包（50个，从 src/univer-lib/ 加载）──
    '@univerjs/action-recorder': join(UNIVER_LIB, 'action-recorder', 'lib', 'es', 'index.js'),
    ...
    '@univerjs/docs-drawing': join(UNIVER_LIB, 'docs-drawing', 'lib', 'es', 'index.js'),
    '@univerjs/docs-drawing-ui': join(UNIVER_LIB, 'docs-drawing-ui', 'lib', 'es', 'index.js'),
    '@univerjs/docs-hyper-link': join(UNIVER_LIB, 'docs-hyper-link', 'lib', 'es', 'index.js'),
    '@univerjs/docs-hyper-link-ui': join(UNIVER_LIB, 'docs-hyper-link-ui', 'lib', 'es', 'index.js'),
    '@univerjs/docs-quick-insert-ui': join(UNIVER_LIB, 'docs-quick-insert-ui', 'lib', 'es', 'index.js'),
    '@univerjs/docs-thread-comment-ui': join(UNIVER_LIB, 'docs-thread-comment-ui', 'lib', 'es', 'index.js'),
    '@univerjs/docs-ui': join(UNIVER_LIB, 'docs-ui', 'lib', 'es', 'index.js'),
    '@univerjs/drawing': join(UNIVER_LIB, 'drawing', 'lib', 'es', 'index.js'),
    '@univerjs/drawing-ui': join(UNIVER_LIB, 'drawing-ui', 'lib', 'es', 'index.js'),
    ...
    '@univerjs/find-replace': join(UNIVER_LIB, 'find-replace', 'lib', 'es', 'index.js'),
    '@univerjs/network': join(UNIVER_LIB, 'network', 'lib', 'es', 'index.js'),
    '@univerjs/protocol': join(UNIVER_LIB, 'protocol', 'lib', 'es', 'index.js'),
    '@univerjs/rpc': join(UNIVER_LIB, 'rpc', 'lib', 'es', 'index.js'),
    '@univerjs/rpc-node': join(UNIVER_LIB, 'rpc-node', 'lib', 'es', 'index.js'),
    '@univerjs/sheets': join(UNIVER_LIB, 'sheets', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-conditional-formatting-ui': join(UNIVER_LIB, 'sheets-conditional-formatting-ui', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-crosshair-highlight': join(UNIVER_LIB, 'sheets-crosshair-highlight', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-data-validation': join(UNIVER_LIB, 'sheets-data-validation', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-drawing-ui': join(UNIVER_LIB, 'sheets-drawing-ui', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-filter': join(UNIVER_LIB, 'sheets-filter', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-filter-ui': join(UNIVER_LIB, 'sheets-filter-ui', 'lib', 'es', 'index.js'),
    ...
    '@univerjs/sheets-graphics': join(UNIVER_LIB, 'sheets-graphics', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-hyper-link-ui': join(UNIVER_LIB, 'sheets-hyper-link-ui', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-note': join(UNIVER_LIB, 'sheets-note', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-note-ui': join(UNIVER_LIB, 'sheets-note-ui', 'lib', 'es', 'index.js'),
    ...
    '@univerjs/sheets-sort': join(UNIVER_LIB, 'sheets-sort', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-table': join(UNIVER_LIB, 'sheets-table', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-table-ui': join(UNIVER_LIB, 'sheets-table-ui', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-thread-comment': join(UNIVER_LIB, 'sheets-thread-comment', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-thread-comment-ui': join(UNIVER_LIB, 'sheets-thread-comment-ui', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-ui': join(UNIVER_LIB, 'sheets-ui', 'lib', 'es', 'index.js'),
    '@univerjs/sheets-zen-editor': join(UNIVER_LIB, 'sheets-zen-editor', 'lib', 'es', 'index.js'),
    '@univerjs/slides': join(UNIVER_LIB, 'slides', 'lib', 'es', 'index.js'),
    '@univerjs/telemetry': join(UNIVER_LIB, 'telemetry', 'lib', 'es', 'index.js'),
    '@univerjs/themes': join(UNIVER_LIB, 'themes', 'lib', 'es', 'index.js'),
    '@univerjs/thread-comment': join(UNIVER_LIB, 'thread-comment', 'lib', 'es', 'index.js'),
    '@univerjs/thread-comment-ui': join(UNIVER_LIB, 'thread-comment-ui', 'lib', 'es', 'index.js'),
    '@univerjs/ui': join(UNIVER_LIB, 'ui', 'lib', 'es', 'index.js'),
    '@univerjs/ui-adapter-vue3': join(UNIVER_LIB, 'ui-adapter-vue3', 'lib', 'es', 'index.js'),
    '@univerjs/watermark': join(UNIVER_LIB, 'watermark', 'lib', 'es', 'index.js'),
    // facade 子路径
    ...
    '@univerjs/sheets-numfmt/facade': join(UNIVER_LIB, 'sheets-numfmt', 'lib', 'es', 'facade.js'),
    // 语言包 (zh-CN)
